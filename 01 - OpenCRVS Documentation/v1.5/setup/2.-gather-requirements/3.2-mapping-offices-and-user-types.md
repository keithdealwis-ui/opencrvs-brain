...
source_url: "https://documentation.opencrvs.org/v1.5/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:de5929da159d42c0b32ec93e0209881ccb7427ddd36d444190c56a231ba520d8"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types.md).
...
```
GET https://documentation.opencrvs.org/v1.5/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types.md?ask=<question>&goal=<endgoal>
```
