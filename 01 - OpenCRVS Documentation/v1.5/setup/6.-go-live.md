---
title: "7. Go-live"
source_url: "https://documentation.opencrvs.org/v1.5/setup/6.-go-live"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/6.-go-live.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:7e97ec79a335c1eddd3b19870745680bfb71a7d93e27a507996391670aff933b"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/setup/6.-go-live.md).
...
The following [Pre-Deployment Checklist](/v1.5/setup/6.-go-live/3.3.4-set-up-an-smtp-server-for-opencrvs-monitoring-alerts.md) should be completed by the **production** environment server administrator before going live.
...
```
GET https://documentation.opencrvs.org/v1.5/setup/6.-go-live.md?ask=<question>&goal=<endgoal>
```
