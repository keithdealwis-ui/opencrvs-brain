---
title: "9. Monitoring"
source_url: "https://documentation.opencrvs.org/v1.5/setup/7.-monitoring"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/7.-monitoring.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:fdb27a458f91556f14c17981e62d4e217799c2f1978a18e3b8d870baa11dc42f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/setup/7.-monitoring.md).
...
![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/k7KSB24koMak6HYiKfs7/image.png)

The login credentials are the ones you used as `KIBANA_USERNAME` and `KIBANA_PASSWORD` as part of the [deployment](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md), or the username: "elastic" and `ELASTICSEARCH_SUPERUSER_PASSWORD`
...
```
GET https://documentation.opencrvs.org/v1.5/setup/7.-monitoring.md?ask=<question>&goal=<endgoal>
```
