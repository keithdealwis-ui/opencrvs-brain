...
source_url: "https://documentation.opencrvs.org/v1.5/setup/5.-testing"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/5.-testing.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:1f716954cdeb1f0772ae01a19f46f9e539edeb11262021d0ca1310158e72948a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/setup/5.-testing.md).
...
```
GET https://documentation.opencrvs.org/v1.5/setup/5.-testing.md?ask=<question>&goal=<endgoal>
```
