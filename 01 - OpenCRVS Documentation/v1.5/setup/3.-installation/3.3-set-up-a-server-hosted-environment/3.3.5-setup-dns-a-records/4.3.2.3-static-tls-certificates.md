---
title: "4.3.2.3 Static TLS certificates"
source_url: "https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.5-setup-dns-a-records/4.3.2.3-static-tls-certificates"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.5-setup-dns-a-records/4.3.2.3-static-tls-certificates.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b5fd9d028e5c5c733c7b12d33fcc063d12e3b76673eb7803282b6fc0d932b5ad"
---
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FT5qWGJX0bEV5aIytbryI%2FScreenshot%202024-10-11%20at%2012.55.01.png?alt=media&amp;token=2265fa04-8fb2-41fe-9bd0-20e1432e2ce8" alt=""><figcaption></figcaption></figure>
...
</code></pre></td><td>The content of the .crt file, ie: the certificate "Full Chain File", equivalent to the <code>fullchain.pem</code> file that is created by <code>certbot</code></td></tr><tr><td><pre><code>SSL_KEY
</code></pre></td><td>The content of the .key file, ie: the private key associated with your SSL certificate, equivalent to the <code>privkey.pem</code> file that is created by <code>certbot</code>.</td></tr></tbody></table>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FLDqQlaMQonFhb5EbLDSV%2FScreenshot%202024-11-05%20at%2014.25.08.png?alt=media&amp;token=6717b80a-db36-4f4e-b9be-2cbeacd2c6d3" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.5-setup-dns-a-records/4.3.2.3-static-tls-certificates.md?ask=<question>&goal=<endgoal>
```
