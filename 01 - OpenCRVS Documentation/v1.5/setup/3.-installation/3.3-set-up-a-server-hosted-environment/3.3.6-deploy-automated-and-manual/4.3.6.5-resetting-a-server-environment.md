...
source_url: "https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.5-resetting-a-server-environment"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.5-resetting-a-server-environment.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:fa9828474fbb1d25646b610dccf4f0b5442db1ec194540b0d6a4f638a9417e37"
---
...
{% hint style="info" %}
After resetting your environment, it contains no data at all.  It must be [seeded](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.2-seeding-a-server-environment.md) again,
{% endhint %}

### Reset a **production** environment

Perhaps you need to clear production after completing a [test that backup is working successfully ](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.7-backup-and-restore.md)in readiness for going live.  Or perhaps you need to [restore a previous backup](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.7-backup-and-restore/4.3.7.1-restoring-a-backup.md) onto production for some other reason.  In these scenarios, you would be required to reset your production environment.
...
```
GET https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.5-resetting-a-server-environment.md?ask=<question>&goal=<endgoal>
```
