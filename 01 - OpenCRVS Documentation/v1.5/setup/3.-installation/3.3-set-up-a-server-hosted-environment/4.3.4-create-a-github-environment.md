...
source_url: "https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:eaaa08d0f0abd2c1b8cd72d401d0e6616713e745e3ca6fde38182cd46c492331"
---
...
The environments will be named according to the naming convention identical to that we have described [here](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md).&#x20;
...
<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/nj7oU8dCTR7SbLprVV4C/Screenshot%202024-01-09%20at%2016.07.25.png" alt=""><figcaption><p>Creating a private Dockerhub repository for a countryconfig forked container</p></figcaption></figure>

Ensure that the Dockerhub members have permissions to write to the repository:

<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FYfveU20bdFRcwkFbx46g%2FScreenshot%202024-09-11%20at%2011.35.02.png?alt=media&amp;token=7129f34a-c7fa-4d21-a6ca-931a19de48e0" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FW3niH6l2fK9Sm1JN4hMq%2FScreenshot%202024-09-27%20at%2009.16.14.png?alt=media&amp;token=a15acbf5-7264-4868-8004-7f58b51f719a" alt=""><figcaption></figcaption></figure>
...
Prepare your VPN and the Github Action approach to connect through the VPN by following the section [4.3.4.2 VPN Recipes](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment/4.3.4.2-vpn-recipes.md).

### 4. Create companion service accounts for monitoring (optional, but recommended)

Our code is hardcoded to track bugs in [Sentry](https://www.sentry.io) and then these can be redirected to an email address or [Slack](https://slack.com/) channel.  Sentry and Slack are extremely low cost tools (all ongoing service costs are listed in section [4.3](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)). &#x20;

We can use the same email address or Slack channel to receive any uncaught errors or infrastructure monitoring alerts from Sentry as we will do from the internal Kibana monitoring tool: explained further in the [Monitoring](/v1.5/setup/7.-monitoring.md) section.

Create a NodeJS project in Sentry for your chosen environment

<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/TV5WC1icp97YMJFF1OyJ/Screenshot%202024-01-09%20at%2017.35.34.png" alt=""><figcaption><p>Creating a NodeJS, Sentry project for a "production" environment</p></figcaption></figure>

In the Sentry project settings, select "Client Keys", and **copy the DSN property**.   You will need it later.

<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/hPl2FhJXdaYAgvOxUzde/Screenshot%202024-01-09%20at%2017.38.52.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/ohiXQjmhT5jHvJvEYp5u/Screenshot%202024-01-16%20at%2016.48.23.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/Nv6rJF4wkiythxCOryVw/Screenshot%202024-01-09%20at%2017.49.03.png" alt=""><figcaption><p>Getting an email address for a Slack channel</p></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FGE5DnImWgLgfDkhFK6yu%2Fnew-env-script.png?alt=media&amp;token=a11fd9c1-14c3-4467-80c7-83946f26d837" alt=""><figcaption></figcaption></figure>

The script will fail if it cannot connect to Github for whatever reason, then continue.

<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FwdPjEIJpD7w5S3IVQkYJ%2FScreenshot%202024-11-07%20at%2013.12.24.png?alt=media&amp;token=7d8e3de3-17aa-483c-adb3-86585ddecdf4" alt=""><figcaption><p>The script will ask for the SSH connection details and <strong>private</strong> key for the "provision" user</p></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FVGCfIo6bGOfiv8V3x24Q%2FScreenshot%202024-11-07%20at%2013.31.16.png?alt=media&amp;token=ba2a2dc3-a70c-4130-84d2-fd4148377918" alt=""><figcaption><p>The script allocates disk space and creates a known-hosts file for your server domain</p></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FfJtjaUnvLBkTE6kRrYhn%2FScreenshot%202024-11-07%20at%2013.36.14.png?alt=media&amp;token=f2330425-e9a2-4ec7-b437-07fb8facbe2f" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FKfhG3kC4t6afPzBfHZGf%2FScreenshot%202024-11-07%20at%2013.39.38.png?alt=media&amp;token=10f5ee5f-4323-4bb0-b683-b7f2aa094b0a" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FUn02JldzBu8wn09LDscx%2FScreenshot%202024-11-07%20at%2013.51.44.png?alt=media&amp;token=9a6afd49-42b2-49b4-8871-52c5c55f1897" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FUSrPPwQYvgQAjh0HRFuz%2FScreenshot%202024-11-07%20at%2013.54.13.png?alt=media&amp;token=bab05793-b927-4857-9b1b-8ed20d2e309a" alt=""><figcaption><p>The script will proceed to create the Github environment and a .env file in your local repo for reference</p></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FgmlAe0wcoFdBTVjgsCfp%2FScreenshot%202024-11-07%20at%2013.59.13.png?alt=media&amp;token=539d2ea5-cc9a-462d-a410-793345f155fa" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FXcnSXiLEJUcW92ThX7RO%2FScreenshot%202024-11-07%20at%2013.58.39.png?alt=media&amp;token=c83dbc7c-4694-4e2c-b980-cf9de5d09c17" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2FtTCAxORBscqeLPFtGbAA%2FScreenshot%202024-11-07%20at%2014.02.46.png?alt=media&amp;token=146144d5-2b16-4613-ab0e-bc874b369c76" alt=""><figcaption><p>You will also notice some "repository secrets and variables" have been created accesiblt to all environments</p></figcaption></figure>
...
<figure><img src="https://114323470-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fl7Cjlh2y2hlCBlt6R76C%2Fuploads%2F4sh9b16YEj4Ih34ar3VM%2FScreenshot%202024-11-07%20at%2014.23.16.png?alt=media&amp;token=8a9a25dc-6772-4ef1-bb1c-b1978f31b699" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment.md?ask=<question>&goal=<endgoal>
```
