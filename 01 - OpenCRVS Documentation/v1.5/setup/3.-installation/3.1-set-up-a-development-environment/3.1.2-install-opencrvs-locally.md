...
source_url: "https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.1-set-up-a-development-environment/3.1.2-install-opencrvs-locally"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.1-set-up-a-development-environment/3.1.2-install-opencrvs-locally.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a0d70095ea3c1e230e773a1f3c7ed38306ba6dc79019a9ff3f12b715bb944d80"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.1-set-up-a-development-environment/3.1.2-install-opencrvs-locally.md).
...
<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/2WfTtrKtW9zq1wBzNRil/Screenshot%202024-01-16%20at%2014.36.58.png" alt=""><figcaption></figcaption></figure>

* Open the url [**`http://localhost:3020/`**](http://localhost:3020/)
* You have successfully installed OpenCRVS! 🎉
* Proceed to login using the details in the [section 3.14 Log in to OpenCRVS](/v1.5/setup/3.-installation/3.1-set-up-a-development-environment/3.1.4-log-in-to-opencrvs-locally.md).
* To stop OpenCRVS running in the installer, type **ctrl+c**, then **exit** in each tmux terminal window

<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/16aFm57eASilVupmpgZG/Screenshot%202024-01-16%20at%2014.38.14.png" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.5/setup/3.-installation/3.1-set-up-a-development-environment/3.1.2-install-opencrvs-locally.md?ask=<question>&goal=<endgoal>
```
