...
source_url: "https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.3-routine-monitoring-checklist"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.3-routine-monitoring-checklist.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f1a0af81263f82ed2237051297279eda4d8e3b6d4e621ec78473428191041505"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.3-routine-monitoring-checklist.md).
...
* Use the parameters listed in [7.2 Infrastructure health](/v1.5/setup/7.-monitoring/7.2-infrastructure-health.md) under Available disk space
* Verify all used disk space is under 70% on all nodes

![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/9t8hjJd5hyE6qpLny3M8/image.png)

#### CPU and memory usage less than 80% on all nodes

* Login to Kibana
* Navigate to **Observability -> Metrics -> Metrics Explorer**
* Use the parameters listed in [7.2 Infrastructure health](/v1.5/setup/7.-monitoring/7.2-infrastructure-health.md) under CPU usage
* Select a timeframe of 24 hours
* Verify CPU load has not exceeded 80% on any of your server nodes

![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/fcbBOFUO5gDr69FE8Jco/image.png)
...
```
GET https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.3-routine-monitoring-checklist.md?ask=<question>&goal=<endgoal>
```
