...
source_url: "https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.1-application-logs"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.1-application-logs.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6e0e24abcd069e5dda64390f7f93daaee8e97c4ce3e349ca7f15c2df3152ca78"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.1-application-logs.md).
...
![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/jqFK5d4gds0HZZVewCvn/image.png)
...
![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/e1q0zIKKsQUqLkUjVipd/image.png)
...
![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/THM69Wq8jir2YsPjPHyd/image.png)
...
![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/z9Gv1oe4E5YLUsAUQhq8/image.png)
...
```
GET https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.1-application-logs.md?ask=<question>&goal=<endgoal>
```
