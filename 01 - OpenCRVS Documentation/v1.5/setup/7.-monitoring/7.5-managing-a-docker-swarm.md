...
source_url: "https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.5-managing-a-docker-swarm"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.5-managing-a-docker-swarm.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b1ef373862329d43c6f5bcd3af8b2e62610246f3d04abf3cf15a06c09489f718"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.5-managing-a-docker-swarm.md).
...
```
GET https://documentation.opencrvs.org/v1.5/setup/7.-monitoring/7.5-managing-a-docker-swarm.md?ask=<question>&goal=<endgoal>
```
