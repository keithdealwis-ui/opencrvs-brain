...
source_url: "https://documentation.opencrvs.org/v1.5/setup/4.-functional-configuration/4.5-create-system-users"
markdown_url: "https://documentation.opencrvs.org/v1.5/setup/4.-functional-configuration/4.5-create-system-users.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f97912f480d9bcc35b40d21ac97ac558ed3aeec93dca6ae7607cfd898166e483"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/setup/4.-functional-configuration/4.5-create-system-users.md).
...
2. **Create a Field Agent**\
   ...
   \
   ![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/2eFVwsoyWB98kOBpUIir/image.png)\
   \
   Select the type of role.\
   ![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/yxCo2q9yAwqoU3HMYDdj/image.png)\
   \
...
4. **Create a Registrar**\
   ...
   \
   ![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/WyytZS3nur0usp0ITiAG/image.png)\
   \
...
```
GET https://documentation.opencrvs.org/v1.5/setup/4.-functional-configuration/4.5-create-system-users.md?ask=<question>&goal=<endgoal>
```
