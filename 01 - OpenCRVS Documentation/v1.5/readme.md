---
title: "Welcome!"
source_url: "https://documentation.opencrvs.org/v1.5/readme"
markdown_url: "https://documentation.opencrvs.org/v1.5/readme.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:bbb5712f512d157d06c4e14b0f5e0ef6eff342e84cafa3adcafc829b8c51a513"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/readme.md).
...
* to understand what effective digital CRVS looks like and the role that OpenCRVS can play, check out [CRVS Systems](/v1.5/crvs-systems/effective-digital-crvs-systems.md).&#x20;
* to explore the OpenCRVS functionality, take a look at the [Product Specifications](/v1.5/product-specifications/functional-architecture.md) and the [Default Configuration for Farajaland](/v1.5/default-configuration/intro-to-farajaland.md)
* to understand how OpenCRVS works technically, go to [Technology](/v1.5/technology/architecture.md)
* to setup you own OpenCRVS project, then go to [Setup](/v1.5/setup/1.-establish-project-and-team.md)
* to see what's coming next for OpenCRVS, see the [Product Roadmap](/v1.5/general/product-roadmap.md)
...
```
GET https://documentation.opencrvs.org/v1.5/readme.md?ask=<question>&goal=<endgoal>
```
