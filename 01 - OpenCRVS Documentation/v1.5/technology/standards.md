---
title: "Standards"
source_url: "https://documentation.opencrvs.org/v1.5/technology/standards"
markdown_url: "https://documentation.opencrvs.org/v1.5/technology/standards.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6449227b8b423c48c5029d7514e0a2ca9a633d924bf0508924fb8fd7d07deb82"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/technology/standards.md).
...
We have extended FHIR's model to include custom codes and extensions that assist the Civil Registration context.  To understand more about how and why we use FHIR, click [here](/v1.5/technology/standards/fhir-documents.md).
...
```
GET https://documentation.opencrvs.org/v1.5/technology/standards.md?ask=<question>&goal=<endgoal>
```
