...
source_url: "https://documentation.opencrvs.org/v1.5/technology/architecture/performance-tests"
markdown_url: "https://documentation.opencrvs.org/v1.5/technology/architecture/performance-tests.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:5fc7f8efebf82dce33dccf5df13ebafddd44182dea413c0bcc0a1176bab8018a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/technology/architecture/performance-tests.md).
...
<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/Ti0EzQVkQcsTj8begUFA/k6results.png" alt=""><figcaption></figcaption></figure>
...
![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/fRtHeExE55Gy6xDQTasC/Screenshot%202022-06-27%20at%2014.39.06.png)
...
```
GET https://documentation.opencrvs.org/v1.5/technology/architecture/performance-tests.md?ask=<question>&goal=<endgoal>
```
