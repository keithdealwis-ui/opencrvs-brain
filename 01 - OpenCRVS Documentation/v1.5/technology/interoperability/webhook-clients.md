...
source_url: "https://documentation.opencrvs.org/v1.5/technology/interoperability/webhook-clients"
markdown_url: "https://documentation.opencrvs.org/v1.5/technology/interoperability/webhook-clients.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6fcf4dd7aaa4e4688925f0c42e92cfae9c6dcbe0145b4ed2ddd9853b489dd523"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/technology/interoperability/webhook-clients.md).
...
4. Respond to the webhook event as you wish internally, and request further details from OpenCRVS via a [Record Search](/v1.5/technology/interoperability/record-search-clients.md) if you need to.
...
<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/iLEKa98xgHGh1zpSXaVD/Screenshot%202023-01-11%20at%2011.34.54.png" alt=""><figcaption></figcaption></figure>
...
The property `context` contains the FHIR bundles. Refer to our [standards](/v1.5/technology/standards.md) section to learn more about the FHIR specification.
...
To subscribe, your subscription service must request an [authorization token ](/v1.5/technology/interoperability/authenticate-a-client.md)using your `client_id` and `client_secret`.
...
```
GET https://documentation.opencrvs.org/v1.5/technology/interoperability/webhook-clients.md?ask=<question>&goal=<endgoal>
```
