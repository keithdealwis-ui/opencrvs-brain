...
source_url: "https://documentation.opencrvs.org/v1.5/technology/interoperability/authenticate-a-client"
markdown_url: "https://documentation.opencrvs.org/v1.5/technology/interoperability/authenticate-a-client.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:169cd061a6309127e800fc5c5a5401144efb07ced70e40c379907b8f0657d681"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/technology/interoperability/authenticate-a-client.md).
...
```
GET https://documentation.opencrvs.org/v1.5/technology/interoperability/authenticate-a-client.md?ask=<question>&goal=<endgoal>
```
