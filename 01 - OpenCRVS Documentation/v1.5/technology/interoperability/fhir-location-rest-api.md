...
source_url: "https://documentation.opencrvs.org/v1.5/technology/interoperability/fhir-location-rest-api"
markdown_url: "https://documentation.opencrvs.org/v1.5/technology/interoperability/fhir-location-rest-api.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:adb42cc7b6a4e20999321805abdcd244eb44a4bf1f7129fae71a50f2dc356326"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/technology/interoperability/fhir-location-rest-api.md).
...
This API will help you configure integrating clients to understand the relationship to places referenced by [FHIR Location](https://build.fhir.org/location.html) ids in payloads such as "Place of birth", "Place of registration", or "Jurisdiction" such as [Webhooks](/v1.5/technology/interoperability/webhook-clients.md) and [National ID](/v1.5/technology/interoperability/national-id-client.md) clients.

For an [Event Notification](/v1.5/technology/interoperability/event-notification-clients.md) client, you must submit the correct FHIR Location id for the health facility that OpenCRVS understands in order to correctly track the place of birth.

For a [Record Search](/v1.5/technology/interoperability/record-search-clients.md) client, you need the correct FHIR Location id when performing advanced searches depending on your parameters.
...
<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/vYCht0Y9VziDKOflngsm/Screenshot%202023-01-19%20at%2016.57.25.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/H0PwppgE9iizQSts5dwd/Screenshot%202023-01-19%20at%2017.41.39.png" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.5/technology/interoperability/fhir-location-rest-api.md?ask=<question>&goal=<endgoal>
```
