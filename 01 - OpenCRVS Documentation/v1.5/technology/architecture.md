---
title: "Architecture"
source_url: "https://documentation.opencrvs.org/v1.5/technology/architecture"
markdown_url: "https://documentation.opencrvs.org/v1.5/technology/architecture.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:99792002fb2973fd05d37afc64c810e25a960ddd8224a061193ab9d57a5bb9b2"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/technology/architecture.md).
...
To learn about the server hosting & network architecture required for hosting OpenCRVS visit [this section.](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)
...
We extended [FHIR](https://www.hl7.org/fhir/) to support the civil registration context. Our civil registration FHIR standard is described [here](/v1.5/technology/standards/fhir-documents.md).
...
ElasticSearch is also used with [Kibana](https://www.elastic.co/kibana) for application and server health monitoring.<br>
...
![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/2x18UwBehtZlB9FB6Q6i/image.png) ![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/EoAGVxkT8NRFiKdNcYUU/image.png) ![](https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/W1S1meTLCrzvjVj2BsD7/image.png)\\
...
```
GET https://documentation.opencrvs.org/v1.5/technology/architecture.md?ask=<question>&goal=<endgoal>
```
