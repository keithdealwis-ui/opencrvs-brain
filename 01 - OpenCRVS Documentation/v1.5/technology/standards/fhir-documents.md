...
source_url: "https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents"
markdown_url: "https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:d1b6391cb29acc443acb6d6cb606aabfe559e1aaac30c7ede12373919789aa36"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents.md).
...
```
GET https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents.md?ask=<question>&goal=<endgoal>
```
