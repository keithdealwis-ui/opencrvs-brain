...
source_url: "https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents/event-observations"
markdown_url: "https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents/event-observations.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6c4d98e4d94aea28e45737acef3a2372618028c721002ee4a293ffc3e8426d6c"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents/event-observations.md).
...
```
GET https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents/event-observations.md?ask=<question>&goal=<endgoal>
```
