...
source_url: "https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents/event-composition"
markdown_url: "https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents/event-composition.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:22b38187b3f8c0fca64b36a15212912879539a654ea3f5ad5739317e4493b3bb"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents/event-composition.md).
...
```
GET https://documentation.opencrvs.org/v1.5/technology/standards/fhir-documents/event-composition.md?ask=<question>&goal=<endgoal>
```
