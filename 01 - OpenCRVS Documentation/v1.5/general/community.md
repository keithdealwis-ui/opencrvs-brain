---
title: "Community"
source_url: "https://documentation.opencrvs.org/v1.5/general/community"
markdown_url: "https://documentation.opencrvs.org/v1.5/general/community.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b1226f9398a30b4ef957e35677acbaacc3fffb954c779959fba5e5c030a58d3e"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/general/community.md).
...
```
GET https://documentation.opencrvs.org/v1.5/general/community.md?ask=<question>&goal=<endgoal>
```
