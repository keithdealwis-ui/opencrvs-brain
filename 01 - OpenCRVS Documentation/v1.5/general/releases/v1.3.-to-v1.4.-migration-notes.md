...
source_url: "https://documentation.opencrvs.org/v1.5/general/releases/v1.3.-to-v1.4.-migration-notes"
markdown_url: "https://documentation.opencrvs.org/v1.5/general/releases/v1.3.-to-v1.4.-migration-notes.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:39c109b7960eb75c2d9f990c83720f50827e8023df1530116708acd75fbaf321"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/general/releases/v1.3.-to-v1.4.-migration-notes.md).
...
The best thing to do is to read the entire section [3.3 Set-up a server hosted environment](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md) again before planning how best to upgrade and migrate your code.
{% endhint %}
...
Follow all the steps in [3.3 Set-up a server hosted environment.](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)

### Step 4: Upgrade your server **environments**

Follow the documentaion in  [3.3 Set-up a server hosted environment](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)&#x20;
...
```
GET https://documentation.opencrvs.org/v1.5/general/releases/v1.3.-to-v1.4.-migration-notes.md?ask=<question>&goal=<endgoal>
```
