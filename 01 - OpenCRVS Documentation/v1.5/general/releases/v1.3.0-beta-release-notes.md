...
source_url: "https://documentation.opencrvs.org/v1.5/general/releases/v1.3.0-beta-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.5/general/releases/v1.3.0-beta-release-notes.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:91eb841c5fec65be654b588cba6fa669aafd039013eea4abced9dd7ebb7980c0"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/general/releases/v1.3.0-beta-release-notes.md).
...
\
Due to this, we are releasing marriage registration in "beta", therefore not for production use. You can [configure marriage registration](/v1.5/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md) in development environments for proof of concept testing.
{% endhint %}

<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/ixhvs2V632WrqUzK67Os/Screenshot%202023-09-13%20at%2013.55.29.png" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/4Dh7u4CErlI8z19TwyCj/Screenshot%202023-09-13%20at%2013.58.08.png" alt=""><figcaption><p>If you decide to print in advance ...</p></figcaption></figure> <figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/Y4LjmrsVyy2mCo5WD3QL/Screenshot%202023-09-13%20at%2013.58.52.png" alt=""><figcaption><p>...then you can track issuance</p></figcaption></figure></div>
...
\
You can [configure the informant signature](/v1.5/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md) capture on and off for birth and death events. By default marriage events require the participant and witness signatures.

<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/k1KfgjyW8HqCDqbVUozW/Screenshot%202023-09-13%20at%2014.10.44.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/Mm06U4qnGQDWLCcXF1Ox/Screenshot%202023-09-13%20at%2014.13.10.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/SGzxyAlQbuwf0LGELWjo/Screenshot%202023-09-13%20at%2014.14.33.png" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/DUU5kHZJLRqscyEOowpc/Screenshot%202023-09-13%20at%2014.21.56.png" alt=""><figcaption></figcaption></figure> <figure><img src="https://content.gitbook.com/content/l7Cjlh2y2hlCBlt6R76C/blobs/4OxBEPmsuA5Sh3FGsiBd/Screenshot%202023-09-13%20at%2014.22.09.png" alt=""><figcaption></figcaption></figure></div>
...
To read more about why we made this decision, refer to our documentation [step 3.2.7 Configure declaration forms](/v1.5/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-declaration-forms.md)
...
[2 Gather requirements](/v1.5/setup/2.-gather-requirements.md)

[3.2 Set-up your own country configuration](/v1.5/setup/3.-installation/3.2-set-up-your-own-country-configuration.md)

[3.3 Set-up a server hosted environment](/v1.5/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)

[4 Functional configuration](/v1.5/setup/4.-functional-configuration.md)
...
```
GET https://documentation.opencrvs.org/v1.5/general/releases/v1.3.0-beta-release-notes.md?ask=<question>&goal=<endgoal>
```
