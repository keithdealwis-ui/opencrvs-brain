...
source_url: "https://documentation.opencrvs.org/v1.5/crvs-systems/understanding-crvs"
markdown_url: "https://documentation.opencrvs.org/v1.5/crvs-systems/understanding-crvs.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:ec59bc6c053bf53d5b1e5e95dd2c2073f515cf517504fe13dedbea3fa00c17f1"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/crvs-systems/understanding-crvs.md).
...
```
GET https://documentation.opencrvs.org/v1.5/crvs-systems/understanding-crvs.md?ask=<question>&goal=<endgoal>
```
