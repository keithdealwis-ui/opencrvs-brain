...
source_url: "https://documentation.opencrvs.org/v1.5/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms"
markdown_url: "https://documentation.opencrvs.org/v1.5/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md"
version: "v1.5"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:4fd30826bfc64821954b6fde2fc306134cce0e0aaef262dafb9201aebbb6cabe"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.5/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md).
...
```
GET https://documentation.opencrvs.org/v1.5/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md?ask=<question>&goal=<endgoal>
```
