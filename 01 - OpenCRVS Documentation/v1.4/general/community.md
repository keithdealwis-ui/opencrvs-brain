---
title: "Community"
source_url: "https://documentation.opencrvs.org/v1.4/general/community"
markdown_url: "https://documentation.opencrvs.org/v1.4/general/community.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:77d6ff8caca9523464ab6bc42586908d90a137197902587a8bf17c06fbc630a6"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/general/community.md).
...
```
GET https://documentation.opencrvs.org/v1.4/general/community.md?ask=<question>&goal=<endgoal>
```
