...
source_url: "https://documentation.opencrvs.org/v1.4/general/interoperability-roadmap"
markdown_url: "https://documentation.opencrvs.org/v1.4/general/interoperability-roadmap.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:187d56ed221073935b72b10fb9f3d7fce6f3234b5b8c3542442d2214a51b1099"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/general/interoperability-roadmap.md).
...
b) Integrated with [DHIS2](https://dhis2.org/) to standardise [event notifications](/v1.4/technology/interoperability/event-notification-clients.md) from a hospital setting for civil registration using [FHIR](https://www.hl7.org/fhir/overview.html) in Bangladesh pilot.
...
c) Release of OpenCRVS [FHIR](https://www.hl7.org/fhir/overview.html) standard W3C standard [WebSub](https://www.w3.org/TR/websub/) [webhooks](/v1.4/technology/interoperability/webhook-clients.md) for subscription.

**OpenCRVS v1.2: Jan 2023**

a) Release of the [Elasticsearch](https://www.elastic.co/) [Record Search API](/v1.4/technology/interoperability/record-search-clients.md) for use as part of a social protection interoperability collaboration the[ Digital Convergance Initiative](https://spdci.org/).

b) Release of the OpenCRVS [FHIR Location REST API](/v1.4/technology/interoperability/fhir-location-rest-api.md) for reading, updating and archiving jurisdictions and facilities.
...
```
GET https://documentation.opencrvs.org/v1.4/general/interoperability-roadmap.md?ask=<question>&goal=<endgoal>
```
