...
source_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.3.0-beta-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.3.0-beta-release-notes.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:78fc0c40522b403df9c4ea07c149a5466892f328cf06ebffee3950cb1a9aec20"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/general/releases/v1.3.0-beta-release-notes.md).
...
Upgrading from v1.2.0 to v1.3.0 requires the upgrade [Migration Notes](/v1.4/general/releases/v1.2.-to-v1.3.-migration-notes.md) to be followed precisely.
{% endhint %}
...
\
Due to this, we are releasing marriage registration in "beta", therefore not for production use. You can [configure marriage registration](/v1.4/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md) in development environments for proof of concept testing.
{% endhint %}

<figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/YhQzmMYfECsnaUGyT6RS/Screenshot%202023-09-13%20at%2013.55.29.png" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/MA3MDLQhouGW42Hblwxo/Screenshot%202023-09-13%20at%2013.58.08.png" alt=""><figcaption><p>If you decide to print in advance ...</p></figcaption></figure> <figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/nFAkznnZ1914YSKaNHnX/Screenshot%202023-09-13%20at%2013.58.52.png" alt=""><figcaption><p>...then you can track issuance</p></figcaption></figure></div>
...
\
You can [configure the informant signature](/v1.4/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md) capture on and off for birth and death events. By default marriage events require the participant and witness signatures.

<figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/0yi0W2fpqlkteV10NokB/Screenshot%202023-09-13%20at%2014.10.44.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/dUs2qI9zJkvfEhqYEkS9/Screenshot%202023-09-13%20at%2014.13.10.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/VbBgSiu2ErFJ0O7eYyDc/Screenshot%202023-09-13%20at%2014.14.33.png" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/VFhzWJeqdI4NX5aVAoZz/Screenshot%202023-09-13%20at%2014.21.56.png" alt=""><figcaption></figcaption></figure> <figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/gIcbpysMYXQNWAuFcf6T/Screenshot%202023-09-13%20at%2014.22.09.png" alt=""><figcaption></figcaption></figure></div>
...
To read more about why we made this decision, refer to our documentation [step 3.2.7 Configure declaration forms](/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-declaration-forms.md)
...
[2 Gather requirements](/v1.4/setup/2.-gather-requirements.md)

[3.2 Set-up your own country configuration](/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration.md)

[3.3 Set-up a server hosted environment](/v1.4/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)

[4 Functional configuration](/v1.4/setup/4.-functional-configuration.md)
...
```
GET https://documentation.opencrvs.org/v1.4/general/releases/v1.3.0-beta-release-notes.md?ask=<question>&goal=<endgoal>
```
