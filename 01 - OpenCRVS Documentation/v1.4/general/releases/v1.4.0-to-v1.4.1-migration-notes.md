---
title: "v1.4.0 to v1.4.1 Migration notes"
source_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.4.0-to-v1.4.1-migration-notes"
markdown_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.4.0-to-v1.4.1-migration-notes.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:0649a45afb7357577570146a9297004f3a622b74f8cfdf3922c23ceb197d4c82"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/general/releases/v1.4.0-to-v1.4.1-migration-notes.md).
...
Updated instructions are documented in the section: [4.2.5.1 Managing language content](/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.5-set-up-application-settings/3.2.9.1-managing-language-content.md)
...
{% hint style="info" %}
Please refer to the [release notes](/v1.4/general/releases/v1.1.0-release-notes.md) , which contains a video of an example code upgrade process, and our [release process including Gitflow](/v1.4/general/releases.md) branching approach.&#x20;
{% endhint %}
...
The following command pulls from a remote named "upstream" which should point to our [countryconfig](https://github.com/opencrvs/opencrvs-countryconfig) repository as documented [here](/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md).
...
6\. If you are running OpenCRVS locally, simply [start OpenCRVS](/v1.4/setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-starting-and-stopping-opencrvs.md). Migrations will automatically run on your data and you have finished upgrading OpenCRVS locally. Proceed to the next section if you have already deployed OpenCRVS to a remote server cluster.
...
```
GET https://documentation.opencrvs.org/v1.4/general/releases/v1.4.0-to-v1.4.1-migration-notes.md?ask=<question>&goal=<endgoal>
```
