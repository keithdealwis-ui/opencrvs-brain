...
source_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.4.1-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.4.1-release-notes.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:e353b86c29ffc3489b2cbdf3852d6feffc73a8cbb29d077be2b1d5784d780f15"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/general/releases/v1.4.1-release-notes.md).
...
In order to manage copy in 1.4.1 as opposed to <1.4.0, refer to the updated documentation [here](https://github.com/opencrvs/documentation/blob/master/v1.4.0/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.5-set-up-application-settings/3.2.9.1-managing-language-content).
...
```
GET https://documentation.opencrvs.org/v1.4/general/releases/v1.4.1-release-notes.md?ask=<question>&goal=<endgoal>
```
