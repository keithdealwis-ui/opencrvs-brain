...
source_url: "https://documentation.opencrvs.org/v1.4/general/releases/patch-elasticsearch-7.10.2"
markdown_url: "https://documentation.opencrvs.org/v1.4/general/releases/patch-elasticsearch-7.10.2.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:844cd2392c33f86920fa765388e67be446d4a02897e2b06b4f7cf4977ca30732"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/general/releases/patch-elasticsearch-7.10.2.md).
...
```
GET https://documentation.opencrvs.org/v1.4/general/releases/patch-elasticsearch-7.10.2.md?ask=<question>&goal=<endgoal>
```
