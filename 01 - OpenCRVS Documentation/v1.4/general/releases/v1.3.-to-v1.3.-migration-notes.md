---
title: "v1.3.\\* to v1.3.\\* Migration notes"
source_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.3.-to-v1.3.-migration-notes"
markdown_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.3.-to-v1.3.-migration-notes.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a874e38c50506417bf8cab8998bca3e51e60c5644bb78093627d7848ac8af5e0"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/general/releases/v1.3.-to-v1.3.-migration-notes.md).
...
5\. Fetch all our latest branches as [**step 17 will have added countryconfig as a remote**](/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md):
...
{% hint style="danger" %}
If you have hosted **AND CONFIGURED** OpenCRVS on a server and are capturing live registrations in production, **YOU MUST:** [**make an emergency backup of your data before proceeding**](broken://pages/u833vH6BnaGtGkPiakf6) so that you can restore in the event of any migration problems. **THIS BACKUP MUST BE STORED EXTERNALLY FROM YOUR PRODUCTION SERVER BEFORE PROCEEDING. THIS BACKUP MUST BE RESTORED SUCCESSFULLY ON A QUALITY ASSURANCE / STAGING / TEST SERVER TO ENSURE IT WORKS BEFORE CONTINUING.** &#x20;
{% endhint %}
...
```
GET https://documentation.opencrvs.org/v1.4/general/releases/v1.3.-to-v1.3.-migration-notes.md?ask=<question>&goal=<endgoal>
```
