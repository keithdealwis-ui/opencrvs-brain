---
title: "v1.2.\\* to v1.3.\\* Migration notes"
source_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.2.-to-v1.3.-migration-notes"
markdown_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.2.-to-v1.3.-migration-notes.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:123da6f5fff6b3f9bb39082244a438adfe9f089bf7cd15f2669c3fb4f96247a9"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/general/releases/v1.2.-to-v1.3.-migration-notes.md).
...
Please refer to [form migration instructions.](/v1.4/general/releases/v1.2.-to-v1.3.-migration-notes/v1.2-to-v1.3-form-migration.md)
...
4\. Ensure that the branches you have set up are ready according to your strategy explained [here](/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md).  Pull, fix conflicts, merge and test according to your strategy.

{% hint style="warning" %}
Refer to our release notes in order to understand breaking changes
{% endhint %}

5\. If you are running OpenCRVS locally, simply [start OpenCRVS](/v1.4/setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-starting-and-stopping-opencrvs.md). Migrations will automatically run on your data and you have finished upgrading OpenCRVS locally. Proceed to the next section if you have already deployed OpenCRVS to a remote server cluster.
...
2. Configure a new set of v1.3.\* servers following **ALL** the [steps 3.3.1](/v1.4/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.1-provision-your-server-nodes-with-ssh-access.md) to [3.3.5](/v1.4/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.5-setup-dns-a-records.md).
3. Deploy v1.3\* following the[ new deploy instructions](/v1.4/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md) including the new secrets
4. Check you can login to OpenCRVS v1.3 successfully.
5. OpenCRVS v1.3 is successfully installed, so now we must empty the database and restore it with your v1.2\* data. Follow these manual clear, restore and migrate process using these [steps](broken://pages/u833vH6BnaGtGkPiakf6).
...
```
GET https://documentation.opencrvs.org/v1.4/general/releases/v1.2.-to-v1.3.-migration-notes.md?ask=<question>&goal=<endgoal>
```
