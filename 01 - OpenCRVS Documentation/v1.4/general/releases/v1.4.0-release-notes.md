...
source_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.4.0-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.4/general/releases/v1.4.0-release-notes.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:38f7737a093d45c0124d4e0123091b986122677ca6a537fd010b63f421a92ef8"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/general/releases/v1.4.0-release-notes.md).
...
Upgrading from v1.3.0 to v1.4.0 requires the upgrade [Migration Notes](/v1.4/general/releases/v1.3.-to-v1.4.-migration-notes.md) to be followed precisely.

### Documentation updates

{% hint style="success" %}
The documentation section [3.3 Set-up a server hosted environment](/v1.4/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md) has been entirely re-written for the new infrastructure provisioning tasks.  We recommend that you read it before continuing.
{% endhint %}
...
```
GET https://documentation.opencrvs.org/v1.4/general/releases/v1.4.0-release-notes.md?ask=<question>&goal=<endgoal>
```
