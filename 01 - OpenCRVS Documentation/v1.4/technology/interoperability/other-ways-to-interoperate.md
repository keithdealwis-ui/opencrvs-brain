...
source_url: "https://documentation.opencrvs.org/v1.4/technology/interoperability/other-ways-to-interoperate"
markdown_url: "https://documentation.opencrvs.org/v1.4/technology/interoperability/other-ways-to-interoperate.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6baa51c2720ae4dfd6e1e4434ecb6cadc4f459eeb87f38cd71362890ab2654b7"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/technology/interoperability/other-ways-to-interoperate.md).
...
You need to create a [DNS](/v1.4/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.5-setup-dns-a-records.md) record to expose the *api.\<your-domain>* endpoint to OpenHIM.
...
```
GET https://documentation.opencrvs.org/v1.4/technology/interoperability/other-ways-to-interoperate.md?ask=<question>&goal=<endgoal>
```
