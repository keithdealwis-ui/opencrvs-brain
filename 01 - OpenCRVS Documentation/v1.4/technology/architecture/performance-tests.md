...
source_url: "https://documentation.opencrvs.org/v1.4/technology/architecture/performance-tests"
markdown_url: "https://documentation.opencrvs.org/v1.4/technology/architecture/performance-tests.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:59eaa98842ce83c12c0196c432d33466c833e4b239a0b65cc7b9e9c6ef41d74f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/technology/architecture/performance-tests.md).
...
<figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/X9Ksx9rex9ZAxCdZ3lj4/k6results.png" alt=""><figcaption></figcaption></figure>
...
![](https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/OvfZZzubxDhuO1V165wH/Screenshot%202022-06-27%20at%2014.39.06.png)
...
```
GET https://documentation.opencrvs.org/v1.4/technology/architecture/performance-tests.md?ask=<question>&goal=<endgoal>
```
