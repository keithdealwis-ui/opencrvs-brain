---
title: "Architecture"
source_url: "https://documentation.opencrvs.org/v1.4/technology/architecture"
markdown_url: "https://documentation.opencrvs.org/v1.4/technology/architecture.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f737f92df7852f5b1aebb64ab6a582e1eea765bb484fc2df4f7a7f4e00bcc06f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/technology/architecture.md).
...
To learn about the server hosting & network architecture required for hosting OpenCRVS visit [this section.](/v1.4/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)
...
We extended [FHIR](https://www.hl7.org/fhir/) to support the civil registration context. Our civil registration FHIR standard is described [here](/v1.4/technology/standards/fhir-documents.md).
...
![](https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/TK4qEvRktpeXR3q8FddC/image.png) ![](https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/IyvH71wEHCIx5pkI7ywT/image.png) ![](https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/saBf5aw4y7gGCWrCtU2X/image.png)\\
...
```
GET https://documentation.opencrvs.org/v1.4/technology/architecture.md?ask=<question>&goal=<endgoal>
```
