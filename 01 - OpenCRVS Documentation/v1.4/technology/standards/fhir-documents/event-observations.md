...
source_url: "https://documentation.opencrvs.org/v1.4/technology/standards/fhir-documents/event-observations"
markdown_url: "https://documentation.opencrvs.org/v1.4/technology/standards/fhir-documents/event-observations.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:27c0242717e7ee0ad4f2de7463438c20560d06e034fa4b6a1228432762f3380c"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/technology/standards/fhir-documents/event-observations.md).
...
```
GET https://documentation.opencrvs.org/v1.4/technology/standards/fhir-documents/event-observations.md?ask=<question>&goal=<endgoal>
```
