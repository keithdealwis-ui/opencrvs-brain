...
source_url: "https://documentation.opencrvs.org/v1.4/technology/standards/fhir-documents/event-composition"
markdown_url: "https://documentation.opencrvs.org/v1.4/technology/standards/fhir-documents/event-composition.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:1616ac99b47c7281da17b0047d1f42661dd679bd75a55afed7f7e281e3cdabcd"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/technology/standards/fhir-documents/event-composition.md).
...
```
GET https://documentation.opencrvs.org/v1.4/technology/standards/fhir-documents/event-composition.md?ask=<question>&goal=<endgoal>
```
