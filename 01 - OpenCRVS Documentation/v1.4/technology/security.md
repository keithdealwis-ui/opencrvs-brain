---
title: "Security"
source_url: "https://documentation.opencrvs.org/v1.4/technology/security"
markdown_url: "https://documentation.opencrvs.org/v1.4/technology/security.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:1333d338b928f486939ae7d2e8fd8788de6a066700f2b4a7f0c2e15dac105945"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/technology/security.md).
...
We provide a "Data Security Framework" document explained further with a video in [this section](/v1.4/setup/6.-go-live/3.3.4-set-up-an-smtp-server-for-opencrvs-monitoring-alerts.md).  The purpose of this document is to provide organisations with:
...
```
GET https://documentation.opencrvs.org/v1.4/technology/security.md?ask=<question>&goal=<endgoal>
```
