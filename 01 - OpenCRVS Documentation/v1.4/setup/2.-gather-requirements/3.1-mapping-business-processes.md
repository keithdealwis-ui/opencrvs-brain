...
source_url: "https://documentation.opencrvs.org/v1.4/setup/2.-gather-requirements/3.1-mapping-business-processes"
markdown_url: "https://documentation.opencrvs.org/v1.4/setup/2.-gather-requirements/3.1-mapping-business-processes.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:1d9ef046fdf787d5628025ed89555e43873ad5dd0d8c9dafbf891d4f3d16715f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/setup/2.-gather-requirements/3.1-mapping-business-processes.md).
...
```
GET https://documentation.opencrvs.org/v1.4/setup/2.-gather-requirements/3.1-mapping-business-processes.md?ask=<question>&goal=<endgoal>
```
