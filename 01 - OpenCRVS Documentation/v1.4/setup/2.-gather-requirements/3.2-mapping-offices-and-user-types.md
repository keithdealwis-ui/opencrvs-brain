...
source_url: "https://documentation.opencrvs.org/v1.4/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types"
markdown_url: "https://documentation.opencrvs.org/v1.4/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f175bcff4dc23596d63948559e3b78c640f5d7475418df870de524c1e969f8bf"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types.md).
...
```
GET https://documentation.opencrvs.org/v1.4/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types.md?ask=<question>&goal=<endgoal>
```
