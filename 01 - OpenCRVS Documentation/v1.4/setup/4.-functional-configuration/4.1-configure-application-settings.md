...
source_url: "https://documentation.opencrvs.org/v1.4/setup/4.-functional-configuration/4.1-configure-application-settings"
markdown_url: "https://documentation.opencrvs.org/v1.4/setup/4.-functional-configuration/4.1-configure-application-settings.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:21b1aeefbf7abeb3acb70fe71f3c8d21fc6f7ec3e22816e3c8eb2fc3e2fdc681"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/setup/4.-functional-configuration/4.1-configure-application-settings.md).
...
![](https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/6tHf4nPS1yjBaNt3QWVF/app-config.png)
...
```
GET https://documentation.opencrvs.org/v1.4/setup/4.-functional-configuration/4.1-configure-application-settings.md?ask=<question>&goal=<endgoal>
```
