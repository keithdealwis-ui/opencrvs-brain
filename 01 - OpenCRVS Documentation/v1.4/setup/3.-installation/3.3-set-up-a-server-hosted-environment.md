...
source_url: "https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.3-set-up-a-server-hosted-environment"
markdown_url: "https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:472cdc1c3933b5c45fdc3c6d81c55ad1db88be1603fffac45a5c999304d01a12"
---
...
<figure><img src="https://2365243258-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FCCxReqNLi05GgVKnwb07%2Fuploads%2FzUO81YAk25cbPn2gCPVE%2FOpenCRVS%20Network%20%26%20Servers.png?alt=media&amp;token=12f2b9d0-6e27-4f9e-8088-072edb32f40d" alt=""><figcaption></figcaption></figure>
...
You must have a working SMTP server and SMTP user details to deploy OpenCRVS.  Staff onboarding and monitoring requires an Email service.<br>
...
```
GET https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md?ask=<question>&goal=<endgoal>
```
