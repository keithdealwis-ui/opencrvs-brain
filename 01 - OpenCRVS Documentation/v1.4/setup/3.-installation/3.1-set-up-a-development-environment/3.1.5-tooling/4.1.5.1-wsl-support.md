...
source_url: "https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.1-set-up-a-development-environment/3.1.5-tooling/4.1.5.1-wsl-support"
markdown_url: "https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.1-set-up-a-development-environment/3.1.5-tooling/4.1.5.1-wsl-support.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:9cf22d7284d89f196fb3913c729c9083aababa88b6545054905d77b57fe6d360"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.1-set-up-a-development-environment/3.1.5-tooling/4.1.5.1-wsl-support.md).
...
Make sure that Docker Desktop is using WSL 2 based engine in it's settings<br>

<figure><img src="https://2365243258-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FCCxReqNLi05GgVKnwb07%2Fuploads%2Fx0jdi5DElGLMwIEj6PmO%2Fimage.png?alt=media&amp;token=157177a7-1021-4dd7-b402-4ac6c88d74f5" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.1-set-up-a-development-environment/3.1.5-tooling/4.1.5.1-wsl-support.md?ask=<question>&goal=<endgoal>
```
