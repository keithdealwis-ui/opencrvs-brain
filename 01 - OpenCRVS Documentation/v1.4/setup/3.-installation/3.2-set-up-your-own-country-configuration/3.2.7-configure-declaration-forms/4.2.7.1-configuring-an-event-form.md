...
source_url: "https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-declaration-forms/4.2.7.1-configuring-an-event-form"
markdown_url: "https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-declaration-forms/4.2.7.1-configuring-an-event-form.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:c5498180be4bd1724cbff659838c2101e53db524aaa4cbd88ff443d747606a6c"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-declaration-forms/4.2.7.1-configuring-an-event-form.md).
...
![](https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/AHNvEc6RkClFlwE2hlJ1/Screenshot%202023-09-07%20at%2016.42.23.png)
...
<figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/Of8U6PTNMFOgOVfrwRxJ/Screenshot%202023-09-07%20at%2018.33.46.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/tvhnahWH2wlAQbV6xMip/Screenshot%202023-09-07%20at%2018.35.30.png" alt=""><figcaption><p>A required field in the birth form</p></figcaption></figure>

{% hint style="danger" %}
Required field functions must be included **AS IS** for OpenCRVS civil registration functionality to operate.  They **CANNOT** **BE CUSTOMISED.**  They are U.N. standard fields.  If you are receiving direction to customise them from civil registration authorities, please get in touch with us at <team@opencrvs.org>  We can liaise with your authorities to explain why they are configured the way they are, usually for [standardisation](/v1.4/technology/standards.md) and [interoperability](/v1.4/technology/interoperability.md) requirements.  **Customising these fields inhibits your government's ability to interoperate between departments.**
{% endhint %}
...
<figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/2mqPQjqK7n6oxgMQZWJA/Screenshot%202023-09-07%20at%2018.36.36.png" alt=""><figcaption><p>Optional fields in the birth form</p></figcaption></figure>
...
For example, how the field renders multi-lingual [content](/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.5-set-up-application-settings/3.2.9.1-managing-language-content.md) for example with "**label**" and "**placeholder**".
...
There are OpenCRVS specific props such as "**mapping**" regarding how these fields map to and from GraphQL/FHIR.  The mapping function points to the certificate handlebar prop you use when adding the user inputted value onto a [certificate](/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.6-configure-certificate-templates.md).  All available required and optional field certificate handlebars are listed in the [certificate-handlebars.ts](https://github.com/opencrvs/opencrvs-countryconfig/blob/develop/src/form/birth/certificate-handlebars.ts) file.
...
So that OpenCRVS can programatically create a powerful search and analytics capability calculating for example statistical information disaggregated by location (state/province/district/municipality), location level selects are dynamically generated from the administrative structure you prepared in [step 3.2.2](/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.2-set-up-administrative-address-divisions.md).  Selects as an input type are particularly powerful in the user experience because they make it impossible for human error (spelling mistakes) when capturing the address.

<figure><img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/kyvxv4TbsrmQR2Xr138A/Screenshot%202023-09-12%20at%2011.05.05.png" alt=""><figcaption><p>You will notice that every location level imported in step 3.2.2 is mandatory</p></figcaption></figure>
...
d) Finally ensure you have changed the country code from "FAR" to your country code in the [JS application settings](/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.5-set-up-application-settings.md) and the default [initialValue](https://github.com/opencrvs/opencrvs-countryconfig/blob/b3ee310aaaaa616ce0a41a6eb69a403afc2e50bb/src/form/addresses/address-fields.ts#L217) for the country select.
...
```
GET https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-declaration-forms/4.2.7.1-configuring-an-event-form.md?ask=<question>&goal=<endgoal>
```
