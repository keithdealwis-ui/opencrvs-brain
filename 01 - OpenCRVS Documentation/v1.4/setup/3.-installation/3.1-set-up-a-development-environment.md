---
title: "4.1 Set-up a local development environment"
source_url: "https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.1-set-up-a-development-environment"
markdown_url: "https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.1-set-up-a-development-environment.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:d3bdf54a2c469f3f17f8b47d644ee900618c1b488c217cb51b6901f6db1a61a6"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.1-set-up-a-development-environment.md).
...
```
GET https://documentation.opencrvs.org/v1.4/setup/3.-installation/3.1-set-up-a-development-environment.md?ask=<question>&goal=<endgoal>
```
