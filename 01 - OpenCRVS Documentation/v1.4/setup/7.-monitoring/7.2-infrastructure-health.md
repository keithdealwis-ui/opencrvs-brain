...
source_url: "https://documentation.opencrvs.org/v1.4/setup/7.-monitoring/7.2-infrastructure-health"
markdown_url: "https://documentation.opencrvs.org/v1.4/setup/7.-monitoring/7.2-infrastructure-health.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:5ee9aba7fe9b4e851a10d2e78e6ab13164c4cdfbd52eb210bd89398e2a393304"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/setup/7.-monitoring/7.2-infrastructure-health.md).
...
![](https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/2sKoLEn4VHyy9piAZYCq/image.png)
...
![](https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/MxMxii4Ldbks7czyvf0K/image.png)
...
![](https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/4NCWdXXnt37OA86CfM97/image.png)
...
```
GET https://documentation.opencrvs.org/v1.4/setup/7.-monitoring/7.2-infrastructure-health.md?ask=<question>&goal=<endgoal>
```
