...
source_url: "https://documentation.opencrvs.org/v1.4/setup/7.-monitoring/7.5-managing-a-docker-swarm"
markdown_url: "https://documentation.opencrvs.org/v1.4/setup/7.-monitoring/7.5-managing-a-docker-swarm.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:533510757ca5433b90b548c5915ebac5c3d17038883e25c898ab9a77824de5eb"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/setup/7.-monitoring/7.5-managing-a-docker-swarm.md).
...
```
GET https://documentation.opencrvs.org/v1.4/setup/7.-monitoring/7.5-managing-a-docker-swarm.md?ask=<question>&goal=<endgoal>
```
