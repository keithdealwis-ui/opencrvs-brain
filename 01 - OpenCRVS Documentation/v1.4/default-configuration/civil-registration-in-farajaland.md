...
source_url: "https://documentation.opencrvs.org/v1.4/default-configuration/civil-registration-in-farajaland"
markdown_url: "https://documentation.opencrvs.org/v1.4/default-configuration/civil-registration-in-farajaland.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:9635eb33c2afde761249e825ebd39ab24c4b3761fb9fa1249c27e2965bfd77f5"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/default-configuration/civil-registration-in-farajaland.md).
...
```
GET https://documentation.opencrvs.org/v1.4/default-configuration/civil-registration-in-farajaland.md?ask=<question>&goal=<endgoal>
```
