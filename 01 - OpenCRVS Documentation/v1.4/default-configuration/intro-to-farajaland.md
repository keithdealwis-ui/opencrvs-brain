...
source_url: "https://documentation.opencrvs.org/v1.4/default-configuration/intro-to-farajaland"
markdown_url: "https://documentation.opencrvs.org/v1.4/default-configuration/intro-to-farajaland.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:dd892aa6fedd343f80917e5451fe2e93678367729c0bf64e5b69c156bd17d95a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/default-configuration/intro-to-farajaland.md).
...
![Provinces and Districts of Farajaland](https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/jA9BbjIOT2C1IPmlFQ9A/farajaland-map.png)
...
```
GET https://documentation.opencrvs.org/v1.4/default-configuration/intro-to-farajaland.md?ask=<question>&goal=<endgoal>
```
