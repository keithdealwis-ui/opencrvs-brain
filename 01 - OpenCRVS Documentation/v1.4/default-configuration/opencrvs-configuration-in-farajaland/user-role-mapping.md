...
source_url: "https://documentation.opencrvs.org/v1.4/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping"
markdown_url: "https://documentation.opencrvs.org/v1.4/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:cfd01d13beaab7e6a0fe823a49683cf6189182977eb9c07eb6bee333068e9027"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md).
...
```
GET https://documentation.opencrvs.org/v1.4/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md?ask=<question>&goal=<endgoal>
```
