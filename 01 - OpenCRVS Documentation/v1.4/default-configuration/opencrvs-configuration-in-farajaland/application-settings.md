...
source_url: "https://documentation.opencrvs.org/v1.4/default-configuration/opencrvs-configuration-in-farajaland/application-settings"
markdown_url: "https://documentation.opencrvs.org/v1.4/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:89efde3df094bd67eb4e40c837a41cdddf5663c13c9dd583298e9097f218ec73"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md).
...
| Government logo                                      | <img src="https://content.gitbook.com/content/CCxReqNLi05GgVKnwb07/blobs/zPPVjJxc3FUxsyZkqpdW/image.png" alt="" data-size="line"> |                                                                                              |
...
```
GET https://documentation.opencrvs.org/v1.4/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md?ask=<question>&goal=<endgoal>
```
