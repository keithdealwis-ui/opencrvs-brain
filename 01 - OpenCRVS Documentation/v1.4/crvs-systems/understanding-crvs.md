...
source_url: "https://documentation.opencrvs.org/v1.4/crvs-systems/understanding-crvs"
markdown_url: "https://documentation.opencrvs.org/v1.4/crvs-systems/understanding-crvs.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:05cadfc42ed41c8ad79ea1d3c98ef38360b8c133f6f65e868a441862a20910c2"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/crvs-systems/understanding-crvs.md).
...
```
GET https://documentation.opencrvs.org/v1.4/crvs-systems/understanding-crvs.md?ask=<question>&goal=<endgoal>
```
