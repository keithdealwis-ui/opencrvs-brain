---
title: "Welcome!"
source_url: "https://documentation.opencrvs.org/v1.4/readme"
markdown_url: "https://documentation.opencrvs.org/v1.4/readme.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:ce739fbac6ee2b70e026d7f879c3e82d5619b0791653d773df2ef85d1fb0b857"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/readme.md).
...
* to understand what effective digital CRVS looks like and the role that OpenCRVS can play, check out [CRVS Systems](/v1.4/crvs-systems/effective-digital-crvs-systems.md).&#x20;
* to explore the OpenCRVS functionality, take a look at the [Product Specifications](/v1.4/product-specifications/functional-architecture.md) and the [Default Configuration for Farajaland](/v1.4/default-configuration/intro-to-farajaland.md)
* to understand how OpenCRVS works technically, go to [Technology](/v1.4/technology/architecture.md)
* to setup you own OpenCRVS project, then go to [Setup](/v1.4/setup/1.-establish-project-and-team.md)
* to see what's coming next for OpenCRVS, see the [Product Roadmap](/v1.4/general/product-roadmap.md)
...
```
GET https://documentation.opencrvs.org/v1.4/readme.md?ask=<question>&goal=<endgoal>
```
