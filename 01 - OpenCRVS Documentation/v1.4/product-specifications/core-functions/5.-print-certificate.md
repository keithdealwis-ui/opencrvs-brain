---
title: "5. Print certificate"
source_url: "https://documentation.opencrvs.org/v1.4/product-specifications/core-functions/5.-print-certificate"
markdown_url: "https://documentation.opencrvs.org/v1.4/product-specifications/core-functions/5.-print-certificate.md"
version: "v1.4"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:e6f99221876ab67730d3ce40c3090a6f2a03846a9308e5afc059865ed0c2625f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.4/product-specifications/core-functions/5.-print-certificate.md).
...
```
GET https://documentation.opencrvs.org/v1.4/product-specifications/core-functions/5.-print-certificate.md?ask=<question>&goal=<endgoal>
```
