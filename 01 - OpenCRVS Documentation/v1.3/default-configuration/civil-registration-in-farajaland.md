...
source_url: "https://documentation.opencrvs.org/v1.3/default-configuration/civil-registration-in-farajaland"
markdown_url: "https://documentation.opencrvs.org/v1.3/default-configuration/civil-registration-in-farajaland.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b9ee70917a061269a3331522a7f65499fcd55d2c7c92f8bbc8dfd1010488be6d"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/default-configuration/civil-registration-in-farajaland.md).
...
```
GET https://documentation.opencrvs.org/v1.3/default-configuration/civil-registration-in-farajaland.md?ask=<question>&goal=<endgoal>
```
