...
source_url: "https://documentation.opencrvs.org/v1.3/general/releases/v1.3.-to-v1.3.-migration-notes"
markdown_url: "https://documentation.opencrvs.org/v1.3/general/releases/v1.3.-to-v1.3.-migration-notes.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:5c8c195c9e722074d4f605f2ba82cef80dc905fcbe1bc34c79a9bc4519753cb4"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/general/releases/v1.3.-to-v1.3.-migration-notes.md).
...
5\. Fetch all our latest branches as [**step 17 will have added countryconfig as a remote**](/v1.3/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md):
...
```
GET https://documentation.opencrvs.org/v1.3/general/releases/v1.3.-to-v1.3.-migration-notes.md?ask=<question>&goal=<endgoal>
```
