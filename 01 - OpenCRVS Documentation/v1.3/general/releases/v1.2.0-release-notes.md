...
source_url: "https://documentation.opencrvs.org/v1.3/general/releases/v1.2.0-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.3/general/releases/v1.2.0-release-notes.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:bad3dcede3818399ecf4d79cebd7665bb0307bb71c435130e6c4b6fa845b4107"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/general/releases/v1.2.0-release-notes.md).
...
Upgrading from v1.1.0 to v1.2.0 requires the upgrade [Migration Notes](/v1.3/general/releases/v1.1.-to-v1.2.-migration-notes.md) to be followed precisely.
...
The entire [Interoperability](/v1.3/technology/interoperability.md) section.

New test [usernames](/v1.3/setup/3.-installation/3.1-set-up-a-development-environment/3.1.4-log-in-to-opencrvs-locally.md) following the format: *inital.surname*

New [Performance](/v1.3/technology/architecture/performance-tests.md) test reports
...
New [commands for importing](broken://pages/UMgXlD9xhOMGGMwUKGH1) the set up files

New [commands for creating factory reset zips](broken://pages/ulEzPN9n9l2nVKWigvlP)
...
New subdomains required for Minio in [DNS](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.5-setup-dns-a-records.md) settings

Configuring any [comms gateway](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.3-provision-a-comms-gateway.md), not just an SMS gateway, e.g. WhatsApp

Clearer instructions for [deploying](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md) either automated or manual with Minio secrets added

Clearer instructions for [backing](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.8-automated-and-manual-backup-and-manual-restore.md) up and restoring OpenCRVS data

[Clearing a server to factory defaults](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.7-seeding-and-clearing-data-on-a-server.md)
...
{% hint style="info" %}
Follow the[ Migration Notes ](/v1.3/general/releases/v1.1.-to-v1.2.-migration-notes.md)to migrate between versions of core
{% endhint %}
...
{% hint style="warning" %}
The country confguration repository [opencrvs-farajaland](https://github.com/opencrvs/opencrvs-farajaland) has been entirely refactored. Please contact us at <team@opencrvs.org> if you need any help rebasing changes in this repository.
{% endhint %}
...
```
GET https://documentation.opencrvs.org/v1.3/general/releases/v1.2.0-release-notes.md?ask=<question>&goal=<endgoal>
```
