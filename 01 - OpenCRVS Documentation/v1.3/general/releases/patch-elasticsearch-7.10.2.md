...
source_url: "https://documentation.opencrvs.org/v1.3/general/releases/patch-elasticsearch-7.10.2"
markdown_url: "https://documentation.opencrvs.org/v1.3/general/releases/patch-elasticsearch-7.10.2.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6c2219afb0d79b20dfe4bb58a97be17cfc797677791cca7b7bea312e55aec7ba"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/general/releases/patch-elasticsearch-7.10.2.md).
...
```
GET https://documentation.opencrvs.org/v1.3/general/releases/patch-elasticsearch-7.10.2.md?ask=<question>&goal=<endgoal>
```
