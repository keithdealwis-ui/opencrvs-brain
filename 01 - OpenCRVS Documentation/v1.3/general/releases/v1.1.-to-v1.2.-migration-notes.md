...
source_url: "https://documentation.opencrvs.org/v1.3/general/releases/v1.1.-to-v1.2.-migration-notes"
markdown_url: "https://documentation.opencrvs.org/v1.3/general/releases/v1.1.-to-v1.2.-migration-notes.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b5c2c37cccc2116548a6fbfcea3ca2124a5f261033c041ba7301c126b5d3ace7"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/general/releases/v1.1.-to-v1.2.-migration-notes.md).
...
4\. Ensure that the branches you have set up are ready according to the new forking instructions [here](/v1.3/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md). Specifically from [step 9 to 17](/v1.3/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md).
...
5\. Fetch all our latest branches as [**step 17 will have added Farajaland as a remote**](/v1.3/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md):
...
8\. If you are running OpenCRVS locally, simply [start OpenCRVS](/v1.3/setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-starting-and-stopping-opencrvs.md). Migrations will automatically run on your data and you have finished upgrading OpenCRVS locally. Proceed to the next section if you have already deployed OpenCRVS to a remote server cluster.
...
2. Configure a new set of v1.2.\* servers following **ALL** the [steps 3.3.1](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.1-provision-your-server-nodes-with-ssh-access.md) to [3.3.5](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.5-setup-dns-a-records.md).

{% hint style="info" %}
In [step 3.3.5](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.5-setup-dns-a-records.md), if you configured your DNS settings with a wilcard, e.g. *\*.\<your\_domain>* then you can continue to the next step. Otherwise in OpenCRVS v1.2\* we have introduced the following new subdomains, so you must create A records for them.
...
3\. Deploy v1.2\* following the[ new deploy instructions](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md) including the new secrets **MINIO\_ROOT\_USER** and **MINIO\_ROOT\_PASSWORD** and a default set of your country configuration factory reset backups.
...
6\. OpenCRVS v1.2 is successfully installed, so now we must empty the database and restore it with your v1.1\* data. Follow these manual restore process using these [steps](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.8-automated-and-manual-backup-and-manual-restore.md).
...
```
GET https://documentation.opencrvs.org/v1.3/general/releases/v1.1.-to-v1.2.-migration-notes.md?ask=<question>&goal=<endgoal>
```
