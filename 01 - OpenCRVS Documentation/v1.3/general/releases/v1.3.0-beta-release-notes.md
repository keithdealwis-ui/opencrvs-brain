...
source_url: "https://documentation.opencrvs.org/v1.3/general/releases/v1.3.0-beta-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.3/general/releases/v1.3.0-beta-release-notes.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:21b8f4056667da3239bc2e963443de6d0b5de63ac003cf5f61ab603f3f74d0f6"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/general/releases/v1.3.0-beta-release-notes.md).

# v1.3.0: Release notes

{% hint style="success" %}
v1.3.0 release includes some exciting new functionality and architectural improvements. This core release is to be used in conjunction with a forked country configuration release v1.3.0<br>

Upgrading from v1.2.0 to v1.3.0 requires the upgrade [Migration Notes](/v1.3/general/releases/v1.2.-to-v1.3.-migration-notes.md) to be followed precisely.
{% endhint %}
...
\
Due to this, we are releasing marriage registration in "beta", therefore not for production use. You can [configure marriage registration](/v1.3/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md) in development environments for proof of concept testing.
{% endhint %}

<figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FNzZwitbM97cTzI0dSlsF%2FScreenshot%202023-09-13%20at%2013.55.29.png?alt=media&amp;token=24ea18ab-4e7e-4616-8fa9-4c4f2d3f3824" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FBly2afTh6vmiavC80EDs%2FScreenshot%202023-09-13%20at%2013.58.08.png?alt=media&amp;token=13af3717-eaeb-4c02-926c-59aea1edf8ff" alt=""><figcaption><p>If you decide to print in advance ...</p></figcaption></figure> <figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FgPg0XQ3tBelwB6VLGmGZ%2FScreenshot%202023-09-13%20at%2013.58.52.png?alt=media&amp;token=cf343d4e-b55f-4abc-ae20-0b053c014c18" alt=""><figcaption><p>...then you can track issuance</p></figcaption></figure></div>
...
\
You can [configure the informant signature](/v1.3/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md) capture on and off for birth and death events. By default marriage events require the participant and witness signatures.

<figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FjO0wbHDD9Ir4JP8R78nW%2FScreenshot%202023-09-13%20at%2014.10.44.png?alt=media&amp;token=a625f2e9-2eb0-4a52-9323-1bcc4003cf84" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FfORVJBwnvx0PDmCwUfhH%2FScreenshot%202023-09-13%20at%2014.13.10.png?alt=media&amp;token=4747e09d-2d14-424e-9d93-4095f33dc2e6" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FJ3rPoaW7vDCeWyV9Y8QE%2FScreenshot%202023-09-13%20at%2014.14.33.png?alt=media&amp;token=a7a01a40-a642-470a-b31c-87dbf073eed8" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FJGL30f7uyuNugsQvRfG9%2FScreenshot%202023-09-13%20at%2014.21.56.png?alt=media&amp;token=1fd1baf6-7956-4a3f-9072-af3a89373e71" alt=""><figcaption></figcaption></figure> <figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FfLnaXHBKZfG5gkNJ6UGC%2FScreenshot%202023-09-13%20at%2014.22.09.png?alt=media&amp;token=a74b2a1d-c0d7-49ce-b5d1-d809e4fa6bb3" alt=""><figcaption></figcaption></figure></div>
...
To read more about why we made this decision, refer to our documentation [step 3.2.7 Configure declaration forms](/v1.3/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-declaration-forms.md)
...
\
Migration scripts will automatically upgrade your OpenCRVS v1.2 data to be supported in v1.3.  Breaking changes that are not supported by automated migrations, or that require manual steps are listed below.  Follow the [Migration Notes](/v1.3/general/releases/v1.2.-to-v1.3.-migration-notes.md) to migrate between versions of core
...
[2 Gather requirements](/v1.3/setup/2.-gather-requirements.md)
...
[4 Functional configuration](/v1.3/setup/4.-functional-configuration.md)
...
```
GET https://documentation.opencrvs.org/v1.3/general/releases/v1.3.0-beta-release-notes.md?ask=<question>&goal=<endgoal>
```
