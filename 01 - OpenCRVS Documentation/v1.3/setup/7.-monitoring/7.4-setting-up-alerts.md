---
title: "7.4 Setting up alerts"
source_url: "https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.4-setting-up-alerts"
markdown_url: "https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.4-setting-up-alerts.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:7905afedcfa0a2ccd7845c9ab674f288a9d266f7b176b377389cad96dbf64e47"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.4-setting-up-alerts.md).
...
```
GET https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.4-setting-up-alerts.md?ask=<question>&goal=<endgoal>
```
