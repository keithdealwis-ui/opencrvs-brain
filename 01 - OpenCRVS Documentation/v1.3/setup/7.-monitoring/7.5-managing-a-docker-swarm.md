---
title: "7.5 Managing a Docker Swarm"
source_url: "https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.5-managing-a-docker-swarm"
markdown_url: "https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.5-managing-a-docker-swarm.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:896f3663c3b134498a6873708f121c43d652bd843e66da85ff4898b83b7c268a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.5-managing-a-docker-swarm.md).
...
```
GET https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.5-managing-a-docker-swarm.md?ask=<question>&goal=<endgoal>
```
