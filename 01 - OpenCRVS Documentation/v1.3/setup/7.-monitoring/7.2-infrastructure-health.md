---
title: "7.2 Infrastructure health"
source_url: "https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.2-infrastructure-health"
markdown_url: "https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.2-infrastructure-health.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a2278cd054863ddbb8d6c6e255a8159bb9f666857b2c2ea9dd21efc729ac7906"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.2-infrastructure-health.md).
...
![](https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2Fgit-blob-d637572f749f09f37abec4c89fa954b677f0715a%2Fimage.png?alt=media)
...
![](https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2Fgit-blob-cae64d9e3057d6d0b684c0f8c428993e62d6f9a5%2Fimage.png?alt=media)
...
```
GET https://documentation.opencrvs.org/v1.3/setup/7.-monitoring/7.2-infrastructure-health.md?ask=<question>&goal=<endgoal>
```
