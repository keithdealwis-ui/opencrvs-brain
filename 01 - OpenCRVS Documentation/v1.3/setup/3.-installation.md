...
source_url: "https://documentation.opencrvs.org/v1.3/setup/3.-installation"
markdown_url: "https://documentation.opencrvs.org/v1.3/setup/3.-installation.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:01b64f99563a97a80ebfc93f66b85663b114bcbe4c2f3034a26edbf3d43fc973"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/setup/3.-installation.md).
...
[3.1 Set-up a local development environment](/v1.3/setup/3.-installation/3.1-set-up-a-development-environment.md)
{% endcontent-ref %}
...
```
GET https://documentation.opencrvs.org/v1.3/setup/3.-installation.md?ask=<question>&goal=<endgoal>
```
