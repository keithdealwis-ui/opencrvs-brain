---
title: "2. Gather requirements"
source_url: "https://documentation.opencrvs.org/v1.3/setup/2.-gather-requirements"
markdown_url: "https://documentation.opencrvs.org/v1.3/setup/2.-gather-requirements.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:928c48370688af68eea69c6acc05c5cbb01308ec339d75393fc16ea015bb1360"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/setup/2.-gather-requirements.md).
...
* [ ] **Rules and regulations for civil registration in your country**\
  ...
  <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p><strong>Note.</strong> rules and regulations should help a country achieve universal civil registration, not get in the way. A comprehensive review of all CRVS rules and regulations should be conducted as part of analysis to inform effective digitised civil registration services - this may mean reform is required as part of a digital transformation programme.</p></div>
...
```
GET https://documentation.opencrvs.org/v1.3/setup/2.-gather-requirements.md?ask=<question>&goal=<endgoal>
```
