---
title: "4.2 Configure registration periods and fees"
source_url: "https://documentation.opencrvs.org/v1.3/setup/4.-functional-configuration/4.2-configure-registration-periods-and-fees"
markdown_url: "https://documentation.opencrvs.org/v1.3/setup/4.-functional-configuration/4.2-configure-registration-periods-and-fees.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:5120b23be4badd64a71d969df09ed7ab3d62472ab1ad15534f8ac88c96d34832"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/setup/4.-functional-configuration/4.2-configure-registration-periods-and-fees.md).
...
![](https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FHHDTzegOcTyqNkD8cm7S%2Fapp-config-birth.png?alt=media\&token=893a1be8-0e29-42c7-963d-b784523f1b30)
...
```
GET https://documentation.opencrvs.org/v1.3/setup/4.-functional-configuration/4.2-configure-registration-periods-and-fees.md?ask=<question>&goal=<endgoal>
```
