---
title: "3.1.3 Starting and stopping OpenCRVS"
source_url: "https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-starting-and-stopping-opencrvs"
markdown_url: "https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-starting-and-stopping-opencrvs.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:1f8dd6a4fc19353be7bd98bad014eabb54707bb6b617b9c9d9ff6a331e90e962"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-starting-and-stopping-opencrvs.md).
...
```
GET https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-starting-and-stopping-opencrvs.md?ask=<question>&goal=<endgoal>
```
