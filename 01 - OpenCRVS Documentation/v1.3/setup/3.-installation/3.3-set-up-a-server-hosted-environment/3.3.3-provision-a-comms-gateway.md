---
title: "3.3.3 Provision a comms gateway"
source_url: "https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.3-provision-a-comms-gateway"
markdown_url: "https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.3-provision-a-comms-gateway.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:880a93376729a1ff2f76029fd13402205aaae490de1680764adeecdf42b1d999"
---
...
1. You apply all API keys you receive from your communications provider to the CI/CD workflow Github Action in the [deployment](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md) step.
...
```
GET https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.3-provision-a-comms-gateway.md?ask=<question>&goal=<endgoal>
```
