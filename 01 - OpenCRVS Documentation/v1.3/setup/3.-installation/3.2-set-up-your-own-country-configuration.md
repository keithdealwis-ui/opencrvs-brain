---
title: "3.2 Set-up your own country configuration"
source_url: "https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.2-set-up-your-own-country-configuration"
markdown_url: "https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.2-set-up-your-own-country-configuration.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:dc0637b05195154c45476f6c71b5e351c4d12a6b36a967c6ede09ae118a15068"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.2-set-up-your-own-country-configuration.md).
...
{% hint style="info" %}
OpenCRVS must be configured for your country locally, before deploying to a server in the next section: [3.3 Set-up a server-hosted environment](/v1.3/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)
{% endhint %}
...
```
GET https://documentation.opencrvs.org/v1.3/setup/3.-installation/3.2-set-up-your-own-country-configuration.md?ask=<question>&goal=<endgoal>
```
