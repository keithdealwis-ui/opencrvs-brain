---
title: "Introduction"
source_url: "https://documentation.opencrvs.org/v1.3/readme"
markdown_url: "https://documentation.opencrvs.org/v1.3/readme.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:bdbcee4add7f262a489d532f03046882baea803ff9318f6fbaab262bc360a1fc"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/readme.md).
...
* to explore the OpenCRVS functionality, check out the [Product Specifications](/v1.3/product-specifications/functional-architecture.md) and the [Default Configuration for Farajaland](/v1.3/default-configuration/intro-to-farajaland.md)
* to understand how OpenCRVS works technically, go to [Technology](/v1.3/technology/architecture.md)
* to setup you own OpenCRVS instance and get it quickly into the hands of users, then go to [Setup](/v1.3/setup/1.-establish-team.md)
* to see what's coming next for OpenCRVS, see the [Product Roadmap](/v1.3/general/product-roadmap.md)
...
```
GET https://documentation.opencrvs.org/v1.3/readme.md?ask=<question>&goal=<endgoal>
```
