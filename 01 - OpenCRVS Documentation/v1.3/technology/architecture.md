---
title: "Architecture"
source_url: "https://documentation.opencrvs.org/v1.3/technology/architecture"
markdown_url: "https://documentation.opencrvs.org/v1.3/technology/architecture.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:923767c7a0507305bf876b7c86ffd3c298a8c7b15e204e685573fc5e9d1df474"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/technology/architecture.md).
...
{% file src="/files/1wL5UBoJj5pk4nGCwsN0" %}
...
We extended [FHIR](https://www.hl7.org/fhir/) to support the civil registration context. Our civil registration FHIR standard is described [here](/v1.3/technology/standards/fhir-documents.md).
...
![](https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2Fgit-blob-c5aaca6d3e131910ea5b924420226c74e8a3f2b8%2Fimage.png?alt=media) ![](https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2Fgit-blob-471dc93293df45d85b6955f6e225f33738212f50%2Fimage.png?alt=media) ![](https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2Fgit-blob-28540fcd8d5ba39391224103a52563b4cc9b0f7a%2Fimage.png?alt=media)\\
...
* [auth](https://github.com/opencrvs/opencrvs-core/tree/master/packages/auth) - the authentication microservice for OpenCRVS, [JWT](https://jwt.io/) token generation and management in [Redis](https://www.redislabs.com/). Our client applications are protected by SMS [2-Factor Authentication](https://en.wikipedia.org/wiki/Multi-factor_authentication). Our apps and microservices utilise [OAuth best practices](https://tools.ietf.org/id/draft-ietf-oauth-jwt-bcp-02.html) for JWT tokens.
...
Using an Android [progressive web application](https://developer.mozilla.org/en-US/docs/Web/Progressive_web_apps/Introduction) for our client applications means that we can take advantage of offline functionality and native mobile features using [Workbox](https://developers.google.com/web/tools/workbox), without the overhead of maintaining multiple web and mobile codebases and respective App/Play Store releases.
...
```
GET https://documentation.opencrvs.org/v1.3/technology/architecture.md?ask=<question>&goal=<endgoal>
```
