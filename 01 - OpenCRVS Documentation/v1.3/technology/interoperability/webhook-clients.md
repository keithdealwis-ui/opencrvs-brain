---
title: "Webhook clients"
source_url: "https://documentation.opencrvs.org/v1.3/technology/interoperability/webhook-clients"
markdown_url: "https://documentation.opencrvs.org/v1.3/technology/interoperability/webhook-clients.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:bfd3e6263be1e9d5cc537ddeeaf962722fa798679d0af52a924332f6a4ad5ac1"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/technology/interoperability/webhook-clients.md).
...
4. Respond to the webhook event as you wish internally, and request further details from OpenCRVS via a [Record Search](/v1.3/technology/interoperability/record-search-clients.md) if you need to.
...
<figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FJTDzQHqNvArqbGDBh44c%2FScreenshot%202023-01-11%20at%2011.34.54.png?alt=media&amp;token=3c2cda4d-659e-4fdb-9797-9b9e54732552" alt=""><figcaption></figcaption></figure>
...
The property `context` contains the FHIR bundles. Refer to our [standards](/v1.3/technology/standards.md) section to learn more about the FHIR specification.
...
To subscribe, your subscription service must request an [authorization token ](/v1.3/technology/interoperability/authenticate-a-client.md)using your `client_id` and `client_secret`.
...
```
GET https://documentation.opencrvs.org/v1.3/technology/interoperability/webhook-clients.md?ask=<question>&goal=<endgoal>
```
