---
title: "FHIR Location REST API"
source_url: "https://documentation.opencrvs.org/v1.3/technology/interoperability/fhir-location-rest-api"
markdown_url: "https://documentation.opencrvs.org/v1.3/technology/interoperability/fhir-location-rest-api.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:1ea898b277e7ba22aa0e5c4b3a116aca446e88873e6a73e54e5d35eb0481e928"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/technology/interoperability/fhir-location-rest-api.md).
...
This API will help you configure integrating clients to understand the relationship to places referenced by [FHIR Location](https://build.fhir.org/location.html) ids in payloads such as "Place of birth", "Place of registration", or "Jurisdiction" such as [Webhooks](/v1.3/technology/interoperability/webhook-clients.md) and [National ID](/v1.3/technology/interoperability/national-id-client.md) clients.

For an [Event Notification](/v1.3/technology/interoperability/event-notification-clients.md) client, you must submit the correct FHIR Location id for the health facility that OpenCRVS understands in order to correctly track the place of birth.

For a [Record Search](/v1.3/technology/interoperability/record-search-clients.md) client, you need the correct FHIR Location id when performing advanced searches depending on your parameters.
...
<figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FgE79l6IJmSmvteWkRbYm%2FScreenshot%202023-01-19%20at%2016.57.25.png?alt=media&amp;token=acdeebfc-0e5a-4ed9-a93d-e695586ee204" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FzeWBnNw32l3p9PtwMs8s%2FScreenshot%202023-01-19%20at%2017.41.39.png?alt=media&amp;token=4518e323-180c-424e-8d34-f9bf40a8f46c" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.3/technology/interoperability/fhir-location-rest-api.md?ask=<question>&goal=<endgoal>
```
