...
source_url: "https://documentation.opencrvs.org/v1.3/technology/standards/fhir-documents/event-observations"
markdown_url: "https://documentation.opencrvs.org/v1.3/technology/standards/fhir-documents/event-observations.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b9ecbe8d9ef7014357e169cb20cd01b44ed36f20c2a67b211ceb228691373993"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/technology/standards/fhir-documents/event-observations.md).
...
```
GET https://documentation.opencrvs.org/v1.3/technology/standards/fhir-documents/event-observations.md?ask=<question>&goal=<endgoal>
```
