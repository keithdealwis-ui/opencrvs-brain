...
source_url: "https://documentation.opencrvs.org/v1.3/technology/standards/fhir-documents/registration-task"
markdown_url: "https://documentation.opencrvs.org/v1.3/technology/standards/fhir-documents/registration-task.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:21ff59d7f98b8a59dba00fb31cd81735b7601cc6017919c23815a01f35676572"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/technology/standards/fhir-documents/registration-task.md).
...
```
GET https://documentation.opencrvs.org/v1.3/technology/standards/fhir-documents/registration-task.md?ask=<question>&goal=<endgoal>
```
