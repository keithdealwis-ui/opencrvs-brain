...
source_url: "https://documentation.opencrvs.org/v1.3/technology/architecture/performance-tests"
markdown_url: "https://documentation.opencrvs.org/v1.3/technology/architecture/performance-tests.md"
version: "v1.3"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:29728213d9221db49fe4071d4d0e01225e89d017990a8da952ddd95cee908bc1"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.3/technology/architecture/performance-tests.md).
...
<figure><img src="https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FuPjM6hGsCvQTLlI7c0xk%2Fk6results.png?alt=media&amp;token=309b163b-389b-43c3-9f06-1e773f710cea" alt=""><figcaption></figcaption></figure>
...
![](https://1176971301-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6qn2vAsiooyRnf055REr%2Fuploads%2FVBldGDCdzU6lQPotrUvv%2FScreenshot%202022-06-27%20at%2014.39.06.png?alt=media\&token=474063b5-d943-4446-9add-cc355482e6f3)
...
```
GET https://documentation.opencrvs.org/v1.3/technology/architecture/performance-tests.md?ask=<question>&goal=<endgoal>
```
