...
source_url: "https://documentation.opencrvs.org/v1.7/product-specifications/workflow-management"
markdown_url: "https://documentation.opencrvs.org/v1.7/product-specifications/workflow-management.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:926b17cd632e52a3a3f69a9f295631589351e1f3b9edda03035b6fe60e7352ad"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/product-specifications/workflow-management.md).
...
For a comprehensive understanding of the various statuses and the potential pathways a record can follow, please refer to the [Status Flow Diagram](/v1.7/product-specifications/status-flow-diagram.md)
...
To list all certified-copies printed off in advance of issuance<br>
...
```
GET https://documentation.opencrvs.org/v1.7/product-specifications/workflow-management.md?ask=<question>&goal=<endgoal>
```
