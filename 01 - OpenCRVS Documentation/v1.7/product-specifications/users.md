...
source_url: "https://documentation.opencrvs.org/v1.7/product-specifications/users"
markdown_url: "https://documentation.opencrvs.org/v1.7/product-specifications/users.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:54f0b63838f81670174c0c609bf536caef87551bc59505d22452c38d6ea18a06"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/product-specifications/users.md).
...
• user.read:only-my-audit – Allows a user to view only their own audit page.<br>

{% hint style="info" %}
**How to configure user roles & scopes?**\
Learn how to define and assign appropriate permissions to different user roles in your system. [3.2 Mapping offices and user types](/v1.7/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types.md)
{% endhint %}

{% hint style="info" %}
**User roles & scopes in Farajaland?**\
Learn how we mapped user roles and scopes to support and improve service delivery in Farajaland [User roles](/v1.7/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md)
{% endhint %}
...
```
GET https://documentation.opencrvs.org/v1.7/product-specifications/users.md?ask=<question>&goal=<endgoal>
```
