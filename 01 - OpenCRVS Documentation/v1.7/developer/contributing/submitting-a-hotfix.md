...
source_url: "https://documentation.opencrvs.org/v1.7/developer/contributing/submitting-a-hotfix"
markdown_url: "https://documentation.opencrvs.org/v1.7/developer/contributing/submitting-a-hotfix.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:ffa20b4a195642eab925951b135a317cc28aedf82fb525ead2715ee66c32eb96"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/developer/contributing/submitting-a-hotfix.md).
...
```
GET https://documentation.opencrvs.org/v1.7/developer/contributing/submitting-a-hotfix.md?ask=<question>&goal=<endgoal>
```
