...
source_url: "https://documentation.opencrvs.org/v1.7/crvs-systems/opencrvs-within-a-government-systems-architecture"
markdown_url: "https://documentation.opencrvs.org/v1.7/crvs-systems/opencrvs-within-a-government-systems-architecture.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:21c5ad1a38e2ce3cdd2ecaa4029406dab5ed640ce0667cdc154afc3cc5fa5ceb"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/crvs-systems/opencrvs-within-a-government-systems-architecture.md).
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/XGsbmSRFWeHBG2xOkSsb/image.png" alt=""><figcaption><p>OpenCRVS and DPI</p></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.7/crvs-systems/opencrvs-within-a-government-systems-architecture.md?ask=<question>&goal=<endgoal>
```
