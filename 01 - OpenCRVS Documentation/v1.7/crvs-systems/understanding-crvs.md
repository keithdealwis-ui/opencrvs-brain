...
source_url: "https://documentation.opencrvs.org/v1.7/crvs-systems/understanding-crvs"
markdown_url: "https://documentation.opencrvs.org/v1.7/crvs-systems/understanding-crvs.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:49787b4bd992b621fad7884a02e781a675c042238db782c7b85eb7cb52af9112"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/crvs-systems/understanding-crvs.md).
...
```
GET https://documentation.opencrvs.org/v1.7/crvs-systems/understanding-crvs.md?ask=<question>&goal=<endgoal>
```
