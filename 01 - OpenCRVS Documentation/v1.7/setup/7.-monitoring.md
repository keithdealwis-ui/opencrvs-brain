---
title: "8. Monitoring"
source_url: "https://documentation.opencrvs.org/v1.7/setup/7.-monitoring"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/7.-monitoring.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:9bf5567aa85245eaf8caa8658b4f0f367f2fe4ce0483228be236fe4bc0b54b6a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/setup/7.-monitoring.md).
...
![](https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/PQJgqfhwYToRIk7aePTG/image.png)

The login credentials are the ones you used as `KIBANA_USERNAME` and `KIBANA_PASSWORD` as part of the [deployment](/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md), or the username: "elastic" and `ELASTICSEARCH_SUPERUSER_PASSWORD`
...
```
GET https://documentation.opencrvs.org/v1.7/setup/7.-monitoring.md?ask=<question>&goal=<endgoal>
```
