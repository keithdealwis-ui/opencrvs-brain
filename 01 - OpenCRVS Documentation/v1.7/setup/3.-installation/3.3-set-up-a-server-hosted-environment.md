...
source_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:587ad7d626bdc08c4d2fe0a211e631ca419ceba364785beb8dc020705299a25a"
---
...
\
*attachments\_per\_year = number of births, deaths.. records per year \* average number of attachments \* 0.4MB*
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/K1q3V88mz8a6BWa0TCMU/OpenCRVS%20Network%20&amp;%20Servers.png" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md?ask=<question>&goal=<endgoal>
```
