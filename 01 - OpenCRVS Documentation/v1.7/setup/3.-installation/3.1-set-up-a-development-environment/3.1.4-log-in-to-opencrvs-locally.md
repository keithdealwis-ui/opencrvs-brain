...
source_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.1-set-up-a-development-environment/3.1.4-log-in-to-opencrvs-locally"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.1-set-up-a-development-environment/3.1.4-log-in-to-opencrvs-locally.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:0a7981d02e78d7df938c800e9ec7c6314ca2a3f5d6d134582f3b1be05c8aa4c5"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.1-set-up-a-development-environment/3.1.4-log-in-to-opencrvs-locally.md).
...
To learn more about user roles please refer to [User roles](/v1.7/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md).
...
```
GET https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.1-set-up-a-development-environment/3.1.4-log-in-to-opencrvs-locally.md?ask=<question>&goal=<endgoal>
```
