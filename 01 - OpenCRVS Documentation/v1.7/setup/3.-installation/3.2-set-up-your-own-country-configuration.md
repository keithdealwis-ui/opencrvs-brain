...
source_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.2-set-up-your-own-country-configuration"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.2-set-up-your-own-country-configuration.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:3f4e6a0f04c1a5a38b24245d3e30fea2f6cc62d30c5d4f36b36b2a2cf0d57a1a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.2-set-up-your-own-country-configuration.md).
...
{% hint style="info" %}
OpenCRVS must be configured for your country locally, before deploying to a server in the next section: [3.3 Set-up a server-hosted environment](/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)
{% endhint %}
...
```
GET https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.2-set-up-your-own-country-configuration.md?ask=<question>&goal=<endgoal>
```
