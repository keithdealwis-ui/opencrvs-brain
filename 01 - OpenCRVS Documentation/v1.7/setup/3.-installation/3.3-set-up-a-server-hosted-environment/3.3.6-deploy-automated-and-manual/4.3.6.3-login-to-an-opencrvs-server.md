...
source_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.3-login-to-an-opencrvs-server"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.3-login-to-an-opencrvs-server.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:7ad9f998b1490b26f1408fd4ab3b629669a33c46ac052f1d87f9fdd5969e3071"
---
...
To learn more about OpenCRVS monitoring and maintenance, visit the [monitoring](/v1.7/setup/7.-monitoring.md) section.
...
```
GET https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.3-login-to-an-opencrvs-server.md?ask=<question>&goal=<endgoal>
```
