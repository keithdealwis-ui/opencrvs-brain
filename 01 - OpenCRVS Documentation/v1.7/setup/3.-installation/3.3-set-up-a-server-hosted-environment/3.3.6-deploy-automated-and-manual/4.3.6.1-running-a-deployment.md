...
source_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.1-running-a-deployment"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.1-running-a-deployment.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:e6a5e7d9b325be9fa9aa38185a345c630605a8c5a16e0ba99237bf8b95af2b33"
---
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/6enpqKVCGoY7dHQcee7L/Screenshot%202024-02-13%20at%2017.08.06.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/dU2vAdVDFIhR8kQpK5ZV/Screenshot%202024-02-13%20at%2017.25.09.png" alt=""><figcaption></figcaption></figure>

If this is your first time deploying OpenCRVS, you need to seed it explained [here](/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.2-seeding-a-server-environment.md).
...
```
GET https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.1-running-a-deployment.md?ask=<question>&goal=<endgoal>
```
