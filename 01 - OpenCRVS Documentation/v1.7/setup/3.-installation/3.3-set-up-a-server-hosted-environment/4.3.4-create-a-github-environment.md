...
source_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6dc72e3c31420b35cf974adeeee0b8d49de866601b3b0386ad0ed9f42e4b01b7"
---
...
The environments will be named according to the naming convention identical to that we have described [here](/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md).&#x20;
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/da1vKDoc7WFe3g42Brbu/Screenshot%202024-01-09%20at%2016.07.25.png" alt=""><figcaption><p>Creating a private Dockerhub repository for a countryconfig forked container</p></figcaption></figure>

Ensure that the Dockerhub members have permissions to write to the repository:

<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/xi1iP3jtEUa2L80BNW65/Screenshot%202024-09-11%20at%2011.35.02.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/aZ86M4GqGzD9NU8p1Xf8/Screenshot%202024-09-27%20at%2009.16.14.png" alt=""><figcaption></figcaption></figure>
...
Prepare your VPN and the Github Action approach to connect through the VPN by following the section [4.3.4.2 VPN Recipes](/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment/4.3.4.2-vpn-recipes.md).

### 4. Create companion service accounts for monitoring (optional, but recommended)

Our code is hardcoded to track bugs in [Sentry](https://www.sentry.io) and then these can be redirected to an email address or [Slack](https://slack.com/) channel.  Sentry and Slack are extremely low cost tools (all ongoing service costs are listed in section [4.3](/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)). &#x20;

We can use the same email address or Slack channel to receive any uncaught errors or infrastructure monitoring alerts from Sentry as we will do from the internal Kibana monitoring tool: explained further in the [Monitoring](/v1.7/setup/7.-monitoring.md) section.

Create a NodeJS project in Sentry for your chosen environment

<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/10NpdHshJlrTc04ZfXxH/Screenshot%202024-01-09%20at%2017.35.34.png" alt=""><figcaption><p>Creating a NodeJS, Sentry project for a "production" environment</p></figcaption></figure>

In the Sentry project settings, select "Client Keys", and **copy the DSN property**.   You will need it later.

<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/8k2pO0DUxTn7jtYXauVD/Screenshot%202024-01-09%20at%2017.38.52.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/u21PLclOFl0fkLuRsi9b/Screenshot%202024-01-16%20at%2016.48.23.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/Th5dLxKKBOcmRSdC6IHz/Screenshot%202024-01-09%20at%2017.49.03.png" alt=""><figcaption><p>Getting an email address for a Slack channel</p></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/7v4COK760HBjCIzlcAXK/new-env-script.png" alt=""><figcaption></figcaption></figure>

The script will fail if it cannot connect to Github for whatever reason, then continue.

<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/sGAy97cRX4mv0ibEnoD0/Screenshot%202024-11-07%20at%2013.12.24.png" alt=""><figcaption><p>The script will ask for the SSH connection details and <strong>private</strong> key for the "provision" user</p></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/ABJ93Wt5K8OKDteWy5jY/Screenshot%202024-11-07%20at%2013.31.16.png" alt=""><figcaption><p>The script allocates disk space and creates a known-hosts file for your server domain</p></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/bp3j12RW4CSFYwS7ql4j/Screenshot%202024-11-07%20at%2013.36.14.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/Nu6Zp6EPLprzhprqp1D8/Screenshot%202024-11-07%20at%2013.39.38.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/FBuxSMGYXfX11FgiIxPR/Screenshot%202024-11-07%20at%2013.51.44.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/uoJXVBk7PDONbba2TwbB/Screenshot%202024-11-07%20at%2013.54.13.png" alt=""><figcaption><p>The script will proceed to create the Github environment and a .env file in your local repo for reference</p></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/oS1V2l56XG2eRNnOGckm/Screenshot%202024-11-07%20at%2013.59.13.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/99HhZGptXUUwDbdMIs9q/Screenshot%202024-11-07%20at%2013.58.39.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/45T2RW9VoSPBe7Djew7H/Screenshot%202024-11-07%20at%2014.02.46.png" alt=""><figcaption><p>You will also notice some "repository secrets and variables" have been created accesiblt to all environments</p></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/Qfu353iDSz5VsDSZ4rAt/Screenshot%202024-11-07%20at%2014.23.16.png" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.7/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment.md?ask=<question>&goal=<endgoal>
```
