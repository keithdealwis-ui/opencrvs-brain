...
source_url: "https://documentation.opencrvs.org/v1.7/setup/7.-monitoring/7.3-routine-monitoring-checklist"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/7.-monitoring/7.3-routine-monitoring-checklist.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:49ff0ca504dbace6eb0e18c1dacff033da4fe33f8a8dc75cd766e7df2a238ca1"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/setup/7.-monitoring/7.3-routine-monitoring-checklist.md).
...
* Use the parameters listed in [7.2 Infrastructure health](/v1.7/setup/7.-monitoring/7.2-infrastructure-health.md) under Available disk space
* Verify all used disk space is under 70% on all nodes

![](https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/4pvooQ3lz0kI6YaFz97C/image.png)

#### CPU and memory usage less than 80% on all nodes

* Login to Kibana
* Navigate to **Observability -> Metrics -> Metrics Explorer**
* Use the parameters listed in [7.2 Infrastructure health](/v1.7/setup/7.-monitoring/7.2-infrastructure-health.md) under CPU usage
* Select a timeframe of 24 hours
* Verify CPU load has not exceeded 80% on any of your server nodes

![](https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/fwabPuXYjQQGP1lq1ZKa/image.png)
...
```
GET https://documentation.opencrvs.org/v1.7/setup/7.-monitoring/7.3-routine-monitoring-checklist.md?ask=<question>&goal=<endgoal>
```
