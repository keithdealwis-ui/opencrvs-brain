...
source_url: "https://documentation.opencrvs.org/v1.7/setup/7.-monitoring/7.5-managing-a-docker-swarm"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/7.-monitoring/7.5-managing-a-docker-swarm.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:4423ef2ea20d32561d0b8d6473e934323ba952c6847b8aace95ed51d253e7b90"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/setup/7.-monitoring/7.5-managing-a-docker-swarm.md).
...
```
GET https://documentation.opencrvs.org/v1.7/setup/7.-monitoring/7.5-managing-a-docker-swarm.md?ask=<question>&goal=<endgoal>
```
