...
source_url: "https://documentation.opencrvs.org/v1.7/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:2e58430f6b15e545c9169554704c81448f2a4a7a707ea60d933c930e5ac4b50b"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types.md).
...
* The OpenCRVS standard users have fixed privileges as described in the product specifications section on [users](/v1.7/product-specifications/users.md). You will also get a good feel for what these users are able to do from the [demo of the Farajaland configuration](/v1.7/default-configuration/opencrvs-configuration-in-farajaland.md). For each of the users that you have identified in your business process they need to be assigned to one of the OpenCRVS system roles and assigned to a specific office.

### How to Configure User Roles & Scopes

{% hint style="info" %}
Use the User Roles & Scopes Template File found in our [Release Notes](/v1.7/general/v1.7-release-notes.md), designed to help you manage and assign appropriate permissions to different user roles in your system.
{% endhint %}
...
```
GET https://documentation.opencrvs.org/v1.7/setup/2.-gather-requirements/3.2-mapping-offices-and-user-types.md?ask=<question>&goal=<endgoal>
```
