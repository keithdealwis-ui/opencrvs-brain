...
source_url: "https://documentation.opencrvs.org/v1.7/setup/5.-testing"
markdown_url: "https://documentation.opencrvs.org/v1.7/setup/5.-testing.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f9ac31ed91640272e0cd98aa3efdfd2a20ffe6b51d544997bcfa6cbb606bf96f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/setup/5.-testing.md).
...
{% hint style="info" %}
[Configuration, testing and technical configuration files](/v1.7/general/releases.md)
...
```
GET https://documentation.opencrvs.org/v1.7/setup/5.-testing.md?ask=<question>&goal=<endgoal>
```
