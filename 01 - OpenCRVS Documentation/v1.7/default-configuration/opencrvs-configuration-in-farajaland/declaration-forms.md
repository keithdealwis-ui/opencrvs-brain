...
source_url: "https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms"
markdown_url: "https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:0c5dcb0ff66f4e2b3593333c62aa4107718fd317f278373075fdc1de3f49adb5"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md).
...
In the **Country Configuration Files** in the [Release Notes](/v1.7/general/v1.7-release-notes.md) you will see how we configured Farajaland declaration forms for other events.
...
```
GET https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md?ask=<question>&goal=<endgoal>
```
