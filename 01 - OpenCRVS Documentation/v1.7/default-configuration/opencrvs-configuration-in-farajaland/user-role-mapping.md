---
title: "User roles"
source_url: "https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping"
markdown_url: "https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b4a13130c96af674207f6e180e52dae73cd2d19ff6ea78cda895f36ead15d570"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md).
...
In the **Country Configuration Files** in the [Release Notes](/v1.7/general/v1.7-release-notes.md) you will see how we mapped and assigned permissions (scopes) to Farajaland user roles.
...
```
GET https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md?ask=<question>&goal=<endgoal>
```
