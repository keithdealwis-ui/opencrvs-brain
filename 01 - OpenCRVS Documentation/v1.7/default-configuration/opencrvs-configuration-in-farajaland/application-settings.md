...
source_url: "https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/application-settings"
markdown_url: "https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:302a6ff2123e4c964186144636588c47df332bccca0dfcf6088027eaceec2bd9"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md).
...
| Government logo                                      | <img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/5EWyZ4rrHJ290Lf6E2pk/image.png" alt="" data-size="line"> |                                                                                              |
...
```
GET https://documentation.opencrvs.org/v1.7/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md?ask=<question>&goal=<endgoal>
```
