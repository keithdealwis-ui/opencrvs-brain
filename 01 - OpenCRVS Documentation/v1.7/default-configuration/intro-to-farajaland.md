...
source_url: "https://documentation.opencrvs.org/v1.7/default-configuration/intro-to-farajaland"
markdown_url: "https://documentation.opencrvs.org/v1.7/default-configuration/intro-to-farajaland.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:ac9a2f68c8326fcec11cde1255cdd1c31fc870d96abf646607b66109e8efb6fa"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/default-configuration/intro-to-farajaland.md).
...
![Provinces and Districts of Farajaland](https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/dMVklZIFBuTRbn8hhLUA/farajaland-map.png)
...
```
GET https://documentation.opencrvs.org/v1.7/default-configuration/intro-to-farajaland.md?ask=<question>&goal=<endgoal>
```
