...
source_url: "https://documentation.opencrvs.org/v1.7/technology/architecture/performance-tests"
markdown_url: "https://documentation.opencrvs.org/v1.7/technology/architecture/performance-tests.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:110d4e1a7948a67c6968146a8113fb6f5ffc1ff000592f2d9a4ce5106b227415"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/technology/architecture/performance-tests.md).
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/ApfX041mbAezKPbmg6mL/k6results.png" alt=""><figcaption></figcaption></figure>
...
![](https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/pECJrzdLNkrtVJpcrJRP/Screenshot%202022-06-27%20at%2014.39.06.png)
...
```
GET https://documentation.opencrvs.org/v1.7/technology/architecture/performance-tests.md?ask=<question>&goal=<endgoal>
```
