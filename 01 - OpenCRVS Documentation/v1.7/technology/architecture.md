---
title: "Architecture"
source_url: "https://documentation.opencrvs.org/v1.7/technology/architecture"
markdown_url: "https://documentation.opencrvs.org/v1.7/technology/architecture.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a81eac559a05d412462fb973e25cbf34eeac5d80385c98b7b5b49a4a71140818"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/technology/architecture.md).
...
To learn about the server hosting & network architecture required for hosting OpenCRVS visit [this section.](https://github.com/opencrvs/documentation/blob/master/v1.7.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment)
...
We extended [FHIR](https://www.hl7.org/fhir/) to support the civil registration context. Our civil registration FHIR standard is described [here](/v1.7/technology/standards/fhir-documents.md).
...
![](https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/3V0LsDJMgBQxrdYwuD7G/image.png) ![](https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/mx47VLlIpg6lIwMynFeF/image.png) ![](https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/TLG7FNaoMSSvj4AyNzFi/image.png)\\
...
```
GET https://documentation.opencrvs.org/v1.7/technology/architecture.md?ask=<question>&goal=<endgoal>
```
