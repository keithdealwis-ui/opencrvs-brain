...
source_url: "https://documentation.opencrvs.org/v1.7/technology/standards/fhir-documents/event-composition"
markdown_url: "https://documentation.opencrvs.org/v1.7/technology/standards/fhir-documents/event-composition.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b1183ac27bd83706daa7b216752c8b82781d63dff50823223418fd19e13518b4"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/technology/standards/fhir-documents/event-composition.md).
...
```
GET https://documentation.opencrvs.org/v1.7/technology/standards/fhir-documents/event-composition.md?ask=<question>&goal=<endgoal>
```
