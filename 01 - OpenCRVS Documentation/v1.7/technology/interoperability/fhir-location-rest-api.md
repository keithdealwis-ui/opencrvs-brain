...
source_url: "https://documentation.opencrvs.org/v1.7/technology/interoperability/fhir-location-rest-api"
markdown_url: "https://documentation.opencrvs.org/v1.7/technology/interoperability/fhir-location-rest-api.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:fb0a304dee78c661fbbe13aa5c2f27725eb8e5f6333e5f785d00f1e510fd5996"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/technology/interoperability/fhir-location-rest-api.md).
...
This API will help you configure integrating clients to understand the relationship to places referenced by [FHIR Location](https://build.fhir.org/location.html) ids in payloads such as "Place of birth", "Place of registration", or "Jurisdiction" such as [Webhooks](/v1.7/technology/interoperability/webhook-clients.md) and [National ID](/v1.7/technology/interoperability/national-id-client.md) clients.

For an [Event Notification](/v1.7/technology/interoperability/event-notification-clients.md) client, you must submit the correct FHIR Location id for the health facility that OpenCRVS understands in order to correctly track the place of birth.

For a [Record Search](/v1.7/technology/interoperability/record-search-clients.md) client, you need the correct FHIR Location id when performing advanced searches depending on your parameters.
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/bAVOUeOkH7mGyfipqbVt/Screenshot%202023-01-19%20at%2016.57.25.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/cseBiSPxUBfcMZLsclsv/Screenshot%202023-01-19%20at%2017.41.39.png" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.7/technology/interoperability/fhir-location-rest-api.md?ask=<question>&goal=<endgoal>
```
