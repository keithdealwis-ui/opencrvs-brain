...
source_url: "https://documentation.opencrvs.org/v1.7/technology/interoperability/webhook-clients"
markdown_url: "https://documentation.opencrvs.org/v1.7/technology/interoperability/webhook-clients.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:327c06c1c4fd4c46a8783f79ed328459d8204311b84e1edac812234e17b9dade"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/technology/interoperability/webhook-clients.md).
...
4. Respond to the webhook event as you wish internally, and request further details from OpenCRVS via a [Record Search](/v1.7/technology/interoperability/record-search-clients.md) if you need to.
...
<figure><img src="https://content.gitbook.com/content/vgBjh6h3DfeeMhA5gwiP/blobs/8hpqiMo4NOC5xIZxAH42/Screenshot%202023-01-11%20at%2011.34.54.png" alt=""><figcaption></figcaption></figure>
...
The property `context` contains the FHIR bundles. Refer to our [standards](/v1.7/technology/standards.md) section to learn more about the FHIR specification.
...
To subscribe, your subscription service must request an [authorization token ](/v1.7/technology/interoperability/authenticate-a-client.md)using your `client_id` and `client_secret`.
...
```
GET https://documentation.opencrvs.org/v1.7/technology/interoperability/webhook-clients.md?ask=<question>&goal=<endgoal>
```
