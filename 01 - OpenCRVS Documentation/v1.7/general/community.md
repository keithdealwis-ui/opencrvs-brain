---
title: "Community"
source_url: "https://documentation.opencrvs.org/v1.7/general/community"
markdown_url: "https://documentation.opencrvs.org/v1.7/general/community.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b4705ab0e088550daca775e7826106fc714eef78e867d43021c5fecdbf3754f8"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/general/community.md).
...
Share your insights on CRVS and engage with other like minded individuals at <https://community.opencrvs.org/>&#x20;
...
```
GET https://documentation.opencrvs.org/v1.7/general/community.md?ask=<question>&goal=<endgoal>
```
