...
source_url: "https://documentation.opencrvs.org/v1.7/general/migration-notes"
markdown_url: "https://documentation.opencrvs.org/v1.7/general/migration-notes.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f391d18a6ff7f80e7984035b12c5b217baa0f938f580eefb98ec8129e9be0f8d"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/general/migration-notes.md).
...
{% hint style="info" %}
Please refer to the release notes , which contains a video of an example code upgrade process, and our [release process including Gitflow](/v1.7/general/releases.md) branching approach.
{% endhint %}
...
The following command pulls from a remote named "upstream" which should already point to our countryconfig repository. You set this up when [forking countryconfig](/v1.7/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md)
...
6\. If you are running OpenCRVS locally, simply [start OpenCRVS](/v1.7/setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-starting-and-stopping-opencrvs.md). Migrations will automatically run on your local data and you have finished upgrading OpenCRVS locally.
...
1. Every release likely contains dev-ops improvements and bug fixes to your servers. Run the [Provision](https://github.com/opencrvs/documentation/blob/master/v1.7.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.5-provisioning-servers) action on your QA server environment.
...
<figure><img src="https://2662731974-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FvgBjh6h3DfeeMhA5gwiP%2Fuploads%2FTosV5sbTEWv0Yiqul4fQ%2FScreenshot%202024-12-11%20at%2008.44.32.png?alt=media&amp;token=71d860ee-4faa-412f-b901-a819de7f4251" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.7/general/migration-notes.md?ask=<question>&goal=<endgoal>
```
