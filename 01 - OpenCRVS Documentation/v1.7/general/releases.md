...
source_url: "https://documentation.opencrvs.org/v1.7/general/releases"
markdown_url: "https://documentation.opencrvs.org/v1.7/general/releases.md"
version: "v1.7"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:aec291821dbbf6b133ed714237a84f830ecc02fa19f6194a9422953f4ab18fdc"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.7/general/releases.md).
...
```
GET https://documentation.opencrvs.org/v1.7/general/releases.md?ask=<question>&goal=<endgoal>
```
