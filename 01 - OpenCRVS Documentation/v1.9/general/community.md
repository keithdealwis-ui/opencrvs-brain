---
title: "Community"
source_url: "https://documentation.opencrvs.org/v1.9/general/community"
markdown_url: "https://documentation.opencrvs.org/v1.9/general/community.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:fad81878853754e0f2d67fb885f1ad1c1a1bc57f73a13054c78052f83ba25e9d"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/general/community.md).
...
```
GET https://documentation.opencrvs.org/v1.9/general/community.md?ask=<question>&goal=<endgoal>
```
