---
title: "Release notes"
source_url: "https://documentation.opencrvs.org/v1.9/general/release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.9/general/release-notes.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:fe96938ad7e38a84dac2953a9bb5a4714b0b8f138ce9124f5ef6d21e44c739c7"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/general/release-notes.md).

# Release notes

## Configuration template files

{% file src="/files/X4KwkOmwmFXXE9Hsm8gI" %}
Business analysis input files for completion, as guidance to development teams.
{% endfile %}

## Deployment, Monitoring & Data Security

{% file src="/files/2gOrFTb4XZXA6HVCzB8f" %}
...
{% file src="/files/wAYytbtJSGJD4Gb5Q8yu" %}
...
```
GET https://documentation.opencrvs.org/v1.9/general/release-notes.md?ask=<question>&goal=<endgoal>
```
