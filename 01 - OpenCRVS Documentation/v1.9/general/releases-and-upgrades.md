...
source_url: "https://documentation.opencrvs.org/v1.9/general/releases-and-upgrades"
markdown_url: "https://documentation.opencrvs.org/v1.9/general/releases-and-upgrades.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6cb55f403ce2f55d9ec6c932af5e3a28e9847f147572793241f9d3b6bdfd445a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/general/releases-and-upgrades.md).
...
```
GET https://documentation.opencrvs.org/v1.9/general/releases-and-upgrades.md?ask=<question>&goal=<endgoal>
```
