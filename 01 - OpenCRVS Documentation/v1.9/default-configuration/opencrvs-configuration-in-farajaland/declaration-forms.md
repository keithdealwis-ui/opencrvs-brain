...
source_url: "https://documentation.opencrvs.org/v1.9/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms"
markdown_url: "https://documentation.opencrvs.org/v1.9/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:56995acefe31e116814342b110d5df716f9151182a6b132ae3713b75a1ec9747"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md).
...
In the **Country Configuration Files** in the [Release Notes](https://github.com/opencrvs/documentation/tree/master/v1.9.0/general/v1.9-release-notes) you will see how we configured Farajaland declaration forms for other events.
...
```
GET https://documentation.opencrvs.org/v1.9/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md?ask=<question>&goal=<endgoal>
```
