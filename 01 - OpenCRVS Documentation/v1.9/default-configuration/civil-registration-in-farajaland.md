...
source_url: "https://documentation.opencrvs.org/v1.9/default-configuration/civil-registration-in-farajaland"
markdown_url: "https://documentation.opencrvs.org/v1.9/default-configuration/civil-registration-in-farajaland.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:299792d78631fa0edf7b4d13a213c6d7e23c65e6ea97474ef03d39c8f65c8497"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/default-configuration/civil-registration-in-farajaland.md).
...
```
GET https://documentation.opencrvs.org/v1.9/default-configuration/civil-registration-in-farajaland.md?ask=<question>&goal=<endgoal>
```
