---
title: "9. Monitoring"
source_url: "https://documentation.opencrvs.org/v1.9/setup/7.-monitoring"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/7.-monitoring.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:d86742d507191a18853bf3ff73c4810f5754a8eb7c3678da137e4d70ca92a666"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/setup/7.-monitoring.md).
...
![](https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-06f675eb15cc4e7d2f92b248eab95fc6012e1313%2Fimage%20\(17\).png?alt=media)

The login credentials are the ones you used as `KIBANA_USERNAME` and `KIBANA_PASSWORD` as part of the [deployment](/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md), or the username: "elastic" and `ELASTICSEARCH_SUPERUSER_PASSWORD`
...
![](https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-d88d2e11134b008cc0264b9b85dba7f371e220e0%2Fimage%20\(15\).png?alt=media)

#### Logstash

Logstash receives log entries in [GELF format](https://docs.graylog.org/docs/gelf) from all OpenCRVS services and writes them into the Elasticsearch database. These logs can be viewed in real-time from **Observability -> Logs -> Stream** or through APM. By default, OpenCRVS stores all logs for three days before they are removed. Read more about logging in [9.1 Application logs](/v1.9/setup/7.-monitoring/7.1-application-logs.md).
...
```
GET https://documentation.opencrvs.org/v1.9/setup/7.-monitoring.md?ask=<question>&goal=<endgoal>
```
