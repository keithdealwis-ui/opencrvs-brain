---
title: "8. Operational Support"
source_url: "https://documentation.opencrvs.org/v1.9/setup/8.-operational-support"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/8.-operational-support.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:bdf3678a9479559c34e5ac354ddd4e0c069f0f102c22335b1935df5c44fe0b69"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/setup/8.-operational-support.md).
...
```
GET https://documentation.opencrvs.org/v1.9/setup/8.-operational-support.md?ask=<question>&goal=<endgoal>
```
