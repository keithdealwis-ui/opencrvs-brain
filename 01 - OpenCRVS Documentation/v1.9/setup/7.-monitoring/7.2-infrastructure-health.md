...
source_url: "https://documentation.opencrvs.org/v1.9/setup/7.-monitoring/7.2-infrastructure-health"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/7.-monitoring/7.2-infrastructure-health.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:de36f7cce15be06e9cfa6738ff3433cf81811e4c480b57713bff2a3867240bae"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/setup/7.-monitoring/7.2-infrastructure-health.md).
...
![](https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-d637572f749f09f37abec4c89fa954b677f0715a%2Fimage%20\(2\).png?alt=media)
...
![](https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-cae64d9e3057d6d0b684c0f8c428993e62d6f9a5%2Fimage%20\(33\).png?alt=media)
...
```
GET https://documentation.opencrvs.org/v1.9/setup/7.-monitoring/7.2-infrastructure-health.md?ask=<question>&goal=<endgoal>
```
