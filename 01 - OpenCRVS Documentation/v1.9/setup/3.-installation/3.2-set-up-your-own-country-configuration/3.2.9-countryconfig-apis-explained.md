---
title: "4.2.9 Other configurable countryconfig API endpoints explained"
source_url: "https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.9-countryconfig-apis-explained"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.9-countryconfig-apis-explained.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:1e588cb74227e9ccbd1e8447d507302f0180a6cbf78cd4167f5c851bb2fc3429"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.9-countryconfig-apis-explained.md).
...
* **Search**\
  ...
  * Tracking ID
* **Lifecycle**\
  From *notify/declare* to *review* to *register* and *issue certificate*, the same Tracking ID follows the record. After registration, it usually appears alongside the registration number in notifications and UIs.
...
```
GET https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.9-countryconfig-apis-explained.md?ask=<question>&goal=<endgoal>
```
