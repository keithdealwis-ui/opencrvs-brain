...
source_url: "https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.5-resetting-a-server-environment"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.5-resetting-a-server-environment.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f5d8431d5e29cf9972401c599bc511e9f6c22d5d692dd8ab701464a5a1bd31dd"
---
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-4d1005eb3a45f02cc121fcbac2645d50440469e2%2FScreenshot%202024-11-14%20at%2007.26.56.png?alt=media" alt=""><figcaption></figcaption></figure>

{% hint style="info" %}
After resetting your environment, it contains no data at all. It must be [seeded](/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.2-seeding-a-server-environment.md) again,
{% endhint %}

### Reset a **production** environment

Perhaps you need to clear production after completing a [test that backup is working successfully ](/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.7-backup-and-restore.md)in readiness for going live. Or perhaps you need to [restore a previous backup](/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.7-backup-and-restore/4.3.7.1-restoring-a-backup.md) onto production for some other reason. In these scenarios, you would be required to reset your production environment.
...
```
GET https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.5-resetting-a-server-environment.md?ask=<question>&goal=<endgoal>
```
