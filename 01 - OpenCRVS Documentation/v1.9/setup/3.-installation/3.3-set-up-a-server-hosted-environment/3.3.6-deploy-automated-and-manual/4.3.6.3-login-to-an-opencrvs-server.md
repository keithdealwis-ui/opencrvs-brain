...
source_url: "https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.3-login-to-an-opencrvs-server"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.3-login-to-an-opencrvs-server.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:04741f5e2c1c025681dd7dba95cc240267ce5468261a794f97f7886f9579cf40"
---
...
To learn more about OpenCRVS monitoring and maintenance, visit the [monitoring](/v1.9/setup/7.-monitoring.md) section.
...
```
GET https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.3-login-to-an-opencrvs-server.md?ask=<question>&goal=<endgoal>
```
