...
source_url: "https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.5-provisioning-servers/4.3.5.2-building-pushing-and-releasing-your-countryconfig-code"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.5-provisioning-servers/4.3.5.2-building-pushing-and-releasing-your-countryconfig-code.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:e48bd471d3213dec1110583b7482646fa2b5c76b87d5c6c7131381ccdb5dfcff"
---
...
```
GET https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.5-provisioning-servers/4.3.5.2-building-pushing-and-releasing-your-countryconfig-code.md?ask=<question>&goal=<endgoal>
```
