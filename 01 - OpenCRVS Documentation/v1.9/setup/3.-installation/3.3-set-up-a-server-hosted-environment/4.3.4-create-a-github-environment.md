---
title: "4.3.4 Create a Github environment"
source_url: "https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:79cc3e43f23a664f3d3110e443924a70f34b86c1867c1fdbf5106d0a3c3aa4b8"
---
...
The environments will be named according to the naming convention identical to that we have described [here](/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md).
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-bfb57160cdf55a3862a18ccece6a7957371a82e8%2FScreenshot%202024-01-09%20at%2016.07.25.png?alt=media" alt=""><figcaption><p>Creating a private Dockerhub repository for a countryconfig forked container</p></figcaption></figure>

Ensure that the Dockerhub members have permissions to write to the repository:

<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-d4ffcecdfe357c401c3626ec0d804977809500c9%2FScreenshot%202024-09-11%20at%2011.35.02.png?alt=media" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-2ef9a00fcfd43b1c7d6604c91ca720049905e23f%2FScreenshot%202024-09-27%20at%2009.16.14.png?alt=media" alt=""><figcaption></figcaption></figure>
...
Prepare your VPN and the Github Action approach to connect through the VPN by following the section [4.3.4.2 VPN Recipes](/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment/4.3.4.2-vpn-recipes.md).

### 4. Create companion service accounts for monitoring (optional, but recommended)

Our code is hardcoded to track bugs in [Sentry](https://www.sentry.io) and then these can be redirected to an email address or [Slack](https://slack.com/) channel. Sentry and Slack are extremely low cost tools (all ongoing service costs are listed in section [4.3](/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)).

We can use the same email address or Slack channel to receive any uncaught errors or infrastructure monitoring alerts from Sentry as we will do from the internal Kibana monitoring tool: explained further in the [Monitoring](/v1.9/setup/7.-monitoring.md) section.

Create a NodeJS project in Sentry for your chosen environment

<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-77c2768d8d36fe9a3609f85850f1e03328721ec0%2FScreenshot%202024-01-09%20at%2017.35.34.png?alt=media" alt=""><figcaption><p>Creating a NodeJS, Sentry project for a "production" environment</p></figcaption></figure>

In the Sentry project settings, select "Client Keys", and **copy the DSN property**. You will need it later.

<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-a89dd12985843881691143e6c5cefee7972be886%2FScreenshot%202024-01-09%20at%2017.38.52%20(1).png?alt=media" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-137b5d5309fe16bce8623ba92be9b05bb9ca02e9%2FScreenshot%202024-01-16%20at%2016.48.23.png?alt=media" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-f8883ebed2f805a7fb7f9c54ced7a6fc2e3a4f87%2FScreenshot%202024-01-09%20at%2017.49.03.png?alt=media" alt=""><figcaption><p>Getting an email address for a Slack channel</p></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-55bdb1ecad51492520fa6051095985d4348e452a%2Fnew-env-script.png?alt=media" alt=""><figcaption></figcaption></figure>

The script will fail if it cannot connect to Github for whatever reason, then continue.

<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-999a179396c18678469e5c232fbef62f1e86e119%2FScreenshot%202024-11-07%20at%2013.12.24.png?alt=media" alt=""><figcaption><p>The script will ask for the SSH connection details and <strong>private</strong> key for the "provision" user</p></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-9a32de37435e2e88093aaa39a0d05d0dd30397dc%2FScreenshot%202024-11-07%20at%2013.31.16%20(1).png?alt=media" alt=""><figcaption><p>The script allocates disk space and creates a known-hosts file for your server domain</p></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-d7e9a72209bbe30bd4d2bee5eabb47f8c0673747%2FScreenshot%202024-11-07%20at%2013.36.14.png?alt=media" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-a223cfbbc90ba0d79bbb2b87f8bf4e4de63b1e5b%2FScreenshot%202024-11-07%20at%2013.39.38.png?alt=media" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-5b99664f146cf9c17ce3589430ea8690cc01a9e1%2FScreenshot%202024-11-07%20at%2013.51.44.png?alt=media" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-7f8d0d608333aa9558dc4ed36b38d284ac281d0b%2FScreenshot%202024-11-07%20at%2013.54.13.png?alt=media" alt=""><figcaption><p>The script will proceed to create the Github environment and a .env file in your local repo for reference</p></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-a99c1e734e96e7b3e009a40cacd2a88d55468315%2FScreenshot%202024-11-07%20at%2013.59.13.png?alt=media" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-e7513506e800bfc356cd75680e54d54f732a774e%2FScreenshot%202024-11-07%20at%2013.58.39.png?alt=media" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-c0bada21c2502cad36860d48be01bcebeaed5fc7%2FScreenshot%202024-11-07%20at%2014.02.46.png?alt=media" alt=""><figcaption><p>You will also notice some "repository secrets and variables" have been created accesiblt to all environments</p></figcaption></figure>
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-2ad7350a9090b1d9da77f1abfed38c1f89a54009%2FScreenshot%202024-11-07%20at%2014.23.16.png?alt=media" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.9/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment.md?ask=<question>&goal=<endgoal>
```
