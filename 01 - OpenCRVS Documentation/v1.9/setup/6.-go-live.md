---
title: "7. Go-live"
source_url: "https://documentation.opencrvs.org/v1.9/setup/6.-go-live"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/6.-go-live.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:3d509d026ef9f5dd423c57802c4647687d22b504739a45e44e51fe60294e2f7b"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/setup/6.-go-live.md).
...
The following [Pre-Deployment Checklist](/v1.9/setup/6.-go-live/3.3.4-set-up-an-smtp-server-for-opencrvs-monitoring-alerts.md) should be completed by the **production** environment server administrator before going live.
...
```
GET https://documentation.opencrvs.org/v1.9/setup/6.-go-live.md?ask=<question>&goal=<endgoal>
```
