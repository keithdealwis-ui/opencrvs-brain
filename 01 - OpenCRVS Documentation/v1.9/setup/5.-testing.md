...
source_url: "https://documentation.opencrvs.org/v1.9/setup/5.-testing"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/5.-testing.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:22882894931f658708cb91fcb8cca953aa04f9545bc19225f01fc2d02f15bb3c"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/setup/5.-testing.md).
...
{% hint style="info" %}
[Configuration, testing and technical configuration files](https://github.com/opencrvs/documentation/tree/master/v1.9.0/general/releases/README.md)
...
```
GET https://documentation.opencrvs.org/v1.9/setup/5.-testing.md?ask=<question>&goal=<endgoal>
```
