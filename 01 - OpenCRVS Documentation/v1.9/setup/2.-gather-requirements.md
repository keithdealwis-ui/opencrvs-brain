...
source_url: "https://documentation.opencrvs.org/v1.9/setup/2.-gather-requirements"
markdown_url: "https://documentation.opencrvs.org/v1.9/setup/2.-gather-requirements.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a27fe294b145f9d8e30b8a9338cc49da6c567eb5eddac541e98686ec3c1dc197"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/setup/2.-gather-requirements.md).
...
{% hint style="info" %}
[Configuration, testing and technical configuration files](/v1.9/general/release-notes.md) Check out our release notes for configuration template files to help you configure your OpenCRVS instance and version
{% endhint %}
...
* [ ] **Complete the Application Settings template** You can make the product look and feel like yours by uploading a logo to appear throughout the product [3.3 Define your application settings](/v1.9/setup/2.-gather-requirements/3.3-define-your-application-settings.md)
* [ ] **Complete the User Mapping template** Map Registration roles in your country to system roles in OpenCRVS
* [ ] **Design your event declaration forms** Get hold of the existing registration forms and consider how you could optimise them for the digital world [3.4 Designing event declaration forms](/v1.9/setup/2.-gather-requirements/3.4-designing-event-declaration-forms.md)
* [ ] **Design vital event certificates** When using a digital system, you can re-design vital event certificates to look good and be fit for purpose including innovations such as QR codes. Don't just digitise a paper certificate that wasn't designed with digital in mind. [3.5 Designing a certified copy](/v1.9/setup/2.-gather-requirements/3.5-designing-a-certificate-template.md)
...
```
GET https://documentation.opencrvs.org/v1.9/setup/2.-gather-requirements.md?ask=<question>&goal=<endgoal>
```
