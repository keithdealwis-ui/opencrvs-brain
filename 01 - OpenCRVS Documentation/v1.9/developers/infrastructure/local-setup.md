---
title: "Local Setup"
source_url: "https://documentation.opencrvs.org/v1.9/developers/infrastructure/local-setup"
markdown_url: "https://documentation.opencrvs.org/v1.9/developers/infrastructure/local-setup.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:5c47ec3fb98564139209565ff9b72066545105b5d3e10d3b542566f3cd61b10d"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/developers/infrastructure/local-setup.md).
...
```
GET https://documentation.opencrvs.org/v1.9/developers/infrastructure/local-setup.md?ask=<question>&goal=<endgoal>
```
