...
source_url: "https://documentation.opencrvs.org/v1.9/technology/architecture/performance-tests"
markdown_url: "https://documentation.opencrvs.org/v1.9/technology/architecture/performance-tests.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:3edc9f0c404bd68308b059de69f8948554b767826e24dd95078260ac443b6645"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/technology/architecture/performance-tests.md).
...
<figure><img src="https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-82aa83d08af5f5b66585b5a55fbf546e4a19a34b%2Fk6results.png?alt=media" alt=""><figcaption></figcaption></figure>
...
![](https://3485090019-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRziAMaeBMeyiTg5hfFq5%2Fuploads%2Fgit-blob-9c7d1a548ed768f2340ed8be209eeccd408d68c4%2FScreenshot%202022-06-27%20at%2014.39.06.png?alt=media)
...
```
GET https://documentation.opencrvs.org/v1.9/technology/architecture/performance-tests.md?ask=<question>&goal=<endgoal>
```
