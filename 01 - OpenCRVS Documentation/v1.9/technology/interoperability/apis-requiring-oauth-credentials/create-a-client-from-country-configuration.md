---
title: "Create a client from the country configuration"
source_url: "https://documentation.opencrvs.org/v1.9/technology/interoperability/apis-requiring-oauth-credentials/create-a-client-from-country-configuration"
markdown_url: "https://documentation.opencrvs.org/v1.9/technology/interoperability/apis-requiring-oauth-credentials/create-a-client-from-country-configuration.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:3288ed95c57a7ac3f9727f54f06a4d9216674df2fdddf88abbb4ff563bcb1cce"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/technology/interoperability/apis-requiring-oauth-credentials/create-a-client-from-country-configuration.md).

# Create a client from the country configuration

Declaring integration clients in your country configuration so that an integrating system authenticates with its own credentials
...
Nothing special: the integration exchanges its client id and secret for an access token exactly like a client created in the UI. See [Authenticate a client](/v1.9/technology/interoperability/apis-requiring-oauth-credentials/authenticate-a-client.md).
...
```
GET https://documentation.opencrvs.org/v1.9/technology/interoperability/apis-requiring-oauth-credentials/create-a-client-from-country-configuration.md?ask=<question>&goal=<endgoal>
```
