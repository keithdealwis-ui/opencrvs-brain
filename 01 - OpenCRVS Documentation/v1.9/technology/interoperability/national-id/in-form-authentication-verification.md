...
source_url: "https://documentation.opencrvs.org/v1.9/technology/interoperability/national-id/in-form-authentication-verification"
markdown_url: "https://documentation.opencrvs.org/v1.9/technology/interoperability/national-id/in-form-authentication-verification.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:516395937b75506e5d258d507ff3b2a28fb8494ea761aa3b4dbbdca02eeebb14"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/technology/interoperability/national-id/in-form-authentication-verification.md).
...
It's possible to [configure](/v1.9/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-declaration-forms.md) many types of form component that can interact with methods of National ID authentication and verification. Choice of component depends on your business rules and availabilty of the relevant dependencies.
...
```
GET https://documentation.opencrvs.org/v1.9/technology/interoperability/national-id/in-form-authentication-verification.md?ask=<question>&goal=<endgoal>
```
