...
source_url: "https://documentation.opencrvs.org/v1.9/crvs-systems/effective-digital-crvs-systems"
markdown_url: "https://documentation.opencrvs.org/v1.9/crvs-systems/effective-digital-crvs-systems.md"
version: "v1.9"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:12a6e2ee4f7ce77f0cb4c9e5ad4d442acc8b9f23e25855287d738e5fc2ea8acc"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.9/crvs-systems/effective-digital-crvs-systems.md).
...
* Ask foundational questions such as:\
  \&#xNAN;*“Where is the authoritative registry?”*\
...
```
GET https://documentation.opencrvs.org/v1.9/crvs-systems/effective-digital-crvs-systems.md?ask=<question>&goal=<endgoal>
```
