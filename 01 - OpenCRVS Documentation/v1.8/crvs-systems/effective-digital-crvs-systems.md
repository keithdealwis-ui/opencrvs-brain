...
source_url: "https://documentation.opencrvs.org/v1.8/crvs-systems/effective-digital-crvs-systems"
markdown_url: "https://documentation.opencrvs.org/v1.8/crvs-systems/effective-digital-crvs-systems.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:4022620fb48147e2502c99116860d16bd42544363f008a67f79006e417f98910"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/crvs-systems/effective-digital-crvs-systems.md).
...
```
GET https://documentation.opencrvs.org/v1.8/crvs-systems/effective-digital-crvs-systems.md?ask=<question>&goal=<endgoal>
```
