...
source_url: "https://documentation.opencrvs.org/v1.8/crvs-systems/opencrvs-within-a-government-systems-architecture"
markdown_url: "https://documentation.opencrvs.org/v1.8/crvs-systems/opencrvs-within-a-government-systems-architecture.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a9264a7a3ac8643ae89e7dfa19b22be74f19f53a3595f8da04e0d7c8cedb692c"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/crvs-systems/opencrvs-within-a-government-systems-architecture.md).
...
<figure><img src="https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2Fgit-blob-21b64631185afcdff1e314e22c5a51e2257f0084%2Fimage%20(52).png?alt=media" alt=""><figcaption><p>OpenCRVS and DPI</p></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.8/crvs-systems/opencrvs-within-a-government-systems-architecture.md?ask=<question>&goal=<endgoal>
```
