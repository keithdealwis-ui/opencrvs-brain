...
source_url: "https://documentation.opencrvs.org/v1.8/crvs-systems/understanding-crvs"
markdown_url: "https://documentation.opencrvs.org/v1.8/crvs-systems/understanding-crvs.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:62e0b5b49db67f87063bff6043eb2362de3a441de1fc1bb004140c997be51d80"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/crvs-systems/understanding-crvs.md).
...
```
GET https://documentation.opencrvs.org/v1.8/crvs-systems/understanding-crvs.md?ask=<question>&goal=<endgoal>
```
