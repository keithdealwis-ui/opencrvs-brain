---
title: "Releasing"
source_url: "https://documentation.opencrvs.org/v1.8/developer/workflows/releasing"
markdown_url: "https://documentation.opencrvs.org/v1.8/developer/workflows/releasing.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b32d3648f09d91e3d86daf2a2571a858bf7847c8651ecb0e0b5742445e1e0424"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/developer/workflows/releasing.md).
...
```
GET https://documentation.opencrvs.org/v1.8/developer/workflows/releasing.md?ask=<question>&goal=<endgoal>
```
