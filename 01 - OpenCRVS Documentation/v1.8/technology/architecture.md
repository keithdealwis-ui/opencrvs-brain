---
title: "Architecture"
source_url: "https://documentation.opencrvs.org/v1.8/technology/architecture"
markdown_url: "https://documentation.opencrvs.org/v1.8/technology/architecture.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:fe4189ca6d2ea1160af29645888979b35b00a1c0985cc72843711a72a9b7a2a5"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/technology/architecture.md).
...
To learn about the server hosting & network architecture required for hosting OpenCRVS visit [this section.](https://github.com/opencrvs/documentation/blob/master/v1.8.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment)
...
We extended [FHIR](https://www.hl7.org/fhir/) to support the civil registration context. Our civil registration FHIR standard is described [here](/v1.8/technology/standards/fhir-documents.md).
...
![](https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2Fgit-blob-c5aaca6d3e131910ea5b924420226c74e8a3f2b8%2Fimage%20\(8\).png?alt=media) ![](https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2Fgit-blob-471dc93293df45d85b6955f6e225f33738212f50%2Fimage%20\(4\).png?alt=media) ![](https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2Fgit-blob-28540fcd8d5ba39391224103a52563b4cc9b0f7a%2Fimage%20\(27\).png?alt=media)\\
...
```
GET https://documentation.opencrvs.org/v1.8/technology/architecture.md?ask=<question>&goal=<endgoal>
```
