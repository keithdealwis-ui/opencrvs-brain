...
source_url: "https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents/event-composition"
markdown_url: "https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents/event-composition.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f59a4ddf213128674b58ff18c3fd5ae5b8208eaea2a03767d3ce227d21f5fd33"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents/event-composition.md).
...
```
GET https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents/event-composition.md?ask=<question>&goal=<endgoal>
```
