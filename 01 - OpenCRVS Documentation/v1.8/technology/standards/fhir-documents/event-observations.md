...
source_url: "https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents/event-observations"
markdown_url: "https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents/event-observations.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:fe4d88836cd4523fef78149906591c4ec7739e525d5b71e37f5b6543a2aa1257"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents/event-observations.md).
...
```
GET https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents/event-observations.md?ask=<question>&goal=<endgoal>
```
