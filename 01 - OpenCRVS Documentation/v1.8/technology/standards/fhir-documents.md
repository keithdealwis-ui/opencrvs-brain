...
source_url: "https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents"
markdown_url: "https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:3019feedbe0dcf2ffd0cf96a9559ba863ba065cd3898a64f23d72e805db76c04"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents.md).
...
```
GET https://documentation.opencrvs.org/v1.8/technology/standards/fhir-documents.md?ask=<question>&goal=<endgoal>
```
