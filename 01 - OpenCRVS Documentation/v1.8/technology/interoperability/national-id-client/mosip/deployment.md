---
title: "Deployment"
source_url: "https://documentation.opencrvs.org/v1.8/technology/interoperability/national-id-client/mosip/deployment"
markdown_url: "https://documentation.opencrvs.org/v1.8/technology/interoperability/national-id-client/mosip/deployment.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:c6d91b47e9b151d125e4a50db28aca4bb392b45b5473e45b6d0ede33d2139f60"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/technology/interoperability/national-id-client/mosip/deployment.md).
...
{% hint style="warning" %}
This section assumes that you are already thoroughly aware of how to deploy OpenCRVS.  If you are not, then first complete a basic deployment following the documentation [here](/v1.8/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md).
{% endhint %}
...
<figure><img src="https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2F8jrmNvrgTQA7hGmh9RJS%2FScreenshot%202025-07-16%20at%2011.10.39.png?alt=media&amp;token=da0479ba-9c7e-4db1-94fc-29b168e7788e" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.8/technology/interoperability/national-id-client/mosip/deployment.md?ask=<question>&goal=<endgoal>
```
