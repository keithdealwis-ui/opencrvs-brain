...
source_url: "https://documentation.opencrvs.org/v1.8/technology/interoperability/create-a-client/webhook-clients"
markdown_url: "https://documentation.opencrvs.org/v1.8/technology/interoperability/create-a-client/webhook-clients.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b2af034a8823dde6d7bdea9569ce588c814f04565a044d02b4687ec6bb873586"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/technology/interoperability/create-a-client/webhook-clients.md).
...
4. Respond to the webhook event as you wish internally, and request further details from OpenCRVS via a [Record Search](/v1.8/technology/interoperability/create-a-client/record-search-clients.md) if you need to.
...
<figure><img src="https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2Fgit-blob-cbcbbdd642eb8286ab3823ec310c923a18a8598e%2FScreenshot%202023-01-11%20at%2011.34.54.png?alt=media" alt=""><figcaption></figcaption></figure>
...
The property `context` contains the FHIR bundles. Refer to our [standards](/v1.8/technology/standards.md) section to learn more about the FHIR specification.
...
To subscribe, your subscription service must request an [authorization token ](/v1.8/technology/interoperability/create-a-client/authenticate-a-client.md)using your `client_id` and `client_secret`.
...
```
GET https://documentation.opencrvs.org/v1.8/technology/interoperability/create-a-client/webhook-clients.md?ask=<question>&goal=<endgoal>
```
