---
title: "Standards"
source_url: "https://documentation.opencrvs.org/v1.8/technology/standards"
markdown_url: "https://documentation.opencrvs.org/v1.8/technology/standards.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:8aacc0b1530b72d8c5a8395f8e9c0f5ec8361242d01064887988d13911b3c2e7"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/technology/standards.md).
...
We have extended FHIR's model to include custom codes and extensions that assist the Civil Registration context. To understand more about how and why we use FHIR, click [here](/v1.8/technology/standards/fhir-documents.md).
...
```
GET https://documentation.opencrvs.org/v1.8/technology/standards.md?ask=<question>&goal=<endgoal>
```
