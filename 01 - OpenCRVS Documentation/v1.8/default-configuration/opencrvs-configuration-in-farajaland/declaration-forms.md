...
source_url: "https://documentation.opencrvs.org/v1.8/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms"
markdown_url: "https://documentation.opencrvs.org/v1.8/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:ca70d4aa42d93b52d5bb7abbc8f8b35ebabfcddffd972dad1056185343ebed01"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md).
...
In the **Country Configuration Files** in the [Release Notes](https://github.com/opencrvs/documentation/blob/master/v1.8.0/general/v1.8-release-notes) you will see how we configured Farajaland declaration forms for other events.
...
```
GET https://documentation.opencrvs.org/v1.8/default-configuration/opencrvs-configuration-in-farajaland/declaration-forms.md?ask=<question>&goal=<endgoal>
```
