...
source_url: "https://documentation.opencrvs.org/v1.8/default-configuration/intro-to-farajaland"
markdown_url: "https://documentation.opencrvs.org/v1.8/default-configuration/intro-to-farajaland.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:74a647cf103122891da76574a6e98fbea1d92134b078c52469572918ad46444f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/default-configuration/intro-to-farajaland.md).
...
![Provinces and Districts of Farajaland](https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2Fgit-blob-a1981b4dad720f789d5e361e3e7d8b450a4b6f12%2Ffarajaland-map.png?alt=media)
...
```
GET https://documentation.opencrvs.org/v1.8/default-configuration/intro-to-farajaland.md?ask=<question>&goal=<endgoal>
```
