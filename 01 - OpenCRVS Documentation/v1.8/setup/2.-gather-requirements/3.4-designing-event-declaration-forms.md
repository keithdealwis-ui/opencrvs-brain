...
source_url: "https://documentation.opencrvs.org/v1.8/setup/2.-gather-requirements/3.4-designing-event-declaration-forms"
markdown_url: "https://documentation.opencrvs.org/v1.8/setup/2.-gather-requirements/3.4-designing-event-declaration-forms.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f5acb19f71cd9920386f3a1def2a4ba44feae5b8d7694dc08e400a896888767d"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/setup/2.-gather-requirements/3.4-designing-event-declaration-forms.md).

# 3.4 Designing event declaration forms

Complete customisation is offered in OpenCRVS to designing a smart dynamic declaration form. In the **Country Configuration Files** in the [Release Notes](/v1.8/general/v1.8-release-notes.md#configuration-template-files) you will find a template file to help you do so. \\
...
```
GET https://documentation.opencrvs.org/v1.8/setup/2.-gather-requirements/3.4-designing-event-declaration-forms.md?ask=<question>&goal=<endgoal>
```
