...
source_url: "https://documentation.opencrvs.org/v1.8/setup/2.-gather-requirements/3.1-mapping-business-processes"
markdown_url: "https://documentation.opencrvs.org/v1.8/setup/2.-gather-requirements/3.1-mapping-business-processes.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:8e4e9d850552d16efebef6755977c0a9b3ccb0922aed604f64c7aef20103afb5"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/setup/2.-gather-requirements/3.1-mapping-business-processes.md).
...
```
GET https://documentation.opencrvs.org/v1.8/setup/2.-gather-requirements/3.1-mapping-business-processes.md?ask=<question>&goal=<endgoal>
```
