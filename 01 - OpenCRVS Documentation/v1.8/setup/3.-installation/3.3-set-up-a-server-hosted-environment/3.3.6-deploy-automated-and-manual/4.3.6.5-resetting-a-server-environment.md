...
source_url: "https://documentation.opencrvs.org/v1.8/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.5-resetting-a-server-environment"
markdown_url: "https://documentation.opencrvs.org/v1.8/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.5-resetting-a-server-environment.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:16f0cb52bd6e3b44fd9334409124dba5737d429deb2f1a2cfdf5c922e362823e"
---
...
<figure><img src="https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2Fgit-blob-4d1005eb3a45f02cc121fcbac2645d50440469e2%2FScreenshot%202024-11-14%20at%2007.26.56.png?alt=media" alt=""><figcaption></figcaption></figure>

{% hint style="info" %}
After resetting your environment, it contains no data at all. It must be [seeded](/v1.8/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.2-seeding-a-server-environment.md) again,
{% endhint %}

### Reset a **production** environment

Perhaps you need to clear production after completing a [test that backup is working successfully ](https://github.com/opencrvs/documentation/blob/master/v1.8.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.7-backup-and-restore)in readiness for going live. Or perhaps you need to [restore a previous backup](/v1.8/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.7-backup-and-restore/4.3.7.1-restoring-a-backup.md) onto production for some other reason. In these scenarios, you would be required to reset your production environment.
...
```
GET https://documentation.opencrvs.org/v1.8/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual/4.3.6.5-resetting-a-server-environment.md?ask=<question>&goal=<endgoal>
```
