---
title: "8.4 Setting up alerts"
source_url: "https://documentation.opencrvs.org/v1.8/setup/7.-monitoring/7.4-setting-up-alerts"
markdown_url: "https://documentation.opencrvs.org/v1.8/setup/7.-monitoring/7.4-setting-up-alerts.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b43255623f9b7ce2111ef91db83e3a691a16d72144adb75d2e40f328f063ba9f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/setup/7.-monitoring/7.4-setting-up-alerts.md).
...
![](https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2Fgit-blob-41e758663f9e0fa14a10fe555b67c8cabba425b0%2Fimage%20\(14\).png?alt=media)
...
![](https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2Fgit-blob-ef671b5e02a13a1aef9749be18c7cf11c60a777f%2Fimage%20\(32\).png?alt=media)
...
```
GET https://documentation.opencrvs.org/v1.8/setup/7.-monitoring/7.4-setting-up-alerts.md?ask=<question>&goal=<endgoal>
```
