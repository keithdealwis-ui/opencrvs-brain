...
source_url: "https://documentation.opencrvs.org/v1.8/setup/5.-testing"
markdown_url: "https://documentation.opencrvs.org/v1.8/setup/5.-testing.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:cd3be3ea9359ea22e3fff37c308c1c2b1ac6af4ee5a4ff6f352209fc8965274c"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/setup/5.-testing.md).
...
{% hint style="info" %}
[Configuration, testing and technical configuration files](/v1.8/general/releases.md)
...
```
GET https://documentation.opencrvs.org/v1.8/setup/5.-testing.md?ask=<question>&goal=<endgoal>
```
