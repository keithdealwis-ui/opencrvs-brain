...
source_url: "https://documentation.opencrvs.org/v1.8/general/migration-notes"
markdown_url: "https://documentation.opencrvs.org/v1.8/general/migration-notes.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a854e83465691cbc402e9f3641a454656279521684b233bcd795c666af3177e6"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/general/migration-notes.md).
...
{% hint style="info" %}
Please refer to the release notes , which contains a video of an example code upgrade process, and our [release process including Gitflow](/v1.8/general/releases.md) branching approach.
{% endhint %}
...
The following command pulls from a remote named "upstream" which should already point to our countryconfig repository. You set this up when [forking countryconfig](/v1.8/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md)
...
6\. If you are running OpenCRVS locally, simply [start OpenCRVS](/v1.8/setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-starting-and-stopping-opencrvs.md). Migrations will automatically run on your local data and you have finished upgrading OpenCRVS locally.
...
2. Every release likely contains dev-ops improvements and changes to [Github environment secrets and variables](/v1.8/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.4-create-a-github-environment.md).  Run `yarn environment:init` for each of your environments. &#x20;
...
1. Every release likely contains dev-ops improvements and bug fixes to your servers. Run the [Provision](https://github.com/opencrvs/documentation/blob/master/v1.8.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.5-provisioning-servers) action on your QA server environment.
...
<figure><img src="https://3067259618-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fesn2q91OsFQf7ZqR8thb%2Fuploads%2Fgit-blob-8116ea4f3c97110570715e748ad0f17db0817994%2FScreenshot%202024-12-11%20at%2008.44.32.png?alt=media" alt=""><figcaption></figcaption></figure>
...
{% hint style="danger" %}
If you have hosted **AND CONFIGURED** OpenCRVS on a server and are capturing live registrations in production, **YOU MUST ENSURE THAT OPENCRVS BACKUPS ARE WORKING AND RESTORING ON A "STAGING" ENVIRONMENT. YOU SHOULD ALSO HAVE A HARD COPY OF RECENT BACKUPS.** This is so that you can restore in the event of any migration problems. [Read the backup instructions.](https://github.com/opencrvs/documentation/blob/master/v1.8.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.7-backup-and-restore)
{% endhint %}
...
```
GET https://documentation.opencrvs.org/v1.8/general/migration-notes.md?ask=<question>&goal=<endgoal>
```
