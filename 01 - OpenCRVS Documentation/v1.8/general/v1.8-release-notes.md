---
title: "Release notes"
source_url: "https://documentation.opencrvs.org/v1.8/general/v1.8-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.8/general/v1.8-release-notes.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b67edd3d46eeecd03a873ffdc86d19dbf82ca53b6f37cae5e4874e8e02549482"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/general/v1.8-release-notes.md).
...
```
GET https://documentation.opencrvs.org/v1.8/general/v1.8-release-notes.md?ask=<question>&goal=<endgoal>
```
