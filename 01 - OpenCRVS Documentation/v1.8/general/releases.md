...
source_url: "https://documentation.opencrvs.org/v1.8/general/releases"
markdown_url: "https://documentation.opencrvs.org/v1.8/general/releases.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:4b8e2f095c97ee8ad7e1783450a88e2e974084a6f1f0aab7ff93b90919f0c31c"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/general/releases.md).
...
```
GET https://documentation.opencrvs.org/v1.8/general/releases.md?ask=<question>&goal=<endgoal>
```
