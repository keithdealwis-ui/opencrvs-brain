---
title: "Welcome!"
source_url: "https://documentation.opencrvs.org/v1.8/readme"
markdown_url: "https://documentation.opencrvs.org/v1.8/readme.md"
version: "v1.8"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:c73386037405d29d892b6addbdb37ff5157c6d2b0b68b47b12554c222be8fb29"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.8/readme.md).
...
* to understand what effective digital CRVS looks like and the role that OpenCRVS can play, check out [CRVS Systems](/v1.8/crvs-systems/effective-digital-crvs-systems.md).
* to explore the OpenCRVS functionality, take a look at the [Product Specifications](/v1.8/product-specifications/functional-architecture.md) and the [Default Configuration for Farajaland](/v1.8/default-configuration/intro-to-farajaland.md)
* to understand how OpenCRVS works technically, go to [Technology](/v1.8/technology/architecture.md).
* to setup you own OpenCRVS project, then go to [Setup](/v1.8/setup/1.-establish-project-and-team.md).
* to run OpenCRVS on your laptop, take a look at the [Quick Start](/v1.8/setup/3.-installation/3.1-set-up-a-development-environment.md).
* to technically configure OpenCRVS, go to [Configure](/v1.8/setup/3.-installation/3.2-set-up-your-own-country-configuration.md).
* to deploy to a server, a configured version of OpenCRVS, go to [Deploy](/v1.8/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md).
* to see what's coming next for OpenCRVS, see the [Product Roadmap](/v1.8/general/product-roadmap.md)
...
```
GET https://documentation.opencrvs.org/v1.8/readme.md?ask=<question>&goal=<endgoal>
```
