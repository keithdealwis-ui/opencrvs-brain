...
source_url: "https://documentation.opencrvs.org/general/crvs-systems/quickstart"
markdown_url: "https://documentation.opencrvs.org/general/crvs-systems/quickstart.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a0c413680668536da284d267361d5f776c1a0631aee20d23bb5664f565c52c8f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/general/crvs-systems/quickstart.md).
...
```
GET https://documentation.opencrvs.org/general/crvs-systems/quickstart.md?ask=<question>&goal=<endgoal>
```
