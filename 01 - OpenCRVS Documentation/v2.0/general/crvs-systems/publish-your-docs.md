...
source_url: "https://documentation.opencrvs.org/general/crvs-systems/publish-your-docs"
markdown_url: "https://documentation.opencrvs.org/general/crvs-systems/publish-your-docs.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:eadea0249276f6e5749272cf89d1c98a5ac7bc91afddeae2dc309f84d563e38d"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/general/crvs-systems/publish-your-docs.md).
...
```
GET https://documentation.opencrvs.org/general/crvs-systems/publish-your-docs.md?ask=<question>&goal=<endgoal>
```
