---
title: "Conditionals"
source_url: "https://documentation.opencrvs.org/technical/apis/toolkit/conditionals"
markdown_url: "https://documentation.opencrvs.org/technical/apis/toolkit/conditionals.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6f00c5497243a514277ce62c720e1b1ab9c3b46f2abac0bf175f51385b5e6a8e"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/apis/toolkit/conditionals.md).
...
```
GET https://documentation.opencrvs.org/technical/apis/toolkit/conditionals.md?ask=<question>&goal=<endgoal>
```
