---
title: "Deduplication"
source_url: "https://documentation.opencrvs.org/technical/apis/toolkit/deduplication"
markdown_url: "https://documentation.opencrvs.org/technical/apis/toolkit/deduplication.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:5ecfbfe7c64b83c31a4271694b0df14b1b73c3bdcbf609633dcea91c8598810a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/apis/toolkit/deduplication.md).
...
```
GET https://documentation.opencrvs.org/technical/apis/toolkit/deduplication.md?ask=<question>&goal=<endgoal>
```
