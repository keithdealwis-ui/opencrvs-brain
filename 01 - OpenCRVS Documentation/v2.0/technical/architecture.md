---
title: "Architecture"
source_url: "https://documentation.opencrvs.org/technical/architecture"
markdown_url: "https://documentation.opencrvs.org/technical/architecture.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:03b0df1ada4f4e752102a9c6f00592c076453ffb53fb747661334f646b25c979"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/architecture.md).
...
```
GET https://documentation.opencrvs.org/technical/architecture.md?ask=<question>&goal=<endgoal>
```
