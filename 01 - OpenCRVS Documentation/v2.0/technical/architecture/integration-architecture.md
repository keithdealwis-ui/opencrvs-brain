...
source_url: "https://documentation.opencrvs.org/technical/architecture/integration-architecture"
markdown_url: "https://documentation.opencrvs.org/technical/architecture/integration-architecture.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:2590cfd93c4e500db065e5347fa94f2266a91be66eb115e0d3077fb17f18bbbb"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/architecture/integration-architecture.md).
...
```
GET https://documentation.opencrvs.org/technical/architecture/integration-architecture.md?ask=<question>&goal=<endgoal>
```
