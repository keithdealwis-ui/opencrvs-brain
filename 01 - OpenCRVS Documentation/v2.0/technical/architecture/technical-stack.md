...
source_url: "https://documentation.opencrvs.org/technical/architecture/technical-stack"
markdown_url: "https://documentation.opencrvs.org/technical/architecture/technical-stack.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:40aac71d1575a2c0d0150cb4d3c0987b954b0c87042fe490aabb8630c46401e4"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/architecture/technical-stack.md).
...
```
GET https://documentation.opencrvs.org/technical/architecture/technical-stack.md?ask=<question>&goal=<endgoal>
```
