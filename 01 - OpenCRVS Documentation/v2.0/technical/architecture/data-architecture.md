...
source_url: "https://documentation.opencrvs.org/technical/architecture/data-architecture"
markdown_url: "https://documentation.opencrvs.org/technical/architecture/data-architecture.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:b2d06c039a00862115a5fdbf158fa3d6bafccac107c34a90497888869d920b03"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/architecture/data-architecture.md).
...
```
GET https://documentation.opencrvs.org/technical/architecture/data-architecture.md?ask=<question>&goal=<endgoal>
```
