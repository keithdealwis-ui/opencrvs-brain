---
title: "Performance"
source_url: "https://documentation.opencrvs.org/technical/architecture/performance"
markdown_url: "https://documentation.opencrvs.org/technical/architecture/performance.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:739d7ddaec967dc0867cca6ca30bec0902001e3f7143c2e091f22288d23e9772"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/architecture/performance.md).
...
```
GET https://documentation.opencrvs.org/technical/architecture/performance.md?ask=<question>&goal=<endgoal>
```
