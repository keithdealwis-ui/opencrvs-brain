---
title: "Security"
source_url: "https://documentation.opencrvs.org/technical/architecture/security"
markdown_url: "https://documentation.opencrvs.org/technical/architecture/security.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:d71a63fd0d114dfaa323c4d74b5b0bceeaeabeb26c0d1116193ebd99cf640f48"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/architecture/security.md).
...
[Learn how to contribute to the security of OpenCRVS.](https://documentation.opencrvs.org/technical/architecture/pages/rw6acjA8c7dAY8OtqDfL#id-5.-contribute-to-the-security-of-opencrvs)
...
```
GET https://documentation.opencrvs.org/technical/architecture/security.md?ask=<question>&goal=<endgoal>
```
