---
title: "Standards"
source_url: "https://documentation.opencrvs.org/technical/architecture/standards"
markdown_url: "https://documentation.opencrvs.org/technical/architecture/standards.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:abe1a984aeb4221d52a6781b66c841b2f6c20446730fe9ae100f0813334575d2"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/architecture/standards.md).
...
```
GET https://documentation.opencrvs.org/technical/architecture/standards.md?ask=<question>&goal=<endgoal>
```
