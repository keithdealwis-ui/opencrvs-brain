...
source_url: "https://documentation.opencrvs.org/technical/guides/configuration/action-triggers"
markdown_url: "https://documentation.opencrvs.org/technical/guides/configuration/action-triggers.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:731dfaa8e596f8979efd655481467e01b8657b515c0044ed920297d674ef8fa5"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/configuration/action-triggers.md).
...
The event triggers can respond synchronously (HTTP 200) or defer the response for asynchronous external validation (HTTP 202). [Example](/technical/guides/configuration/integrations/mosip-registration-integration.md)
...
```
GET https://documentation.opencrvs.org/technical/guides/configuration/action-triggers.md?ask=<question>&goal=<endgoal>
```
