---
title: "Built-in helpers and template variables"
source_url: "https://documentation.opencrvs.org/technical/guides/configuration/certificates/built-in-helpers-and-template-variables"
markdown_url: "https://documentation.opencrvs.org/technical/guides/configuration/certificates/built-in-helpers-and-template-variables.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:5c60e738fffd521fff31492723d0944a37e5ec952e7dd43207837ae90c3624a5"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/configuration/certificates/built-in-helpers-and-template-variables.md).

# Built-in helpers and template variables

How to use the built-in certificate helpers
...
```
GET https://documentation.opencrvs.org/technical/guides/configuration/certificates/built-in-helpers-and-template-variables.md?ask=<question>&goal=<endgoal>
```
