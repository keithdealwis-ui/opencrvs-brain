---
title: "PR development"
source_url: "https://documentation.opencrvs.org/technical/guides/contributing/core-development"
markdown_url: "https://documentation.opencrvs.org/technical/guides/contributing/core-development.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:42c410534bd93f19001344cadb77e99d4e7b368615b05472b0106a44be0f70a4"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/contributing/core-development.md).
...
Using the `ocrvs-<issue-number>` convention is important when your change spans multiple repositories — we match branches by name across them (see *Cross-repository changes* below).
...
```
GET https://documentation.opencrvs.org/technical/guides/contributing/core-development.md?ask=<question>&goal=<endgoal>
```
