---
title: "Contributing"
source_url: "https://documentation.opencrvs.org/technical/guides/contributing"
markdown_url: "https://documentation.opencrvs.org/technical/guides/contributing.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:54031b7689008de8c6ef6326a34d23458e1d29793fc9edcaccfd68728287b04d"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/contributing.md).
...
Clicking on a milestone tells you the due date allowing you to project plan [version upgrades](/technical/guides/version-upgrades.md).
...
<figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2FKMaokwC4VapAVTXIDZMC%2FScreenshot%202026-08-19%20at%2015.11.48.png?alt=media&amp;token=cf98cf08-6656-4230-a268-6b0d5a7259a5" alt=""><figcaption><p>Issue #13246 was given the milestone 1.9.16</p></figcaption></figure>

<figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2FkTqmQUvypDwHCAfF3QHD%2FScreenshot%202026-08-19%20at%2015.10.46.png?alt=media&amp;token=0030010b-40bc-4cb5-ba6d-27c566d20ce5" alt=""><figcaption><p>The linked pull request is based from the release/1.9.16 branch</p></figcaption></figure>
...
To request access, please email: <team@opencrvs.org> and provide:
...
```
GET https://documentation.opencrvs.org/technical/guides/contributing.md?ask=<question>&goal=<endgoal>
```
