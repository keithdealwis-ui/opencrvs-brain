---
title: "Why VPN?"
source_url: "https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/why-vpn"
markdown_url: "https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/why-vpn.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a5549514f6823e69192e7fd8971431749dd13b885d9076c5e298e2e6872982a2"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/why-vpn.md).
...
```
GET https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/why-vpn.md?ask=<question>&goal=<endgoal>
```
