---
title: "LetsEncrypt DNS challenge in production"
source_url: "https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/tls-ssl-configuration-for-traefik/letsencrypt-dns-challenge-in-production"
markdown_url: "https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/tls-ssl-configuration-for-traefik/letsencrypt-dns-challenge-in-production.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6581586dcda9b136ddb2135867b3b8b906a6d3fa0a6888f7a6f2484bf64717a6"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/tls-ssl-configuration-for-traefik/letsencrypt-dns-challenge-in-production.md).
...
{% hint style="info" %}
Before you begin please make sure github environment was created using `yarn environment:init` script, check the [Create a Github Environment](/technical/guides/installation/deploy-set-up-a-server-hosted-environment/create-a-github-environment.md) step.
{% endhint %}
...
```
GET https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/tls-ssl-configuration-for-traefik/letsencrypt-dns-challenge-in-production.md?ask=<question>&goal=<endgoal>
```
