---
title: "Elasticsearch disk management"
source_url: "https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/elasticsearch-disk-management"
markdown_url: "https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/elasticsearch-disk-management.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:bfe88d8c0eb00a418e83629d8150dce79492fdbd350474c91df94ec98064177f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/elasticsearch-disk-management.md).
...
For setup instructions, see [Deploy OpenCRVS with external data stores](/technical/guides/installation/advanced-topics/deploy-opencrvs-with-external-data-stores.md).
...
```
GET https://documentation.opencrvs.org/technical/guides/installation/advanced-topics/elasticsearch-disk-management.md?ask=<question>&goal=<endgoal>
```
