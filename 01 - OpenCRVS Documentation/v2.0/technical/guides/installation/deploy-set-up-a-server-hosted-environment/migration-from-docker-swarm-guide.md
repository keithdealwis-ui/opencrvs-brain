---
title: "Migration from Docker swarm guide"
source_url: "https://documentation.opencrvs.org/technical/guides/installation/deploy-set-up-a-server-hosted-environment/migration-from-docker-swarm-guide"
markdown_url: "https://documentation.opencrvs.org/technical/guides/installation/deploy-set-up-a-server-hosted-environment/migration-from-docker-swarm-guide.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:1897e11f10bbb85411e4fac2c3fa46f87730da2ffa7be9a4aca82bd17ab68485"
---
...
OpenCRVS v2.0+ uses a dedicated **repository** for continuous delivery configuration: <https://github.com/opencrvs/infrastructure>
...
<https://github.com/opencrvs/opencrvs-core/tree/develop/charts/opencrvs-mosip>
...
3. Run "Migration swarm to k8s" GitHub actions workflow
   ...
   <figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2Fgit-blob-8fb0504794ab893f771f8931d741b3d11cba1ac7%2Fimage%20(22).png?alt=media" alt=""><figcaption></figcaption></figure>
...
4. Verify workflow execution results:\
   ...
   <figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2Fgit-blob-a5dd66bb8a27fea17775a6fb24b765ba065d4fdd%2Fimage%20(20).png?alt=media" alt=""><figcaption></figcaption></figure>
...
3. Navigate to Settings -> Actions -> Runners -> Self-hosted runners: Make sure self-hosted runners are available for each migrated environment. If you run migration for one environment only, you will find only one runner. NOTE: Environment name is a part of runner name and one of the runner tags, e/g "development" on the screenshot
   ...
   <figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2Fgit-blob-f1691f783df4a9a9367c44ebd0c97383c0c57fae%2Fimage%20(4).png?alt=media" alt=""><figcaption><p>Each environment will have ows self-hosted runner</p></figcaption></figure>
4. Navigate to "Pull requests" section: You will find PR with all changes required to deploy new environment with Kubernetes.

   <figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2Fgit-blob-121d69f7bb46258a26abe7b950469290873d598d%2Fimage%20(5).png?alt=media" alt=""><figcaption></figcaption></figure>
5. Review changes within PR:
   ...
   2. By default traefik is configured to use static ssl certificates, adjust values if needed, check documentation at [TLS/SSL Configuration for traefik](/technical/guides/installation/advanced-topics/tls-ssl-configuration-for-traefik.md)
6. Merge Pull request to your release branch, (e/g release/2.0.0). If multiple environments were migrated at the same time, you will need to resolve pull request conflicts manually, usually effected section is `environment` input selector:
   ...
   <figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2Fgit-blob-0608fb46128fac0fd9fb245232f9800a44e8e55f%2Fimage%20(6).png?alt=media" alt=""><figcaption></figcaption></figure>

   <figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2Fgit-blob-9716d05bd071d2b16492823c6aa95cdc22c82768%2Fimage%20(7).png?alt=media" alt=""><figcaption></figcaption></figure>

**Kubernetes environment provision and deploy**

1. Provision Kubernetes environment on top of Docker Swarm environment: Run Provision workflow from Infrastructure repository, see for more information [Provisioning servers](/technical/guides/installation/deploy-set-up-a-server-hosted-environment/provisioning-servers.md)
2. Reboot your target server
3. Deploy dependencies, see for more information [Running Dependencies deployment](/technical/guides/installation/deploy-set-up-a-server-hosted-environment/deploy/running-a-dependencies-deployment.md)
4. Deploy OpenCRVS: see for more information [Running an OpenCRVS deployment](/technical/guides/installation/deploy-set-up-a-server-hosted-environment/deploy/running-a-opencrvs-deployment.md)
   ...
   3. Make sure "Enable data seeding during deployment" is unchecked
      ...
      <figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2Fgit-blob-9301a19e22d99b601955120a753b4c5c8a1fc49d%2Fimage%20(8).png?alt=media" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/technical/guides/installation/deploy-set-up-a-server-hosted-environment/migration-from-docker-swarm-guide.md?ask=<question>&goal=<endgoal>
```
