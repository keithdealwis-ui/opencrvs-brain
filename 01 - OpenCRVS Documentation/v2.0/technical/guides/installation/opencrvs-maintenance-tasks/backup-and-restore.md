...
source_url: "https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/backup-and-restore"
markdown_url: "https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/backup-and-restore.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:cc0e833191ffffae6fcc3cd8f9586b32a94d1837758b646f420150b101464268"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/backup-and-restore.md).
...
{% hint style="info" %}
Backup and restore is automatically configured while environment creation by `yarn environment:init` script, check [Create a Github environment](/technical/guides/installation/deploy-set-up-a-server-hosted-environment/create-a-github-environment.md). This guide dives into details:
...
<figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2Fgit-blob-c392ad541731ccf25221827b475f15cc43f144a5%2Fk8s-infra-backup-restore-secrets.png?alt=media" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/backup-and-restore.md?ask=<question>&goal=<endgoal>
```
