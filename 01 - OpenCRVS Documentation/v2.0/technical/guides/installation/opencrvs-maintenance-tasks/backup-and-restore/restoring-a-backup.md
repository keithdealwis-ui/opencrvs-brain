---
title: "Automated restore configuration"
source_url: "https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/backup-and-restore/restoring-a-backup"
markdown_url: "https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/backup-and-restore/restoring-a-backup.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:8596df14683b359bb3d2dc598598728c0dbcaaab2efa24cf8274504e17984261"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/backup-and-restore/restoring-a-backup.md).
...
1. [Copy backup secrets from production to staging](#copy-secrets-from-production-to-staging)
2. [Enable restore in Dependencies helm chart values](#enable-restore-in-dependencies-helm-chart-values)
3. [Enable reindex in OpenCRVS helm chart values](#enable-reindex-in-opencrvs-helm-chart-values)
...
* `schedule`: Cronjob schedule for reindex, see <https://crontab.guru/>
...
Push your changes to github and Re-[Deploy OpenCRVS](/technical/guides/installation/deploy-set-up-a-server-hosted-environment/deploy/running-a-opencrvs-deployment.md)
...
```
GET https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/backup-and-restore/restoring-a-backup.md?ask=<question>&goal=<endgoal>
```
