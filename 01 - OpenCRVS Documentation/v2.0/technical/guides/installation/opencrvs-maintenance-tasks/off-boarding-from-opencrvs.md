---
title: "Off-boarding from OpenCRVS"
source_url: "https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/off-boarding-from-opencrvs"
markdown_url: "https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/off-boarding-from-opencrvs.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:6f71c3b2ce37a995387a2984ad367b97f92ed049d5fa2bfc56d3139b066778ac"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/off-boarding-from-opencrvs.md).
...
```
GET https://documentation.opencrvs.org/technical/guides/installation/opencrvs-maintenance-tasks/off-boarding-from-opencrvs.md?ask=<question>&goal=<endgoal>
```
