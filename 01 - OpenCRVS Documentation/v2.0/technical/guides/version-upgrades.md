...
source_url: "https://documentation.opencrvs.org/technical/guides/version-upgrades"
markdown_url: "https://documentation.opencrvs.org/technical/guides/version-upgrades.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:bc43efa0508ff5f75417e2d209d6fb5be0e98056f3fa5dfdf939e2a9de48c855"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/version-upgrades.md).
...
#### [Update code and test locally](#step-2-update-code-and-test-locally)
...
#### [Update GitHub environments](#step-3-update-github-environments)
...
#### [Deploy to QA environment](#step-4-deploy-to-qa-environment)
...
#### [Deploy to staging environment](#step-5-deploy-to-staging-environment)
...
#### [Schedule downtime and notify staff](#step-6-schedule-downtime-and-notify-staff)
...
#### [Deploy to production](#step-7-deploy-to-production)
...
* Is your country configuration fully complete? I.e. have you gone through all the steps on [Configuration](/technical/guides/configuration.md)
...
{% hint style="warning" %}
Ensure backups are working and can be restored to staging. Keep an offline and online copies of recent backups in case recovery is needed. [Read the backup instructions.](/technical/guides/installation/opencrvs-maintenance-tasks/backup-and-restore.md)
{% endhint %}
...
<div align="center"><figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2Fgit-blob-ec31ee14f46dbab5c44c0a071ae44177fbae1223%2FScreenshot%202026-06-18%20at%2017.00.24.png?alt=media" alt="" width="563"><figcaption><p>Email all users - available to users with the <code>config.update-all</code> scope</p></figcaption></figure></div>
...
```
GET https://documentation.opencrvs.org/technical/guides/version-upgrades.md?ask=<question>&goal=<endgoal>
```
