...
source_url: "https://documentation.opencrvs.org/technical/guides/data-migration"
markdown_url: "https://documentation.opencrvs.org/technical/guides/data-migration.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:67b68e292b6159f5a8e7fbfd264abe67e47d72de7a81f4cc3429dd6a8216d8d3"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/technical/guides/data-migration.md).
...
```
GET https://documentation.opencrvs.org/technical/guides/data-migration.md?ask=<question>&goal=<endgoal>
```
