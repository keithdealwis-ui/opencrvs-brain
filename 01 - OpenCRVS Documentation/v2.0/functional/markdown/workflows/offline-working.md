...
source_url: "https://documentation.opencrvs.org/functional/markdown/workflows/offline-working"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/workflows/offline-working.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:ce5fdef545b0f29c15b2a67d036416e8e37019fcd5cc1e93c16fabcfac75d2b0"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/workflows/offline-working.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/workflows/offline-working.md?ask=<question>&goal=<endgoal>
```
