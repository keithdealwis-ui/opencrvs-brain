---
title: "Users"
source_url: "https://documentation.opencrvs.org/functional/markdown/workflows/users"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/workflows/users.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:98588c97038ce6cb201e4fa8c7e3e6282e23bfba2b892a4bc542f1211882b796"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/workflows/users.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/workflows/users.md?ask=<question>&goal=<endgoal>
```
