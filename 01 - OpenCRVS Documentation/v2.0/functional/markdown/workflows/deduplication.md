---
title: "Deduplication"
source_url: "https://documentation.opencrvs.org/functional/markdown/workflows/deduplication"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/workflows/deduplication.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a4012fe08b7261607588cc6f9620bd92e9195a585a0755c7da2619c9c844bb68"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/workflows/deduplication.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/workflows/deduplication.md?ask=<question>&goal=<endgoal>
```
