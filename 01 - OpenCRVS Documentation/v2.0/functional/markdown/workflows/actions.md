---
title: "Actions"
source_url: "https://documentation.opencrvs.org/functional/markdown/workflows/actions"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/workflows/actions.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:016859c42f5f56dbc838a2d2cea7ad1157dc499c00c0e8448b9347b52e6bf5f7"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/workflows/actions.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/workflows/actions.md?ask=<question>&goal=<endgoal>
```
