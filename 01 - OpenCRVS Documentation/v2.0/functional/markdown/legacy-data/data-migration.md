...
source_url: "https://documentation.opencrvs.org/functional/markdown/legacy-data/data-migration"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/legacy-data/data-migration.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:eddc933bc46fd4033fb54f7d261b819525ce0ff9620ac64b0e8948bd85da9a63"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/legacy-data/data-migration.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/legacy-data/data-migration.md?ask=<question>&goal=<endgoal>
```
