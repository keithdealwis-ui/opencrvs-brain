---
title: "Digitise paper records"
source_url: "https://documentation.opencrvs.org/functional/markdown/legacy-data/digitise-paper-records"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/legacy-data/digitise-paper-records.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f61b2428b4cc3c5b361801f8507b7bfc462fa36b1fc83d617adb6360090bda7e"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/legacy-data/digitise-paper-records.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/legacy-data/digitise-paper-records.md?ask=<question>&goal=<endgoal>
```
