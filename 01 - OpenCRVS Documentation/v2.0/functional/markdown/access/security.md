---
title: "Security"
source_url: "https://documentation.opencrvs.org/functional/markdown/access/security"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/access/security.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:153c8e5dd6ef82badfeb3ca6556b9bf1b29cc253c5a254499265c6eea2ef2adc"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/access/security.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/access/security.md?ask=<question>&goal=<endgoal>
```
