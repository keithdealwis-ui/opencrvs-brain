...
source_url: "https://documentation.opencrvs.org/functional/markdown/access/user-management"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/access/user-management.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:dcae0bb61c1ff2191f2f61127959a001d2f0e8f3f3b6276edfbdaf08df7bed74"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/access/user-management.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/access/user-management.md?ask=<question>&goal=<endgoal>
```
