---
title: "Certificates"
source_url: "https://documentation.opencrvs.org/functional/markdown/records/certificates"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/records/certificates.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:12f62e809f9910d618ee423824fcad3efc40877bed930009e6504529fc9889fb"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/records/certificates.md).
...
{% hint style="info" %}
See our guide on how to design and configure a certificate [Guide: Certificate configuration](/implementation/your-opencrvs-project/gathering-requirements/design-and-specification/guides/guide-certificate-configuration.md)
{% endhint %}
...
```
GET https://documentation.opencrvs.org/functional/markdown/records/certificates.md?ask=<question>&goal=<endgoal>
```
