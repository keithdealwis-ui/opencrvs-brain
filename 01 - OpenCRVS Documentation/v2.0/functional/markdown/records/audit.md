---
title: "Audit"
source_url: "https://documentation.opencrvs.org/functional/markdown/records/audit"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/records/audit.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:cac3ea145570fb91b2a3da285a42649c7e13883d78293b752511cf84a35b8b2a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/records/audit.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/records/audit.md?ask=<question>&goal=<endgoal>
```
