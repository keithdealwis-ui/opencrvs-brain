---
title: "Statuses"
source_url: "https://documentation.opencrvs.org/functional/markdown/records/statuses"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/records/statuses.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:42721b34b5a65486f3783e4f491ee4832ee34b8b22e028471bb42dbabacfe68c"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/records/statuses.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/records/statuses.md?ask=<question>&goal=<endgoal>
```
