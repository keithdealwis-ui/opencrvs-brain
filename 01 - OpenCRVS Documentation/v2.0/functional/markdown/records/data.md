---
title: "Data"
source_url: "https://documentation.opencrvs.org/functional/markdown/records/data"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/records/data.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:8d1f9bb6e3271afaaa3ad447d87fba44e83f1e3ae5f38c830e6f6426ae037268"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/records/data.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/records/data.md?ask=<question>&goal=<endgoal>
```
