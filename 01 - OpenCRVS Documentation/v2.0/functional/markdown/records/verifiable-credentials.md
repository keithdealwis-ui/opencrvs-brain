...
source_url: "https://documentation.opencrvs.org/functional/markdown/records/verifiable-credentials"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/records/verifiable-credentials.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:d1841f66f4f004f3d7a4950d86ae7c005913cee030f58da2d0f52075791ca13a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/records/verifiable-credentials.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/records/verifiable-credentials.md?ask=<question>&goal=<endgoal>
```
