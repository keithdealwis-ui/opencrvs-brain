---
title: "Flags"
source_url: "https://documentation.opencrvs.org/functional/markdown/records/flags"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/records/flags.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:db2c8cebd0d4ce3541908fc30a61d4be4d33d7afc372540f60357eb9e2029b19"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/records/flags.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/records/flags.md?ask=<question>&goal=<endgoal>
```
