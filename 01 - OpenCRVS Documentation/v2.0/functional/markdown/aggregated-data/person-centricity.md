...
source_url: "https://documentation.opencrvs.org/functional/markdown/aggregated-data/person-centricity"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/aggregated-data/person-centricity.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:481f1f28aea50d0a535b11043909e05c1a86def13f960d18358f048342d6b20e"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/aggregated-data/person-centricity.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/aggregated-data/person-centricity.md?ask=<question>&goal=<endgoal>
```
