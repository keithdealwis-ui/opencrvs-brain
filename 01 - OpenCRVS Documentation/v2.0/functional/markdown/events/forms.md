---
title: "Forms"
source_url: "https://documentation.opencrvs.org/functional/markdown/events/forms"
markdown_url: "https://documentation.opencrvs.org/functional/markdown/events/forms.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:da37805ec5dfe96a7f76084705e4bc824a61edf997d3b4abb7aa16d7e82fed79"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown/events/forms.md).
...
```
GET https://documentation.opencrvs.org/functional/markdown/events/forms.md?ask=<question>&goal=<endgoal>
```
