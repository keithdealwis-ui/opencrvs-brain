...
source_url: "https://documentation.opencrvs.org/functional/markdown"
markdown_url: "https://documentation.opencrvs.org/functional/markdown.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:334455e4b2b1aba697829bbfc8302203e30f5606c33ce3c18d4eccbc6f17359f"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/functional/markdown.md).
...
<figure><img src="https://3593002492-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FTIJguU5Pzi7HeHrkXa4I%2Fuploads%2Fgit-blob-2349e16ad3a43cd08ccc922ccabe1e96ca363b99%2FOpenCRVS%20%E2%80%94%20Functional%20Architecture.png?alt=media" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/functional/markdown.md?ask=<question>&goal=<endgoal>
```
