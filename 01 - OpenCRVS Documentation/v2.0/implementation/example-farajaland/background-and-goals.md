...
source_url: "https://documentation.opencrvs.org/implementation/example-farajaland/background-and-goals"
markdown_url: "https://documentation.opencrvs.org/implementation/example-farajaland/background-and-goals.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:785d1c8e3f5b09cb6a47ad909058e91e69e75ce95e455986f8c748864540e380"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/implementation/example-farajaland/background-and-goals.md).
...
```
GET https://documentation.opencrvs.org/implementation/example-farajaland/background-and-goals.md?ask=<question>&goal=<endgoal>
```
