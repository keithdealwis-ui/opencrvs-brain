---
title: "Go-live"
source_url: "https://documentation.opencrvs.org/implementation/your-opencrvs-project/go-live"
markdown_url: "https://documentation.opencrvs.org/implementation/your-opencrvs-project/go-live.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:7aec538b3fc3eacd5329b77456aa814d91b0c038dd7699da49e722259179cb11"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/implementation/your-opencrvs-project/go-live.md).
...
```
GET https://documentation.opencrvs.org/implementation/your-opencrvs-project/go-live.md?ask=<question>&goal=<endgoal>
```
