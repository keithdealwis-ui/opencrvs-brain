---
title: "Configuration"
source_url: "https://documentation.opencrvs.org/implementation/your-opencrvs-project/configuration"
markdown_url: "https://documentation.opencrvs.org/implementation/your-opencrvs-project/configuration.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f94212f18aa69e10c92833eccb788bb9a34414f3bbed1188880721edeb0923b4"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/implementation/your-opencrvs-project/configuration.md).
...
```
GET https://documentation.opencrvs.org/implementation/your-opencrvs-project/configuration.md?ask=<question>&goal=<endgoal>
```
