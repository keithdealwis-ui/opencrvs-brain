...
source_url: "https://documentation.opencrvs.org/implementation/your-opencrvs-project/migrate-legacy-data"
markdown_url: "https://documentation.opencrvs.org/implementation/your-opencrvs-project/migrate-legacy-data.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:22d85ca75b177c1464314c0b63e697a29f97811596d2e029ed98ad5859d97405"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/implementation/your-opencrvs-project/migrate-legacy-data.md).
...
```
GET https://documentation.opencrvs.org/implementation/your-opencrvs-project/migrate-legacy-data.md?ask=<question>&goal=<endgoal>
```
