...
source_url: "https://documentation.opencrvs.org/implementation/your-opencrvs-project/project-planning"
markdown_url: "https://documentation.opencrvs.org/implementation/your-opencrvs-project/project-planning.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:2462928986967538a3e67ec3110df14276d30c67f1259228f997fecd2b87185b"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/implementation/your-opencrvs-project/project-planning.md).
...
For detailed guidance on roles, skills, and team composition, see [Establish project & team](/implementation/your-opencrvs-project/establish-project-and-team.md)
...
For detailed guidance on what the work plan should cover and common oversights to avoid, see [Building an implementation work plan](/implementation/your-opencrvs-project/project-planning/building-an-implementation-work-plan.md).&#x20;
...
```
GET https://documentation.opencrvs.org/implementation/your-opencrvs-project/project-planning.md?ask=<question>&goal=<endgoal>
```
