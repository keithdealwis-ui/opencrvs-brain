...
source_url: "https://documentation.opencrvs.org/implementation/your-opencrvs-project/quality-assurance"
markdown_url: "https://documentation.opencrvs.org/implementation/your-opencrvs-project/quality-assurance.md"
version: "v2.0"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f5154a5ef0570f46658334d04ed0530957070917ba3b9831439a02535d4fc4d8"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/implementation/your-opencrvs-project/quality-assurance.md).
...
If you suspect that you have discovered a defect you will need to raise an issue for L3 or L4 support.  Read the [Operational support](/implementation/your-opencrvs-project/operational-support.md) guide for info on what these tiers mean and who is responsible for resolution.
...
**L4 next steps:** Refer to the [Contributing](/technical/guides/contributing.md) guide to understand how to escalate this report to the OpenCRVS Core team.
...
```
GET https://documentation.opencrvs.org/implementation/your-opencrvs-project/quality-assurance.md?ask=<question>&goal=<endgoal>
```
