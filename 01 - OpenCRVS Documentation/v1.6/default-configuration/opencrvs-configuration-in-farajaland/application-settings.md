...
source_url: "https://documentation.opencrvs.org/v1.6/default-configuration/opencrvs-configuration-in-farajaland/application-settings"
markdown_url: "https://documentation.opencrvs.org/v1.6/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:2f90d7f25de2c536b58ccb39d2ed2d36ec3d89cb31560110ad5dab8dad43c32a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md).
...
| Government logo                                      | <img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/UlMYbVagKGRwYSmFDoGp/image.png" alt="" data-size="line"> |                                                                                              |
...
```
GET https://documentation.opencrvs.org/v1.6/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md?ask=<question>&goal=<endgoal>
```
