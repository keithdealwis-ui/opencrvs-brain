...
source_url: "https://documentation.opencrvs.org/v1.6/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping"
markdown_url: "https://documentation.opencrvs.org/v1.6/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:49200ee41406882f140b3304c92a60ef8f52a6cd3498746406293a48d257978e"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md).
...
```
GET https://documentation.opencrvs.org/v1.6/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md?ask=<question>&goal=<endgoal>
```
