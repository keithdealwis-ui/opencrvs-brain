...
source_url: "https://documentation.opencrvs.org/v1.6/default-configuration/intro-to-farajaland"
markdown_url: "https://documentation.opencrvs.org/v1.6/default-configuration/intro-to-farajaland.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:c291fd071eb8274f81db69f7eeef94fc40d7e1b1374d80ba1eef0ba13694e7e4"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/default-configuration/intro-to-farajaland.md).
...
![Provinces and Districts of Farajaland](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/Pqpq48MooyIynvwu9xGk/farajaland-map.png)
...
```
GET https://documentation.opencrvs.org/v1.6/default-configuration/intro-to-farajaland.md?ask=<question>&goal=<endgoal>
```
