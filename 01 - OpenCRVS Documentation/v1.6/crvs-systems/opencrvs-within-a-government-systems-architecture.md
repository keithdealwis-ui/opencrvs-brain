...
source_url: "https://documentation.opencrvs.org/v1.6/crvs-systems/opencrvs-within-a-government-systems-architecture"
markdown_url: "https://documentation.opencrvs.org/v1.6/crvs-systems/opencrvs-within-a-government-systems-architecture.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:2c9654130090ac22ab77a3991c54e0a3278b4514b54288b11a9199f5d7781ba5"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/crvs-systems/opencrvs-within-a-government-systems-architecture.md).
...
<figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/blOS8JSmkL0Yx9K5WNfv/image.png" alt=""><figcaption><p>OpenCRVS and DPI</p></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.6/crvs-systems/opencrvs-within-a-government-systems-architecture.md?ask=<question>&goal=<endgoal>
```
