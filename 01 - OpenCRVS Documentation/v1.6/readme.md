---
title: "Welcome!"
source_url: "https://documentation.opencrvs.org/v1.6/readme"
markdown_url: "https://documentation.opencrvs.org/v1.6/readme.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:cf4147f653eaace959f69a9a21331c9a575e54f9603b260680fd46915be00ea9"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/readme.md).
...
* to understand what effective digital CRVS looks like and the role that OpenCRVS can play, check out [CRVS Systems](/v1.6/crvs-systems/effective-digital-crvs-systems.md).&#x20;
* to explore the OpenCRVS functionality, take a look at the [Product Specifications](/v1.6/product-specifications/functional-architecture.md) and the [Default Configuration for Farajaland](/v1.6/default-configuration/intro-to-farajaland.md)
* to understand how OpenCRVS works technically, go to [Technology](/v1.6/technology/architecture.md)
* to setup you own OpenCRVS project, then go to [Setup](/v1.6/setup/1.-establish-project-and-team.md)
* to see what's coming next for OpenCRVS, see the [Product Roadmap](/v1.6/general/product-roadmap.md)
...
```
GET https://documentation.opencrvs.org/v1.6/readme.md?ask=<question>&goal=<endgoal>
```
