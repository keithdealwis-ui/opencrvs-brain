---
title: "Community"
source_url: "https://documentation.opencrvs.org/v1.6/general/community"
markdown_url: "https://documentation.opencrvs.org/v1.6/general/community.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a8c39cfd0c108d1784d4ce13f8a2f5fc6707065355e4ff645d565f3ec89a5c4e"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/general/community.md).
...
```
GET https://documentation.opencrvs.org/v1.6/general/community.md?ask=<question>&goal=<endgoal>
```
