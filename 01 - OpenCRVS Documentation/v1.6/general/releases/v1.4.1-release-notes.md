...
source_url: "https://documentation.opencrvs.org/v1.6/general/releases/v1.4.1-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.6/general/releases/v1.4.1-release-notes.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:ea4ab0dc9346bfa4a8a2a767083d8e8a6324d419a2d0c794e8ca60b792196ac8"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/general/releases/v1.4.1-release-notes.md).
...
In order to manage copy in 1.4.1 as opposed to <1.4.0, refer to the updated documentation [here](https://github.com/opencrvs/documentation/blob/master/v1.6.0/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.5-set-up-application-settings/3.2.9.1-managing-language-content).
...
```
GET https://documentation.opencrvs.org/v1.6/general/releases/v1.4.1-release-notes.md?ask=<question>&goal=<endgoal>
```
