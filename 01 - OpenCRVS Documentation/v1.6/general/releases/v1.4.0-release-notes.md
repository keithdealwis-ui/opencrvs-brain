...
source_url: "https://documentation.opencrvs.org/v1.6/general/releases/v1.4.0-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.6/general/releases/v1.4.0-release-notes.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:93bc0eed97049aff283bd3972262d0356526b32d4105f59d7411b0915c53e3c3"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/general/releases/v1.4.0-release-notes.md).
...
Upgrading from v1.3.0 to v1.4.0 requires the upgrade [Migration Notes](broken://pages/Ec3m55wqB4zjBIeJe8Mb) to be followed precisely.

### Documentation updates

{% hint style="success" %}
The documentation section [3.3 Set-up a server hosted environment](/v1.6/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md) has been entirely re-written for the new infrastructure provisioning tasks.  We recommend that you read it before continuing.
{% endhint %}
...
```
GET https://documentation.opencrvs.org/v1.6/general/releases/v1.4.0-release-notes.md?ask=<question>&goal=<endgoal>
```
