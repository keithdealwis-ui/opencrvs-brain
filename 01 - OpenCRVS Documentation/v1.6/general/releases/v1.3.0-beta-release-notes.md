...
source_url: "https://documentation.opencrvs.org/v1.6/general/releases/v1.3.0-beta-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.6/general/releases/v1.3.0-beta-release-notes.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:c9150914dca8fb17f2108bd9ccb7c1420ea3ac2c53ec70a1e6c8b85a811d0bf4"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/general/releases/v1.3.0-beta-release-notes.md).
...
\
Due to this, we are releasing marriage registration in "beta", therefore not for production use. You can [configure marriage registration](/v1.6/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md) in development environments for proof of concept testing.
{% endhint %}

<figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/bwxsOSp4A3GtQXmMgbeo/Screenshot%202023-09-13%20at%2013.55.29.png" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/2zZ2x7YOd5odGndP4vtP/Screenshot%202023-09-13%20at%2013.58.08.png" alt=""><figcaption><p>If you decide to print in advance ...</p></figcaption></figure> <figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/Qg8sy9Yz14AziDfG0czB/Screenshot%202023-09-13%20at%2013.58.52.png" alt=""><figcaption><p>...then you can track issuance</p></figcaption></figure></div>
...
\
You can [configure the informant signature](/v1.6/default-configuration/opencrvs-configuration-in-farajaland/application-settings.md) capture on and off for birth and death events. By default marriage events require the participant and witness signatures.

<figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/Nfh4Q5uVXuePxpWGxBd6/Screenshot%202023-09-13%20at%2014.10.44.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/c2GMh4VKUFv69utAHQk0/Screenshot%202023-09-13%20at%2014.13.10.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/8NFnedFmIQr7UfdbcfBJ/Screenshot%202023-09-13%20at%2014.14.33.png" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/yf2ql46t85TZBU9RKSOG/Screenshot%202023-09-13%20at%2014.21.56.png" alt=""><figcaption></figcaption></figure> <figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/TxK1M5qFmcygceWtZcCy/Screenshot%202023-09-13%20at%2014.22.09.png" alt=""><figcaption></figcaption></figure></div>
...
To read more about why we made this decision, refer to our documentation [step 3.2.7 Configure declaration forms](/v1.6/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-declaration-forms.md)
...
[2 Gather requirements](/v1.6/setup/2.-gather-requirements.md)

[3.2 Set-up your own country configuration](/v1.6/setup/3.-installation/3.2-set-up-your-own-country-configuration.md)

[3.3 Set-up a server hosted environment](/v1.6/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)

[4 Functional configuration](/v1.6/setup/4.-functional-configuration.md)
...
```
GET https://documentation.opencrvs.org/v1.6/general/releases/v1.3.0-beta-release-notes.md?ask=<question>&goal=<endgoal>
```
