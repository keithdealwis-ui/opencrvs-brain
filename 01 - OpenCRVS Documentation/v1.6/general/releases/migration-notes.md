...
source_url: "https://documentation.opencrvs.org/v1.6/general/releases/migration-notes"
markdown_url: "https://documentation.opencrvs.org/v1.6/general/releases/migration-notes.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:8e26c2e9cd518704ba31e3bdd97d38ad40ce3dc7e0026f09f00548e623cda171"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/general/releases/migration-notes.md).
...
{% hint style="info" %}
Please refer to the release notes , which contains a video of an example code upgrade process, and our [release process including Gitflow](/v1.6/general/releases.md) branching approach.
{% endhint %}
...
The following command pulls from a remote named "upstream" which should already point to our countryconfig repository. You set this up when [forking countryconfig](/v1.6/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md)
...
6\. If you are running OpenCRVS locally, simply [start OpenCRVS](/v1.6/setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-starting-and-stopping-opencrvs.md). Migrations will automatically run on your local data and you have finished upgrading OpenCRVS locally.
...
1. Every release likely contains dev-ops improvements and bug fixes to your servers. Run the [Provision](https://github.com/opencrvs/documentation/blob/master/v1.6.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.5-provisioning-servers) action on your QA server environment.
...
<figure><img src="https://697986218-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FYTKQAa9NKqMdS5tq1TB3%2Fuploads%2FDqw5X9RenGx2pDIjApwb%2FScreenshot%202024-12-11%20at%2008.44.32.png?alt=media&amp;token=75168422-2b72-42cc-b3cf-41c9e2febd32" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.6/general/releases/migration-notes.md?ask=<question>&goal=<endgoal>
```
