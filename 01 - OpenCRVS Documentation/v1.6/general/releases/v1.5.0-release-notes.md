...
source_url: "https://documentation.opencrvs.org/v1.6/general/releases/v1.5.0-release-notes"
markdown_url: "https://documentation.opencrvs.org/v1.6/general/releases/v1.5.0-release-notes.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:2cde6259305f6ce0e15f6713daf37a2d5925bd9fc4f73bd5866f298fa96f8675"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/general/releases/v1.5.0-release-notes.md).
...
```
<figure><img src="/files/FAFytZ5Y3P0OX1wLI39A" alt=""><figcaption><p>National System Admin: Email all users feature</p></figcaption></figure>
```
...
```
GET https://documentation.opencrvs.org/v1.6/general/releases/v1.5.0-release-notes.md?ask=<question>&goal=<endgoal>
```
