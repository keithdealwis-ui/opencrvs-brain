---
title: "Architecture"
source_url: "https://documentation.opencrvs.org/v1.6/technology/architecture"
markdown_url: "https://documentation.opencrvs.org/v1.6/technology/architecture.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:841e7f1bdbc648d56335aa98b2dbd64f9fe4a11dc8862909f00e34b8d4289191"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/technology/architecture.md).
...
To learn about the server hosting & network architecture required for hosting OpenCRVS visit [this section.](/v1.6/setup/3.-installation/3.3-set-up-a-server-hosted-environment.md)
...
We extended [FHIR](https://www.hl7.org/fhir/) to support the civil registration context. Our civil registration FHIR standard is described [here](/v1.6/technology/standards/fhir-documents.md).
...
![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/7cxAgaFTFA7rCGNZDQOQ/image.png) ![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/vCHs4rt45XwUHw1BKQjY/image.png) ![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/Y41EFNVV8nG7wWxZOrTW/image.png)\\
...
```
GET https://documentation.opencrvs.org/v1.6/technology/architecture.md?ask=<question>&goal=<endgoal>
```
