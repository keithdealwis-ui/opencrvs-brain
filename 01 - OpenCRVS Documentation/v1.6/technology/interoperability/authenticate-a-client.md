...
source_url: "https://documentation.opencrvs.org/v1.6/technology/interoperability/authenticate-a-client"
markdown_url: "https://documentation.opencrvs.org/v1.6/technology/interoperability/authenticate-a-client.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:dd159c281cd69afc524d88d98166040a7ade780bb75060448638dcf3bf2e441d"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/technology/interoperability/authenticate-a-client.md).
...
```
GET https://documentation.opencrvs.org/v1.6/technology/interoperability/authenticate-a-client.md?ask=<question>&goal=<endgoal>
```
