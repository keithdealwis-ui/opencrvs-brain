...
source_url: "https://documentation.opencrvs.org/v1.6/technology/interoperability/fhir-location-rest-api"
markdown_url: "https://documentation.opencrvs.org/v1.6/technology/interoperability/fhir-location-rest-api.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:3f9f30f47f153b3d1d6702ca8e67a370f17ade4b5aa1e8f5a79ce57196a68861"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/technology/interoperability/fhir-location-rest-api.md).
...
This API will help you configure integrating clients to understand the relationship to places referenced by [FHIR Location](https://build.fhir.org/location.html) ids in payloads such as "Place of birth", "Place of registration", or "Jurisdiction" such as [Webhooks](/v1.6/technology/interoperability/webhook-clients.md) and [National ID](/v1.6/technology/interoperability/national-id-client.md) clients.

For an [Event Notification](/v1.6/technology/interoperability/event-notification-clients.md) client, you must submit the correct FHIR Location id for the health facility that OpenCRVS understands in order to correctly track the place of birth.

For a [Record Search](/v1.6/technology/interoperability/record-search-clients.md) client, you need the correct FHIR Location id when performing advanced searches depending on your parameters.
...
<figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/EhkTqw8rwb3NxP8zVLpr/Screenshot%202023-01-19%20at%2016.57.25.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/Nsnw69MKcxcUFHmRZIsi/Screenshot%202023-01-19%20at%2017.41.39.png" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.6/technology/interoperability/fhir-location-rest-api.md?ask=<question>&goal=<endgoal>
```
