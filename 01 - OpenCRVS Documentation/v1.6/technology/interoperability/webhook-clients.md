...
source_url: "https://documentation.opencrvs.org/v1.6/technology/interoperability/webhook-clients"
markdown_url: "https://documentation.opencrvs.org/v1.6/technology/interoperability/webhook-clients.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:671905d43f1e95b71f27ca5eb70bb3595053c48fcf3a5f1bfb1b636d013ce7b7"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/technology/interoperability/webhook-clients.md).
...
4. Respond to the webhook event as you wish internally, and request further details from OpenCRVS via a [Record Search](/v1.6/technology/interoperability/record-search-clients.md) if you need to.
...
<figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/ZL8Zr4XKqBImmD4PYmV1/Screenshot%202023-01-11%20at%2011.34.54.png" alt=""><figcaption></figcaption></figure>
...
The property `context` contains the FHIR bundles. Refer to our [standards](/v1.6/technology/standards.md) section to learn more about the FHIR specification.
...
To subscribe, your subscription service must request an [authorization token ](/v1.6/technology/interoperability/authenticate-a-client.md)using your `client_id` and `client_secret`.
...
```
GET https://documentation.opencrvs.org/v1.6/technology/interoperability/webhook-clients.md?ask=<question>&goal=<endgoal>
```
