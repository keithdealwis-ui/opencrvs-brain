---
title: "Security"
source_url: "https://documentation.opencrvs.org/v1.6/technology/security"
markdown_url: "https://documentation.opencrvs.org/v1.6/technology/security.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:bd74c7a4d96aea478d83d8e4ac9f4d7b3c901bae02ad99d4bf0cca05cb9dc243"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/technology/security.md).
...
We provide a "Data Security Framework" document explained further with a video in [this section](/v1.6/setup/6.-go-live/3.3.4-set-up-an-smtp-server-for-opencrvs-monitoring-alerts.md).  The purpose of this document is to provide organisations with:
...
```
GET https://documentation.opencrvs.org/v1.6/technology/security.md?ask=<question>&goal=<endgoal>
```
