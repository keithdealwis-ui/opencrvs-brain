...
source_url: "https://documentation.opencrvs.org/v1.6/technology/standards/fhir-documents/registration-task"
markdown_url: "https://documentation.opencrvs.org/v1.6/technology/standards/fhir-documents/registration-task.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:663c85760c5042dc218db66e1df9042d179aac84f4b0d964deab891d5486312a"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/technology/standards/fhir-documents/registration-task.md).
...
```
GET https://documentation.opencrvs.org/v1.6/technology/standards/fhir-documents/registration-task.md?ask=<question>&goal=<endgoal>
```
