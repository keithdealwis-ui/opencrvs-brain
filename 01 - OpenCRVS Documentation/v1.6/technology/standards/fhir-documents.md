...
source_url: "https://documentation.opencrvs.org/v1.6/technology/standards/fhir-documents"
markdown_url: "https://documentation.opencrvs.org/v1.6/technology/standards/fhir-documents.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:5e983cebe3e98edadae3ca8ce4d63623bfffa586bdc519795f4cbead0b9d0edd"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/technology/standards/fhir-documents.md).
...
```
GET https://documentation.opencrvs.org/v1.6/technology/standards/fhir-documents.md?ask=<question>&goal=<endgoal>
```
