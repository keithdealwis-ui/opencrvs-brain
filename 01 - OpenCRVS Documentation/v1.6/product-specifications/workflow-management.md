...
source_url: "https://documentation.opencrvs.org/v1.6/product-specifications/workflow-management"
markdown_url: "https://documentation.opencrvs.org/v1.6/product-specifications/workflow-management.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:433b4cef5c7e79d70159b2324203a66e6af02dc8c5abb3c6de1ec1c8b02514e4"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/product-specifications/workflow-management.md).
...
For a comprehensive understanding of the various statuses and the potential pathways a record can follow, please refer to the [Status Flow Diagram](/v1.6/product-specifications/status-flow-diagram.md)
...
```
GET https://documentation.opencrvs.org/v1.6/product-specifications/workflow-management.md?ask=<question>&goal=<endgoal>
```
