---
title: "Users"
source_url: "https://documentation.opencrvs.org/v1.6/product-specifications/users"
markdown_url: "https://documentation.opencrvs.org/v1.6/product-specifications/users.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:7f7fd5e496485ed333c0a6f6edd555b4c153ca9a08e67579d95cd2958b101ed0"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/product-specifications/users.md).
...
* To see how these roles are mapped to user types in Farajaland, see [User / role mapping](/v1.6/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md).
* To see how these actors work together to improve service delivery in Farajaland, see [Business process flows in Farajaland](/v1.6/default-configuration/business-process-flows-in-farajaland.md).
...
```
GET https://documentation.opencrvs.org/v1.6/product-specifications/users.md?ask=<question>&goal=<endgoal>
```
