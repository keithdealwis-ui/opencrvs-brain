...
source_url: "https://documentation.opencrvs.org/v1.6/setup/8.-operational-support"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/8.-operational-support.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:101ee2a9a9ba6e743831ea3395df0ca79def2223bdec1ac66205239db0eed3dc"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/8.-operational-support.md).
...
```
GET https://documentation.opencrvs.org/v1.6/setup/8.-operational-support.md?ask=<question>&goal=<endgoal>
```
