---
title: "7. Go-live"
source_url: "https://documentation.opencrvs.org/v1.6/setup/6.-go-live"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/6.-go-live.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:f5511703694ac659aef6d1c0871398f5cd26b707b3f76bc6326f900e6a3ebf50"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/6.-go-live.md).
...
The following [Pre-Deployment Checklist](/v1.6/setup/6.-go-live/3.3.4-set-up-an-smtp-server-for-opencrvs-monitoring-alerts.md) should be completed by the **production** environment server administrator before going live.
...
```
GET https://documentation.opencrvs.org/v1.6/setup/6.-go-live.md?ask=<question>&goal=<endgoal>
```
