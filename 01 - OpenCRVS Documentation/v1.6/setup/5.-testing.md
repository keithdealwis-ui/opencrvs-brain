...
source_url: "https://documentation.opencrvs.org/v1.6/setup/5.-testing"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/5.-testing.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:e7d80a1f7b4c80fc125cad45a18d34123dcab2d617e315ffc26aa220a4aee9d3"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/5.-testing.md).
...
```
GET https://documentation.opencrvs.org/v1.6/setup/5.-testing.md?ask=<question>&goal=<endgoal>
```
