...
source_url: "https://documentation.opencrvs.org/v1.6/setup/4.-functional-configuration/4.5-create-system-users"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/4.-functional-configuration/4.5-create-system-users.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:df7815364338041218db8b136eab103e164e576957d014cb427bdefb81d4ee20"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/4.-functional-configuration/4.5-create-system-users.md).
...
2. **Create a Field Agent**\
   ...
   \
   ![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/2OSGMzRSnDH2uQOAz9eV/image.png)\
   \
   Select the type of role.\
   ![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/ZM0LIZtR4fr8ElV4NYJO/image.png)\
   \
...
4. **Create a Registrar**\
   ...
   \
   ![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/a1Bvez1dISsg8Xqol8xy/image.png)\
   \
...
```
GET https://documentation.opencrvs.org/v1.6/setup/4.-functional-configuration/4.5-create-system-users.md?ask=<question>&goal=<endgoal>
```
