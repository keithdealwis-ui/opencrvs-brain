...
source_url: "https://documentation.opencrvs.org/v1.6/setup/4.-functional-configuration/4.1-configure-application-settings"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/4.-functional-configuration/4.1-configure-application-settings.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:d6d391ed1975e4b6f906a227b6dcae55768ac87efaf997ca978d49d0eb103805"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/4.-functional-configuration/4.1-configure-application-settings.md).
...
![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/oBWSHjnmBXIUjdH0uWlU/app-config.png)
...
```
GET https://documentation.opencrvs.org/v1.6/setup/4.-functional-configuration/4.1-configure-application-settings.md?ask=<question>&goal=<endgoal>
```
