---
title: "9.5 Managing a Docker Swarm"
source_url: "https://documentation.opencrvs.org/v1.6/setup/7.-monitoring/7.5-managing-a-docker-swarm"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/7.-monitoring/7.5-managing-a-docker-swarm.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:36961cb82dcd4c4dd9233f6a41595885443e13097a570bdbff30c179eb2a1ab7"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/7.-monitoring/7.5-managing-a-docker-swarm.md).
...
```
GET https://documentation.opencrvs.org/v1.6/setup/7.-monitoring/7.5-managing-a-docker-swarm.md?ask=<question>&goal=<endgoal>
```
