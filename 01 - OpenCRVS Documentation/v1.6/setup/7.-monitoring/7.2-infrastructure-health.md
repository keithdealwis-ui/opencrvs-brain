...
source_url: "https://documentation.opencrvs.org/v1.6/setup/7.-monitoring/7.2-infrastructure-health"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/7.-monitoring/7.2-infrastructure-health.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:a2c938b0b89643bf1c3f1170b281239ea0f440eda31ab5b8743173c026f34ce5"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/7.-monitoring/7.2-infrastructure-health.md).
...
![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/wcK7Uyhv4o0meNy08nsL/image.png)
...
![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/s6Zd1FeZvn235eM9soLB/image.png)
...
![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/LNjp6sNMtWPJiObYGsC1/image.png)
...
```
GET https://documentation.opencrvs.org/v1.6/setup/7.-monitoring/7.2-infrastructure-health.md?ask=<question>&goal=<endgoal>
```
