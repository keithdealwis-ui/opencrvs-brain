---
title: "4.1.4 Log in to OpenCRVS locally"
source_url: "https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.1-set-up-a-development-environment/3.1.4-log-in-to-opencrvs-locally"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.1-set-up-a-development-environment/3.1.4-log-in-to-opencrvs-locally.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:2398ea929117ce43df4ee7278f4f5cce198e07018f328ff1ac600552ae46e5b8"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.1-set-up-a-development-environment/3.1.4-log-in-to-opencrvs-locally.md).
...
To learn more about user roles please refer to [User / role mapping](/v1.6/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping.md).
...
```
GET https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.1-set-up-a-development-environment/3.1.4-log-in-to-opencrvs-locally.md?ask=<question>&goal=<endgoal>
```
