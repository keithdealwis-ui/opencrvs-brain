...
source_url: "https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.2-set-up-administrative-address-divisions/3.2.2.2-prepare-source-file-for-statistics"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.2-set-up-administrative-address-divisions/3.2.2.2-prepare-source-file-for-statistics.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:4fa66b0813eda7496a990f26ecdd888931b01bad775ba7249e7152da22eae199"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.2-set-up-administrative-address-divisions/3.2.2.2-prepare-source-file-for-statistics.md).
...
You can add statistical data to a location every year using the [FHIR Location API](/v1.6/technology/interoperability/fhir-location-rest-api.md).

{% hint style="info" %}
**Note:** crude death rate is applied globally in the [3.2.5 Set up Application Settings](/v1.6/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.5-set-up-application-settings.md) step later in this documentation.
...
```
GET https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.2-set-up-administrative-address-divisions/3.2.2.2-prepare-source-file-for-statistics.md?ask=<question>&goal=<endgoal>
```
