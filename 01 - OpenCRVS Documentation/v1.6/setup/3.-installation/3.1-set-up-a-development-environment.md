...
source_url: "https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.1-set-up-a-development-environment"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.1-set-up-a-development-environment.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:29427ef45ae1f45de8dacd12ddc42d5bb7b4f52755e4b522d6e93b5f3eb70319"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.1-set-up-a-development-environment.md).
...
```
GET https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.1-set-up-a-development-environment.md?ask=<question>&goal=<endgoal>
```
