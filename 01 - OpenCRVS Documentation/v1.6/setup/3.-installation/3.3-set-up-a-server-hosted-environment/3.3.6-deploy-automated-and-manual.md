---
title: "4.3.6 Deploy"
source_url: "https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:5ebce7fa162cc0b7a008a542ab5147c279d8d27d31aa25235d8eecfd0252449e"
---
...
Refer back to section [4.3.2.1](/v1.6/setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.4-set-up-employees-for-testing-or-production/3.2.3.1-prepare-source-file-for-test-employees.md) employees source files to understand how user access is different for each environment.

### Configure your docker-compose files

There are a few environment variables you need to manually set in docker compose files for your installation such as those that are relevant for your [TLS/SSL Certificate approach](/v1.6/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.5-setup-dns-a-records.md).  Make sure that you make those changes before proceeding.
...
<figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/EqOgAXHRtlHoUj1bBoKA/Screenshot%202024-02-13%20at%2017.39.46.png" alt=""><figcaption><p>Example of Deploy(production) approval</p></figcaption></figure>
...
<figure><img src="https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/4X0mnYOAybntyup6X5jM/Screenshot%202024-02-13%20at%2017.34.21.png" alt=""><figcaption></figcaption></figure>
...
```
GET https://documentation.opencrvs.org/v1.6/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md?ask=<question>&goal=<endgoal>
```
