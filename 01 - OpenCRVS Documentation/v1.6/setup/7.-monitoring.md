---
title: "9. Monitoring"
source_url: "https://documentation.opencrvs.org/v1.6/setup/7.-monitoring"
markdown_url: "https://documentation.opencrvs.org/v1.6/setup/7.-monitoring.md"
version: "v1.6"
retrieved_at: "2026-09-16T15:06:42Z"
content_hash: "sha256:9edb267d9e60938a92a136ecba78c8990abb3dff0357beed3ddcb247bbcf8abc"
---

> For the complete documentation index, see [llms.txt](https://documentation.opencrvs.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://documentation.opencrvs.org/v1.6/setup/7.-monitoring.md).
...
![](https://content.gitbook.com/content/YTKQAa9NKqMdS5tq1TB3/blobs/puXjHx6PL8zJOEWb88S5/image.png)

The login credentials are the ones you used as `KIBANA_USERNAME` and `KIBANA_PASSWORD` as part of the [deployment](/v1.6/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md), or the username: "elastic" and `ELASTICSEARCH_SUPERUSER_PASSWORD`
...
```
GET https://documentation.opencrvs.org/v1.6/setup/7.-monitoring.md?ask=<question>&goal=<endgoal>
```
